...
startClass=com.equitybankgroup.payments.imt.tech_imt_moneygram_cd_ms.TechImtMoneygramCdMsApplication
...
#/u01/gag/jdk-17.0.6/bin/java
javaPath="\/u01\/gag\/jdk-17.0.6\/bin\/java"


# building jar name
jarFileName=tech-imt-moneygram-cd-ms-0.0.1-SNAPSHOT.jar

# application name
applicationName=tech-imt-moneygram-cd-ms
