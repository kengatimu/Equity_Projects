 ...
 * 调整Identity积分的请求消息
 * 
 * <p>Java class for AdjustCustomerPointsRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AdjustCustomerPointsRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AdjustCustomerPointsRequest", propOrder = {
    "pointList",
    "adjustmentCategory"
})
public class AdjustCustomerPointsRequest {

    @XmlElement(name = "PointList", required = true)
    protected AdjustCustomerPointsRequest.PointList pointList;
     ...
     * @return
     *     possible object is
     *     {@link AdjustCustomerPointsRequest.PointList }
     *     
     */
    public AdjustCustomerPointsRequest.PointList getPointList() {
        return pointList;
    }
     ...
     *     
     */
    public void setPointList(AdjustCustomerPointsRequest.PointList value) {
    ...
    public static class PointList {
        ...
        protected List<AdjustCustomerPointsRequest.PointList.Point> point;
         ...
         * {@link AdjustCustomerPointsRequest.PointList.Point }
         * 
         * 
         */
        public List<AdjustCustomerPointsRequest.PointList.Point> getPoint() {
            if (point == null) {
                point = new ArrayList<AdjustCustomerPointsRequest.PointList.Point>();
            }
            return this.point;
        }
