...
/**
 * Customer自注册，使用PIN而不使用Password
 * 
 * <p>Java class for CustomerSelfRegistration4PINRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CustomerSelfRegistration4PINRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CustomerSelfRegistration4PINRequest", propOrder = {
    "customerType",
    "simDeviceData",
    "ruleProfileID",
    "registeredBy",
...
public class CustomerSelfRegistration4PINRequest {

    @XmlElement(name = "CustomerType")
    protected String customerType;
    @XmlElement(name = "SIMDeviceData", required = true)
    protected CustomerSelfRegistration4PINRequest.SIMDeviceData simDeviceData;
     ...
     * @return
     *     possible object is
     *     {@link CustomerSelfRegistration4PINRequest.SIMDeviceData }
     *     
     */
    public CustomerSelfRegistration4PINRequest.SIMDeviceData getSIMDeviceData() {
     ...
     *     
     */
    public void setSIMDeviceData(CustomerSelfRegistration4PINRequest.SIMDeviceData value) {
