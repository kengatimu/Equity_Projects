 ...
 * 创建顶级组织
 * 
 * <p>Java class for CreateTopOrgRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CreateTopOrgRequest"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="CentralOwnedAcctModel" type="{http://cps.huawei.com/cpsinterface/common}IDType" minOccurs="0"/&gt;
 *         &lt;element name="AggregatorAcctModel" type="{http://cps.huawei.com/cpsinterface/common}IDType" minOccurs="0"/&gt;
...
@XmlType(name = "CreateTopOrgRequest", propOrder = {
    "shortCode",
    "organizationName",
    "chargeProfileID",
    "ruleProfileID",
    "centralOwnedAcctModel",
    "aggregatorAcctModel",
    "simpleKYCUpdateData",
...
public class CreateTopOrgRequest {
    ...
    @XmlElement(name = "CentralOwnedAcctModel")
    protected String centralOwnedAcctModel;
    ...
    /**
     * Gets the value of the centralOwnedAcctModel property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getCentralOwnedAcctModel() {
        return centralOwnedAcctModel;
    }

    /**
     * Sets the value of the centralOwnedAcctModel property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setCentralOwnedAcctModel(String value) {
        this.centralOwnedAcctModel = value;
    }
