 ...
 * 查询客户积分的结果消息
 * 
 * <p>Java class for QueryCustomerPointsResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="QueryCustomerPointsResult"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "QueryCustomerPointsResult", propOrder = {
    "pointsList"
})
public class QueryCustomerPointsResult {

    @XmlElement(name = "PointsList")
    protected QueryCustomerPointsResult.PointsList pointsList;
     ...
     * @return
     *     possible object is
     *     {@link QueryCustomerPointsResult.PointsList }
     *     
     */
    public QueryCustomerPointsResult.PointsList getPointsList() {
        return pointsList;
    }
     ...
     *     
     */
    public void setPointsList(QueryCustomerPointsResult.PointsList value) {
    ...
    public static class PointsList {
        ...
        protected List<QueryCustomerPointsResult.PointsList.Point> point;
        @XmlElement(name = "PointSummary")
        protected List<QueryCustomerPointsResult.PointsList.PointSummary> pointSummary;
         ...
         * {@link QueryCustomerPointsResult.PointsList.Point }
         * 
         * 
         */
        public List<QueryCustomerPointsResult.PointsList.Point> getPoint() {
            if (point == null) {
                point = new ArrayList<QueryCustomerPointsResult.PointsList.Point>();
            }
            return this.point;
        }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link QueryCustomerPointsResult.PointsList.PointSummary }
         * 
         * 
         */
        public List<QueryCustomerPointsResult.PointsList.PointSummary> getPointSummary() {
            if (pointSummary == null) {
                pointSummary = new ArrayList<QueryCustomerPointsResult.PointsList.PointSummary>();
            }
