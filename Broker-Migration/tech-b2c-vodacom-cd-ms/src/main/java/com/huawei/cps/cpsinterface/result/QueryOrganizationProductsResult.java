 ...
 * 查询Organization的产品
 * 
 * <p>Java class for QueryOrganizationProductsResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="QueryOrganizationProductsResult"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "QueryOrganizationProductsResult", propOrder = {
    "boCompletedTime",
    "productData"
})
public class QueryOrganizationProductsResult {

    @XmlElement(name = "BOCompletedTime", required = true)
    protected String boCompletedTime;
    @XmlElement(name = "ProductData", required = true)
    protected QueryOrganizationProductsResult.ProductData productData;
     ...
     * @return
     *     possible object is
     *     {@link QueryOrganizationProductsResult.ProductData }
     *     
     */
    public QueryOrganizationProductsResult.ProductData getProductData() {
        return productData;
    }
     ...
     *     
     */
    public void setProductData(QueryOrganizationProductsResult.ProductData value) {
