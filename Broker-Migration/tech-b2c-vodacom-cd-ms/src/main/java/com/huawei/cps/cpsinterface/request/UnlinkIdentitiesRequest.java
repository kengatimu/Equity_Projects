...
/**
 * Unlink Identities操作的请求消息
 * 
 * <p>Java class for UnlinkIdentitiesRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UnlinkIdentitiesRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "UnlinkIdentitiesRequest", propOrder = {
    "identity"
})
public class UnlinkIdentitiesRequest {

    @XmlElement(name = "Identity", required = true)
    protected List<UnlinkIdentitiesRequest.Identity> identity;
     ...
     * {@link UnlinkIdentitiesRequest.Identity }
     * 
     * 
     */
    public List<UnlinkIdentitiesRequest.Identity> getIdentity() {
        if (identity == null) {
            identity = new ArrayList<UnlinkIdentitiesRequest.Identity>();
        }
