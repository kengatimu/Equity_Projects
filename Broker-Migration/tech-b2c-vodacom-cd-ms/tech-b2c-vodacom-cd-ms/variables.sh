...
startClass=com.equitybankgroup.payments.b2c.VodacomB2CApplication
...
# building jar name
jarFileName=tech-b2c-vodacom-cd-ms-0.0.1-SNAPSHOT.jar

# application name
applicationName=tech-b2c-vodacom-cd-ms
