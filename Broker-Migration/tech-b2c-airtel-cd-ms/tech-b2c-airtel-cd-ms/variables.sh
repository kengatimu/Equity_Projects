...
startClass=com.equitybankgroup.payments.b2c.AirtelB2CApplication
...
# building jar name
jarFileName=tech-b2c-airtel-cd-ms-0.0.1-SNAPSHOT.jar

# application name
applicationName=tech-b2c-airtel-cd-ms
