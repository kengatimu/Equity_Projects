...
startClass=com.equitybank.gag.orange_money_ms.OrangeMoneyMsApplication
...
# building jar name
jarFileName=tech-b2c-orange-cd-ms-0.0.1-SNAPSHOT.jar

# application name
applicationName=tech-b2c-orange-cd-ms
