package com.equitybank.gag.mtn_money_ms.entity;
...
//@Table(name = "Telco_B2C_Payload_Details", indexes = {
...
public class PayloadDetails implements Serializable {
    ...
    @Lob
    @Column(name = "channel_request", columnDefinition = "LONGTEXT")
    ...
    @Lob
    @Column(name = "fin_iso_request", columnDefinition = "LONGTEXT")
    private String finIsoRequest;

    @Lob
    @Column(name = "fin_iso_response", columnDefinition = "LONGTEXT")
    private String finIsoResponse;

    @Lob
    @Column(name = "channel_callback_response", columnDefinition = "LONGTEXT")
    private String channelCallbackResponse;

    @Lob
    @Column(name = "channel_status_check_req", columnDefinition = "LONGTEXT")
    private String channelStatusCheckReq;

    @Lob
    @Column(name = "channel_status_check_res", columnDefinition = "LONGTEXT")
    private String channelStatusCheckRes;

    @Lob
    @Column(name = "telco_request", columnDefinition = "LONGTEXT")
    private String telcoRequest;

    @Lob
    @Column(name = "telco_response", columnDefinition = "LONGTEXT")
    private String telcoResponse;

    @Lob
    @Column(name = "telco_status_check_req", columnDefinition = "LONGTEXT")
    private String telcoStatusCheckReq;

    @Lob
    @Column(name = "telco_status_check_res", columnDefinition = "LONGTEXT")
