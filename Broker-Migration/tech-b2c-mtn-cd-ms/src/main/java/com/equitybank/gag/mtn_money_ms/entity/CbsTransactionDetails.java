...
import com.equitybank.gag.mtn_money_ms.enums.CbsStatus;
...
public class CbsTransactionDetails implements Serializable {
    ...
    @Lob
    @Column(name = "fin_iso_request", columnDefinition = "LONGBLOB")
//    @Column(name = "fin_iso_request", columnDefinition = "LONGTEXT")
    private byte[] finIsoRequest;

    @Lob
    @Column(name = "fin_iso_response", columnDefinition = "LONGBLOB")
