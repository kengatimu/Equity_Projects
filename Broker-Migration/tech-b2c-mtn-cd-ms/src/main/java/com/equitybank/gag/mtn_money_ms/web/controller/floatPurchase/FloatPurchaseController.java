package com.equitybank.gag.mtn_money_ms.web.controller.floatPurchase;
...
public class FloatPurchaseController {
    private static final Logger log = LoggerFactory.getLogger(FloatPurchaseController.class);
    ...
    @Autowired
    public FloatPurchaseController(XmlReaderService xmlReaderService,
    ...
    @PostMapping(value = "/buyfloat",
            consumes = {MediaType.APPLICATION_XML_VALUE},
            produces = {MediaType.APPLICATION_XML_VALUE})
    public ResponseEntity<?> processFloatPurchaseRequest(@RequestBody String channelXmlRequest, BindingResult result, WebRequest webRequest) {
        String type = "floatPurchase";
        String rrn = "";
        try {
            // Get xml tag values in a map
            Map<String, String> xmlTagsMap = xmlReaderService.parseXmlString(channelXmlRequest, "float-purchase-request");
            ...
            // Process the request
            String responseXml = processRequestService.processFloatPurchaseRequest(channelXmlRequest, xmlTagsMap, rrn, type);
