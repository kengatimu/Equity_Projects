...
public class CodeTableController {
    private static final Logger log = LoggerFactory.getLogger(CodeTableController.class);
    ...
    @Autowired
    public CodeTableController(@Value("${signature.validation.isInternal}") boolean isInternal,
    ...
    public ResponseEntity<?> handleChannelRequest(@RequestBody String requestXml, WebRequest webRequest) throws CustomException {
        String type = "moneygram-code-table-service";
        String rrn = "";
        try {
            ...
            return new ResponseEntity<>(responseXml, getCspHeaders(), HttpStatus.ACCEPTED);
        } catch (Exception e) {
