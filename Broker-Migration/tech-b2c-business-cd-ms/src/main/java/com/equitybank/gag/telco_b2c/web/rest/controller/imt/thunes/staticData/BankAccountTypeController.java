...
public class BankAccountTypeController {
    private static final Logger log = LoggerFactory.getLogger(BankAccountTypeController.class);

    private final Gson gson;
    private final EnabledServicesChecker enabledServicesChecker;
    private final RequestExecutorService requestExecutorService;

    public BankAccountTypeController(Gson gson,
    ...
    @PostMapping(value = "/bank-account-type", consumes = {MediaType.APPLICATION_JSON_VALUE}, produces = {MediaType.APPLICATION_JSON_VALUE})
    public ResponseEntity<?> handleChannelRequest(@Valid @RequestBody StaticDataRequest staticDataRequest, BindingResult bindingResult, WebRequest webRequest) throws CustomException {
        String type = "thunes-static-data-bank-account-type";
