...
public class ListOfServicesController {
    private static final Logger log = LoggerFactory.getLogger(ListOfServicesController.class);

    private final Gson gson;
    private final EnabledServicesChecker enabledServicesChecker;
    private final RequestExecutorService requestExecutorService;

    public ListOfServicesController(Gson gson,
    ...
    public ResponseEntity<?> handleChannelRequest(@Valid @RequestBody ListOfThunesServices listOfThunesServices, BindingResult bindingResult, WebRequest webRequest) throws CustomException {
        String type = "thunes-list-of-services";
        ...
        try {
            ...
            log.info("{}: Received {} Request From Channel: \n{}", rrn, type, gson.toJson(listOfThunesServices));
            ChannelResponse channelResponse = requestExecutorService.executeThunesListOfServices(rrn, listOfThunesServices, bindingResult, type);
