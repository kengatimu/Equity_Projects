package com.equitybank.gag.telco_b2c.web.rest.controller.imt.moneyGram.outbound;
...
@RestController
@RequestMapping(path = "/api/v1/moneygram/outbound")
public class MoneyGramCallbackController {
    private static final Logger log = LoggerFactory.getLogger(MoneyGramCallbackController.class);
    ...
    @Autowired
    public MoneyGramCallbackController(@Value("${signature.validation.isInternal}") boolean isInternal,
    ...
    @PostMapping(value = "/commitCallback",
    ...
    public ResponseEntity<?> handleOmniRequest(@RequestBody String requestXml, WebRequest webRequest) throws CustomException {
        String type = "moneygram-commit-callback";
        String rrn = "";
        try {
            ...
            enabledServicesChecker.checkServiceStatus(enabledServicesChecker.isMoneygramOutboundEnabled(), type + " service");
            ...
            log.info("{}: Returned {} Success Response To Technical Service: \n{}", rrn, type, responseXml);
