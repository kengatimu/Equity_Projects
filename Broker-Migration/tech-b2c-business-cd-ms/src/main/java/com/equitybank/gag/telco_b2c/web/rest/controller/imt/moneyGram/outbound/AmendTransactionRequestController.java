...
public class AmendTransactionRequestController {
    private static final Logger log = LoggerFactory.getLogger(AmendTransactionRequestController.class);
    ...
    @Autowired
    public AmendTransactionRequestController(@Value("${signature.validation.isInternal}") boolean isInternal,
    ...
    @PostMapping(value = "/amendTransaction",
    ...
    public ResponseEntity<?> handleOmniRequest(@RequestBody String requestXml, WebRequest webRequest) throws CustomException {
        String type = "moneygram-amend-transaction";
        String rrn = "";
        try {
