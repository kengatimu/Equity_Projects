package com.equitybank.gag.telco_b2c.web.rest.controller.imt.thunes.staticData;
...
public class PurposeOfPaymentController {
    private static final Logger log = LoggerFactory.getLogger(PurposeOfPaymentController.class);

    private final Gson gson;
    private final EnabledServicesChecker enabledServicesChecker;
    private final RequestExecutorService requestExecutorService;

    public PurposeOfPaymentController(Gson gson,
    ...
    @PostMapping(value = "/purpose-of-payment", consumes = {MediaType.APPLICATION_JSON_VALUE}, produces = {MediaType.APPLICATION_JSON_VALUE})
    public ResponseEntity<?> handleChannelRequest(@Valid @RequestBody StaticDataRequest staticDataRequest, BindingResult bindingResult, WebRequest webRequest) throws CustomException {
        String type = "thunes-static-data-purpose-of-payment";
        ...
        try {
            ...
            log.info("{}: Received {} Request From Channel: \n{}", rrn, type, gson.toJson(staticDataRequest));
            ChannelResponse channelResponse = requestExecutorService.executeThunesStaticData(rrn, staticDataRequest, bindingResult, type);
