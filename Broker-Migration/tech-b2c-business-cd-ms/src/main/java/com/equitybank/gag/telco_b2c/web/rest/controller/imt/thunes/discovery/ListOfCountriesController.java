...
public class ListOfCountriesController {
    private static final Logger log = LoggerFactory.getLogger(ListOfCountriesController.class);

    private final Gson gson;
    private final EnabledServicesChecker enabledServicesChecker;
    private final RequestExecutorService requestExecutorService;

    public ListOfCountriesController(Gson gson,
    ...
    public ResponseEntity<?> handleChannelRequest(@Valid @RequestBody ListOfThunesCountries listOfThunesCountries, BindingResult bindingResult, WebRequest webRequest) throws CustomException {
        String type = "thunes-list-of-countries";
        ...
        try {
            ...
            log.info("{}: Received {} Request From Channel: \n{}", rrn, type, gson.toJson(listOfThunesCountries));
            ChannelResponse channelResponse = requestExecutorService.executeThunesListOfCountries(rrn, listOfThunesCountries, bindingResult, type);
