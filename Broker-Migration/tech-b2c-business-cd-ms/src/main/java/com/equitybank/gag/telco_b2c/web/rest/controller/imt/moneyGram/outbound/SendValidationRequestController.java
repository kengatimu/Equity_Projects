...
public class SendValidationRequestController {
    private static final Logger log = LoggerFactory.getLogger(SendValidationRequestController.class);
    ...
    @Autowired
    public SendValidationRequestController(@Value("${signature.validation.isInternal}") boolean isInternal,
    ...
    @PostMapping(value = "/sendValidation",
    ...
    public ResponseEntity<?> handleOmniRequest(@RequestBody String requestXml, WebRequest webRequest) throws CustomException {
        String type = "moneygram-send-validation-request";
        String rrn = "";
        try {
