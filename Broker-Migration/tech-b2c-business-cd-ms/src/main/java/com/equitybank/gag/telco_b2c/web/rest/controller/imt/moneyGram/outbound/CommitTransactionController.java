...
public class CommitTransactionController {
    private static final Logger log = LoggerFactory.getLogger(CommitTransactionController.class);
    ...
    @Autowired
    public CommitTransactionController(@Value("${signature.validation.isInternal}") boolean isInternal,
    ...
    public ResponseEntity<?> handleOmniRequest(@RequestBody String requestXml, WebRequest webRequest) throws CustomException {
        String type = "moneygram-commit-transaction";
        String rrn = "";
        try {
