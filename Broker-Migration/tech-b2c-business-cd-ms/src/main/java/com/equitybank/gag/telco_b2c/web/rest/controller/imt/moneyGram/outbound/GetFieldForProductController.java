...
public class GetFieldForProductController {
    private static final Logger log = LoggerFactory.getLogger(GetFieldForProductController.class);
    ...
    @Autowired
    public GetFieldForProductController(@Value("${signature.validation.isInternal}") boolean isInternal,
    ...
    @PostMapping(value = "/getFieldsForProduct",
    ...
    public ResponseEntity<?> handleOmniRequest(@RequestBody String requestXml, WebRequest webRequest) throws CustomException {
        String type = "moneygram-get-field-for-product";
        String rrn = "";
        try {
