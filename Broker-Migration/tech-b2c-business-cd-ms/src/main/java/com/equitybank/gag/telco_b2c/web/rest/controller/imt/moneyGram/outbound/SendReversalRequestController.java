...
public class SendReversalRequestController {
    private static final Logger log = LoggerFactory.getLogger(SendReversalRequestController.class);
    ...
    @Autowired
    public SendReversalRequestController(@Value("${signature.validation.isInternal}") boolean isInternal,
    ...
    @PostMapping(value = "/sendReversal",
    ...
    public ResponseEntity<?> handleOmniRequest(@RequestBody String requestXml, WebRequest webRequest) throws CustomException {
        String type = "moneygram-send-reversal";
        String rrn = "";
        try {
