...
public class DetailsLookupController {
    private static final Logger log = LoggerFactory.getLogger(DetailsLookupController.class);
    ...
    @Autowired
    public DetailsLookupController(@Value("${signature.validation.isInternal}") boolean isInternal,
    ...
    @PostMapping(value = "/detailLookup",
    ...
    public ResponseEntity<?> handleOmniRequest(@RequestBody String requestXml, WebRequest webRequest) throws CustomException {
        String type = "moneygram-detail-lookup";
        String rrn = "";
        try {
