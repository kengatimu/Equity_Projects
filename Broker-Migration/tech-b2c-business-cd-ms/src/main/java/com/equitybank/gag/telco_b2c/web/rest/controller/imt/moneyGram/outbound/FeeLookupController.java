...
public class FeeLookupController {
    private static final Logger log = LoggerFactory.getLogger(FeeLookupController.class);
    ...
    @Autowired
    public FeeLookupController(@Value("${signature.validation.isInternal}") boolean isInternal,
    ...
    public ResponseEntity<?> handleOmniRequest(@RequestBody String requestXml, WebRequest webRequest) throws CustomException {
        String type = "moneygram-fee-lookup";
        String rrn = "";
        try {
            ...
            log.info("{}: Received MoneyGram Fee Lookup Request XML: \n{}", rrn, requestXml);
            ...
            log.info("{}: Returned MoneyGram Fee Lookup Success Response To Channel: \n{}", rrn, responseXml);
