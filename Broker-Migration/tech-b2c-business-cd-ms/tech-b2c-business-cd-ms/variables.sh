...
startClass=com.equitybank.gag.telco_b2c.TelcoB2cMsApplication
...
# building jar name
jarFileName=tech-b2c-business-cd-ms-0.0.1-SNAPSHOT.jar

# application name
applicationName=tech-b2c-business-cd-ms
