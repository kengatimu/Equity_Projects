...
public class AirtimeTelcoController {
    private static final Logger log = LoggerFactory.getLogger(AirtimeTelcoController.class);

    private final TelcoTransactionProcessService transactionProcessService;
    private final Gson gson;

    @Autowired
    public AirtimeTelcoController(TelcoTransactionProcessService transactionProcessService,
                                  Gson gson) {
        this.transactionProcessService = transactionProcessService;
        this.gson = gson;
    }
    @PostMapping(path = "/AirTimeTopUpWSService/AirTimeTopUp",
