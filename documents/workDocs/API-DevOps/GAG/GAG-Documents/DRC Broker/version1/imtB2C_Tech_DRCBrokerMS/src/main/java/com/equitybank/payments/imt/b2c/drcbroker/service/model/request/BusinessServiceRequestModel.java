...
public class BusinessServiceRequestModel implements Serializable {

    @JsonProperty("eazzycash")
    private Eazzycash eazzycash;
    private final static long serialVersionUID = -6703479506961568559L;
    ...
    public String toString() {
        ...
        sb.append(BusinessServiceRequestModel.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("eazzycash");
        sb.append('=');
