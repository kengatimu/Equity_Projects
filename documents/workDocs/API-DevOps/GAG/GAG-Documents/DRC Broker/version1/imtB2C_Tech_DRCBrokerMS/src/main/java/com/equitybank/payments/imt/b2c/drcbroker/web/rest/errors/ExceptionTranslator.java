...
//
//import com.equitybank.payments.imt.b2c.drcbroker.service.model.response.GenericBusinessServiceResModel;
...
//        //build the response
//        Gson gson = new Gson();
//        String toJson = gson.toJson(problem.getParameters().get("fieldErrors"));
//        GenericBusinessServiceResModel finalResponse = new GenericBusinessServiceResModel();
//
//        //JsonArray Impl
//        JSONArray jsonarray;
...
//        String message;
//        try {
//            jsonarray = new JSONArray(toJson);
//            jsonObject = jsonarray.getJSONObject(0);
//            message = jsonObject.getString("message");
//
//        } catch (Exception e) {
//            finalResponse.setStatus("Failed");
//            finalResponse.setStatusCode("01");
//            finalResponse.setStatusDesc(e.getMessage());
//            log.error("JsonException Occurred::: " + e.getMessage());
//            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(finalResponse);
//        }
//        finalResponse.setStatus("Failed");
//        finalResponse.setStatusCode("01");
//        finalResponse.setStatusDesc(message);
//
//        log.info("Fields Entry Validation Exception Catcher ::: " + message);
//        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(finalResponse);
//
...
//            "io.",
//            "de.",
//            "com.equitybank.payments.interbank.business"
//        );
//    }
//}
