<?xml version="1.0"?>
 <xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:variable name="file1">../Renderer/Customization/55/cif/resource/AccountFields_<xsl:value-of select="$locale"/>.xml</xsl:variable>
...
/* ***** Tracker# 97236 CIF - EBanking Changes : End ***** */
	...
	<xsl:attribute name="onload">load();validateStaffFlag();loadDisable();custFnLoad();loadSalutation();introdSalutation();selectFieldAcc();
...
<!--TrackerID: 113227 end of changes-->
	...
	<xsl:template name="AccountBO.StrUserField20">
		...
		<xsl:with-param name="selectname">AccountBO.StrUserField20</xsl:with-param>
