...
<xsl:variable name="file1">../Renderer/Customization/50/corpcif/resource/CorpCustOnboard_<xsl:value-of select="$locale"/>.xml</xsl:variable>
...
<script language='javascript'>
	...
	function RefNumValidation()
	{
		...
		var doc_code = document.getElementsByName('documenttype')[0].value;
