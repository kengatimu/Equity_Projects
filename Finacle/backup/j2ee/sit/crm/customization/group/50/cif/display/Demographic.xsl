...
<xsl:variable name="configFile_4" select="SRM"/>
    ...
    <xsl:variable name="file5">../Renderer/cif/resource/DemographicOtherDetails_<xsl:value-of select="$locale"/>.xml</xsl:variable>
...
<!-- TrackerID:209607,CHANGES START -->
    ...
    <script type="text/javascript" src="../Customization/js/DemographicCustom.js" language="javascript"></script>
	<script type="text/javascript" src="../common/html/Rendvalidate.js"></script>
	<script type="text/javascript" src="../common/html/RendvalidateL2.js"></script>
		<script type="text/javascript" src="../common/html/utils.js"></script>
...
/*IDENTIFICATION DOCUMENT CHANGES end*/
    ...
    <LINK REL="stylesheet" Type="text/css" href="../Branding/css/common/SRMListTemplate_{$locale}.css"/>
	 ...
	 <script type="text/javascript" src="../common/html/calendar.js" language="javascript"></script>
	<!-- vasanth's changes end -->
    ...
    function fnSetMandatory(){
		...
		if(boName=='DemographicBO'){
			...
			/* Tracker Id : 129978 BEGIN OF CHANGES */
				    ...
				    var object = document.getElementsByName("Passport Number.txt_Valid_Date")[0];
				    object.setAttribute('IsMandatory','false');
				    var object1 = document.getElementsByName("Passport Number.txt_ID")[0];
				    object1.setAttribute('IsMandatory','false');
				    /* Tracker Id : 69162 BEGIN OF CHANGES  */
				    var object2=document.getElementsByName("Passport Number.txt_Issue_Date")[0];
				    object2.setAttribute('IsMandatory','false');
				    var object3=document.getElementsByName("Passport Number.txt_Issue_Place")[0];
				    object3.setAttribute('IsMandatory','false');
				    /* Tracker Id : 69162 END OF CHANGES  */
		...
		if(document.frm2.isMCEditedDemo.value=="N"){
	     ...
	     if(suspID !=""){
		  ...
		  if(mainAccId != ''){
			  entityType = entityType+"Mod";
			  if(acctID == ''){
				accountId = savedID;//863373 TOL Changes
			  }
		  }
				...
				if(operationType!="Edit Entity"){
					if(operationType!="Queue"){
						try{
							...
							document.frm2.isMCEditedDemo.value=parent.parent.IFrmtab0.formDispFrame.contentDocument.frm2.isMCEditedGeneral.value;
						}
...
/* Changes for Tracker # 88712 End */
	...
	EntityType = Type;
	 ...
	 var accountId;
	 try{
		accountId = parent.parent.IFrmtab0.formDispFrame.document.getElementsByName("accID")[0].value;
	 }catch(e){
		accountId = parent.parent.IFrmtab0.formDispFrame.contentDocument.getElementsByName("accID")[0].value;
	 }
...
//                        document.frm2.YY.value = document.frm2.YY.value + " ," + srmEscape(edu_YY[i], '^', escChars);
		...
		if(Type == "Account"){
			try{
				...
				document.getElementsByName("accKey")[0].value = parent.parent.IFrmtab0.formDispFrame.contentDocument.getElementsByName("accKey")[0].value;
			}
			...
			try{
				...
				document.getElementsByName("ModAccID")[0].value = parent.parent.IFrmtab0.formDispFrame.contentDocument.getElementsByName("ModAccID")[0].value;
			}
			...
			try{
				...
				document.getElementsByName("CoreCustID")[0].value = parent.parent.IFrmtab0.formDispFrame.contentDocument.getElementsByName("CoreCustID")[0].value;
			}
			...
			try{
				...
				document.getElementsByName("accKey")[0].value = parent.parent.IFrmtab0.formDispFrame.contentDocument.getElementsByName("susKey")[0].value;
			}
			...
			try{
				...
				document.getElementsByName("ModAccID")[0].value = parent.parent.IFrmtab0.formDispFrame.contentDocument.getElementsByName("modSusID")[0].value;
			}
			...
			try{
				...
				document.getElementsByName("accKey")[0].value = parent.parent.IFrmtab0.formDispFrame.contentDocument.getElementsByName("contKey")[0].value;
			}
			...
			try{
				...
				document.getElementsByName("ModAccID")[0].value = parent.parent.IFrmtab0.formDispFrame.contentDocument.getElementsByName("modContID")[0].value;
			}
...
/*IDENTIFICATION DOCUMENT CHANGES end*/
	...
	function disableFields() {
		if(document.frm2.elements["Cat_DemographicBO.Residence_Country"].value != null &amp;&amp; document.frm2.elements["Cat_DemographicBO.Residence_Country"].value != "") { 
			/***10.2.18:TOL-878441***/
			document.getElementsByName("3_DemographicBO.Residence_Since")[0].disabled = false;
			/***10.2.18:TOL-878441***/
			document.getElementsByTagName("img")[0].disabled = false;
			document.getElementsByTagName("img")[0].style.visibility = "visible";
			document.getElementsByTagName("a")[0].disabled = false;
			document.getElementsByTagName("a")[0].style.visibility = "visible";		
		}
		else {
			document.frm2.elements["3_DemographicBO.Residence_Since"].value = "";
			/***10.2.18:TOL-878441***/
			document.getElementsByName("3_DemographicBO.Residence_Since")[0].disabled = true;
			/***10.2.18:TOL-878441***/
			document.getElementsByTagName("img")[0].disabled = true;
			document.getElementsByTagName("img")[0].style.visibility = "hidden";
			document.getElementsByTagName("a")[0].disabled = true;
	...
	//Changes for call id 433698 ENDS
        ...
        try{
            ...
            //changes start for tol id 700121
			var profession = document.getElementsByName("DemographicBO.MiscellaneousInfo.strText2")[0];
            var Industry = document.getElementsByName("DemographicBO.MiscellaneousInfo.strText3")[0];
            var Designation = document.getElementsByName("DemographicBO.MiscellaneousInfo.strText8")[0];
            //changes end for tol id 700121
...
//Changes for call id 434730 STARTS   
   function formatfields(){  
	...
	<!-- Fix for 729215 starts -->
	strText5 = strText5.substring(0, strText5.length);
	...
	strText6 = strText6.substring(0, strText6.length);
	...
	strText28 = strText28.substring(0, strText28.length);
	<!-- Fix for 729215 ends -->
...
/* function showIncomeTabOnly(){
        ...
        try{
           ...
           if(elem.options[elem.selectedIndex].value == 'Self employed'){
            //check if data present in otherfields if yes
                ...
                <!-- CRM62MNT:TRACKER# 55270 **END   CHANGES** -->
                document.getElementsByName("3_DemographicBO.Annual_Salary_Income")[0].setAttribute('IsMandatory','false');	//Fix for ticket 245768
   ...
   <!-- Fix as a part of ticket 351273 Ends -->
    ...
    <!-- Fix as a part of ticket 437856 Starts -->    
        <xsl:attribute name="onload">showInReadOnlyMode('<xsl:value-of select="$readMode" />');onEmpl("");load();chkBSN();loadBaseCurrency();loadCode();formatDemographyAmount();PreviousEmploymentDetails();showInReadOnlyMode('<xsl:value-of select="$readMode"/>');</xsl:attribute>
    ...
    <!-- Fix as a part of ticket 437856 Starts -->
    <!-- Fix for tracker 278386 Starts -->
    <xsl:attribute name="onload">disableFields();populateExRates();chkBSN();onEmpl("");showbuttonsVisible(30);load();loadBaseCurrency();checkESFields();loadCode();formatDemographyAmount();PreviousEmploymentDetails();</xsl:attribute>
    <!-- Fix for tracker 278386 Ends -->
    <!-- Fix as a part of ticket 437856 Ends-->
    <!-- Fix as a part of ticket 351273 Ends-->
...
-->
      <xsl:template name="DemographicBO.Annual_Salary_Income">
			...
			<!--- changes for call 691536-->
                <xsl:with-param name="fncname">rate("3_DemographicBO.Annual_Salary_Income","<xsl:value-of select="$boName"/>.CU_Annual_Salary_Income",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
		...
		<xsl:with-param name="choicename">Currency</xsl:with-param>
         ...
         <xsl:template name="DemographicBO.Annual_Rental_Income">
			...
			<!--- changes for call 691536-->
                <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.Annual_Rental_Income</xsl:with-param>  <xsl:with-param name="fncname">rate("3_DemographicBO.Annual_Rental_Income","<xsl:value-of select="$boName"/>.CU_Annual_Rental_Income",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
         ...
         <xsl:template name="DemographicBO.Annual_Stock_Bond_Income">
			...
			<!--- changes for call 691536-->
                <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.Annual_Stock_Bond_Income</xsl:with-param>  <xsl:with-param name="fncname">rate("3_DemographicBO.Annual_Stock_Bond_Income","<xsl:value-of select="$boName"/>.CU_Annual_Stock_Bond_Income",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
...
<!--Field Addition Tracker 172089:end of Changes-->
 ...
 <!-- Tracker id 113276 changes start -->
		 ...
		 <!-- Modify the amount field template name -->
		 	<!--- changes for call 691536-->
		<xsl:with-param name="fncname">rate("3_DemographicBO.Annual_Others_Income","<xsl:value-of select="$boName"/>.CU_Annual_Others_Income",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
...
<!-- CRM62MNT:TRACKER# 55270 **END   CHANGES** -->
    ...
    <xsl:template name="DemographicBO.Annual_Operating_Exp">
       <xsl:call-template name="amountlabel">
	 	...
	 	<!--- changes for call 691536-->
         <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.Annual_Operating_Exp</xsl:with-param> <xsl:with-param name="fncname">rate("3_DemographicBO.Annual_Operating_Exp","<xsl:value-of select="$boName"/>.CU_Annual_Operating_Exp",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
	 	...
	 	<!--- changes for call 691536-->
         <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.Annual_IntProd_Exp</xsl:with-param>   <xsl:with-param name="fncname">rate("3_DemographicBO.Annual_IntProd_Exp","<xsl:value-of select="$boName"/>.CU_Annual_IntProd_Exp",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
    ...
    <xsl:with-param name="onchangefn">checkDropValue("3_DemographicBO.Annual_IntProd_Exp","<xsl:value-of select="$boName"/>.CU_Annual_IntProd_Exp");</xsl:with-param>
	 	...
	 	<!--- changes for call 691536-->
         <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.Annual_Loan_Instal</xsl:with-param>   <xsl:with-param name="fncname">rate("3_DemographicBO.Annual_Loan_Instal","<xsl:value-of select="$boName"/>.CU_Annual_Loan_Instal",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
    ...
    <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.Annual_ExtProd_Exp</xsl:with-param>
    	<!--- changes for call 691536-->
    <xsl:with-param name="fncname">rate("3_DemographicBO.Annual_ExtProd_Exp","<xsl:value-of select="$boName"/>.CU_Annual_ExtProd_Exp",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
     ...
     <xsl:template name="DemographicBO.Annual_Commit_Exp">
        <xsl:call-template name="amountlabel">
          <xsl:with-param name="res_name" select="$configLabels_3[@name='DemographicBO.Annual_Commit_Exp']"/>
	     	...
	     	<!--- changes for call 691536-->
             <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.Annual_Commit_Exp</xsl:with-param>    <xsl:with-param name="fncname">rate("3_DemographicBO.Annual_Commit_Exp","<xsl:value-of select="$boName"/>.CU_Annual_Commit_Exp",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
      ...
      <xsl:template name="DemographicBO.Annual_Other_Exp">
         <xsl:call-template name="amountlabel">
	   	...
	   	<!--- changes for call 691536-->
           <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.Annual_Other_Exp</xsl:with-param>   <xsl:with-param name="fncname">rate("3_DemographicBO.Annual_Other_Exp","<xsl:value-of select="$boName"/>.CU_Annual_Other_Exp",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
            ...
            <!-- User Field5-->
              ...
              <xsl:template name="DemographicBO.MiscellaneousInfo.EmployeeID">
                 <xsl:call-template name="label">
					  ...
					  <!--Changes for call id:::666106  begins-->
					  <xsl:with-param name="max_length">10</xsl:with-param>
					   <!--Changes for call id:::666106  ends -->
                      <xsl:with-param name="UsrDataSpace">CURRENTEMPLOYMENT</xsl:with-param>
               </xsl:call-template>
            </xsl:template>
...
<!-- vinaya : Income / expenses for salaried start -->
      <xsl:template name="DemographicBO.SalAllowances">
         <xsl:call-template name="amountlabel">
	     	...
	     	<!--- changes for call 691536-->
             <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.SalAllowances</xsl:with-param>    <xsl:with-param name="fncname">rate("3_DemographicBO.SalAllowances","<xsl:value-of select="$boName"/>.CU_SalAllowances",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
    ...
    <xsl:template name="DemographicBO.SalProrataMonthlyIncentive">
         <xsl:call-template name="amountlabel">
           <xsl:with-param name="res_name" select="$configLabels_3[@name='DemographicBO.SalProrataMonthlyIncentive']"/>
	     	...
	     	<!--- changes for call 691536-->
             <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.SalProrataMonthlyIncentive</xsl:with-param>   <xsl:with-param name="fncname">rate("3_DemographicBO.SalProrataMonthlyIncentive","<xsl:value-of select="$boName"/>.CU_SalProrataMonthlyIncentive",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
	    ...
	    <xsl:with-param name="choicename">Currency</xsl:with-param>
         ...
         <xsl:template name="DemographicBO.SalInterestSubsidy">
            <xsl:call-template name="amountlabel">
		 	...
		 	<!--- changes for call 691536-->
                 <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.SalInterestSubsidy</xsl:with-param>   <xsl:with-param name="fncname">rate("3_DemographicBO.SalInterestSubsidy","<xsl:value-of select="$boName"/>.CU_SalInterestSubsidy",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
		...
		<xsl:with-param name="choicename">Currency</xsl:with-param>
         ...
         <xsl:template name="DemographicBO.SalOtherIncome2">
            <xsl:call-template name="amountlabel">
		 	...
		 	<!--- changes for call 691536-->
                 <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.SalOtherIncome2</xsl:with-param>  <xsl:with-param name="fncname">rate("3_DemographicBO.SalOtherIncome2","<xsl:value-of select="$boName"/>.CU_SalOtherIncome2",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
     ...
     <xsl:template name="DemographicBO.SalOtherIncome3">
         <xsl:call-template name="amountlabel">
	    	...
	    	<!--- changes for call 691536-->
            <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.SalOtherIncome3</xsl:with-param>   <xsl:with-param name="fncname">rate("3_DemographicBO.SalOtherIncome3","<xsl:value-of select="$boName"/>.CU_SalOtherIncome3",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
    ...
    <xsl:template name="DemographicBO.TotalEstAccountValue">
        <xsl:call-template name="amountlabel">
	    	...
	    	<!--- changes for call 691536-->
            <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.TotalEstAccountValue</xsl:with-param>  <xsl:with-param name="fncname">rate("3_DemographicBO.TotalEstAccountValue","<xsl:value-of select="$boName"/>.CU_TotalEstAccountValue",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
    ...
    <xsl:template name="DemographicBO.TotalEstAccountValue_SelfEmployed">
        <xsl:call-template name="amountlabel">
	    	...
	    	<!--- changes for call 691536-->
            <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.TotalEstAccountValue</xsl:with-param>  <xsl:with-param name="fncname">rate("3_DemographicBO.TotalEstAccountValue","<xsl:value-of select="$boName"/>.CU_TotalEstAccountValue_SelfEmployed",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
      ...
      <xsl:template name="DemographicBO.TotalInvestmentInSharesandUnits">
         <xsl:call-template name="amountlabel">
	     	...
	     	<!--- changes for call 691536-->
             <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.TotalInvestmentInSharesandUnits</xsl:with-param>  <xsl:with-param name="fncname">rate("3_DemographicBO.TotalInvestmentInSharesandUnits","<xsl:value-of select="$boName"/>.CU_TotalInvestmentInSharesandUnits",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
     ...
     <xsl:template name="DemographicBO.TotalMonthlyDebtServiceAmt">
         <xsl:call-template name="amountlabel">
	     	...
	     	<!--- changes for call 691536-->
             <xsl:with-param name="fncname">rate("3_DemographicBO.TotalMonthlyDebtServiceAmt","<xsl:value-of select="$boName"/>.CU_TotalMonthlyDebtServiceAmt",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
    ...
    <xsl:template name="DemographicBO.SelfempGrossReciptCurrentYR">
         <xsl:call-template name="amountlabel">
            <xsl:with-param name="res_name" select="$configLabels_3[@name='DemographicBO.SelfempGrossReciptCurrentYR']"/>
	     	...
	     	<!--- changes for call 691536-->
             <xsl:with-param name="fncname">rate("3_DemographicBO.SelfempGrossReciptCurrentYR","<xsl:value-of select="$boName"/>.CU_SelfempGrossReciptCurrentYR",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
     ...
     <xsl:template name="DemographicBO.SelfempGrossReceiptPriorYear">
          <xsl:call-template name="amountlabel">
	      	...
	      	<!--- changes for call 691536-->
              <xsl:with-param name="fncname">rate("3_DemographicBO.SelfempGrossReceiptPriorYear",'<xsl:value-of select="$boName"/>.CU_SelfempGrossReceiptPriorYear','<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
        ...
        <xsl:template name="DemographicBO.SelfempNetProfitCurrentYR">
			...
			<!--- changes for call 691536-->
                <xsl:with-param name="fncname">rate("3_DemographicBO.SelfempNetProfitCurrentYR",'<xsl:value-of select="$boName"/>.CU_SelfempNetProfitCurrentYR','<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
        ...
        <xsl:template name="DemographicBO.SelfempNetProfitPriorYR">
           <xsl:call-template name="amountlabel">
	      	...
	      	<!--- changes for call 691536-->
              <xsl:with-param name="fncname">rate("3_DemographicBO.SelfempNetProfitPriorYR",'<xsl:value-of select="$boName"/>.CU_SelfempNetProfitPriorYR','<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
       ...
       <xsl:template name="DemographicBO.SelfempDepreciationCurrentYear">
         <xsl:call-template name="amountlabel">
	     	...
	     	<!--- changes for call 691536-->
             <xsl:with-param name="fncname">rate("3_DemographicBO.SelfempDepreciationCurrentYear",'<xsl:value-of select="$boName"/>.CU_SelfempDepreciationCurrentYear','<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
     ...
     <xsl:template name="DemographicBO.SelfempDepreciationPriorYear">
         <xsl:call-template name="amountlabel">
            <xsl:with-param name="res_name" select="$configLabels_3[@name='DemographicBO.SelfempDepreciationPriorYear']"/>
	     	...
	     	<!--- changes for call 691536-->
             <xsl:with-param name="fncname">rate("3_DemographicBO.SelfempDepreciationPriorYear","DemographicBO.CU_SelfempDepreciationPriorYear",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
      ...
      <xsl:template name="DemographicBO.SelfempAverageAnnualTurnover">
         <xsl:call-template name="amountlabel">
	     	...
	     	<!--- changes for call 691536-->
             <xsl:with-param name="fncname">rate("3_DemographicBO.SelfempAverageAnnualTurnover","DemographicBO.CU_SelfempAverageAnnualTurnover",'<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
...
<xsl:template name="DemographicBO.Residence_Country">
 ...
 <!--Changes for call id 433698 ENDS-->
 <xsl:with-param name="buttontwo_fnc">clearCategoryValue('DemographicBO.Residence_Country');clearCategoryValue('DemographicBO.Residence_Since');disableFields();</xsl:with-param>
 <xsl:with-param name="checkASCII">false</xsl:with-param>
 </xsl:call-template>
</xsl:template>
...
<!--changes for recon id 146406 ends-->
      ...
      <xsl:template name="DemographicBO.TotalFundBase">
			...
			<!--- changes for call 691536-->
                <xsl:with-param name="fncname">rate('3_DemographicBO.TotalFundBase','<xsl:value-of select="$boName"/>.CU_TotalFundBase','<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
      ...
      <xsl:template name="DemographicBO.TotalNonFundBase">
			...
			<!--- changes for call 691536-->
                <xsl:with-param name="fncname">rate('3_DemographicBO.TotalNonFundBase','<xsl:value-of select="$boName"/>.CU_TotalNonFundBase','<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
      ...
      <xsl:template name="DemographicBO.CustNetWorth">
			...
			<!--- changes for call 691536-->
                <xsl:with-param name="fncname">rate('3_DemographicBO.CustNetWorth','<xsl:value-of select="$boName"/>.CU_CustNetWorth','<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
        ...
        <xsl:template name="DemographicBO.OtherLimits">
			...
			<!--- changes for call 691536-->
                <xsl:with-param name="fncname">rate('3_DemographicBO.OtherLimits','<xsl:value-of select="$boName"/>.CU_OtherLimits','<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
        ...
        <xsl:template name="DemographicBO.TDSExcemptSubmitDate">
	       ...
	       <xsl:template name="DemographicBO.Tax_Exmpt_Start_Date">
	               ...
	               <xsl:template name="DemographicBO.No_Tax_Recal_Beyond_Date">
	       		           ...
	       		           <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.No_Tax_Recal_Beyond_Date</xsl:with-param>
	               ...
	               <xsl:template name="DemographicBO.Tax_Rate_Table_Code">
			         ...
			         <xsl:with-param name="eleval"><xsl:value-of select="$boName"/>.Tax_Rate_Table_Code</xsl:with-param>
			         <xsl:with-param name="buttonone_name" select="$configLabels_4[@name='BTN_LOOKUP']/@configLabel"/>
			         <xsl:with-param name="buttontwo_name" select="$configLabels_4[@name='BTN_CLEAR']/@configLabel"/>
...
<!-- Changes for Tracker # 88712 Start -->
       <xsl:template name="DemographicBO.CustBusinessAssets">
		 	...
		 	<!--- changes for call 691536-->
                 <xsl:with-param name="fncname">rate('3_DemographicBO.CustBusinessAssets','<xsl:value-of select="$boName"/>.CU_CustBusinessAssets','<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
        ...
        <xsl:template name="DemographicBO.CustPropertyAssets">
		  	...
		  	<!--- changes for call 691536-->
                  <xsl:with-param name="fncname">rate('3_DemographicBO.CustPropertyAssets','<xsl:value-of select="$boName"/>.CU_CustPropertyAssets','<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
        ...
        <xsl:template name="DemographicBO.CustDepositsInOtherBanks">
		  	...
		  	<!--- changes for call 691536-->
                  <xsl:with-param name="fncname">rate('3_DemographicBO.CustDepositsInOtherBanks','<xsl:value-of select="$boName"/>.CU_CustDepositsInOtherBanks','<xsl:value-of select="$BaseCurrency"/>');</xsl:with-param>
...
<!-- unique Id's : end -->
        ...
        <td>
			  ...
			  <!-- new added hidden : for :Copy :start -->
          	           <!-- variable for account Key-->
					   <input type="hidden" name="accKey1" id ="accKey1" value="{$accKey}"/>
          	           <input type="hidden" name="accKey" id ="accKey" value="{$accKey}"/>
          	           <!-- Core Dependency changes -->
          	           <input type="hidden" name="susKey" id="susKey" value="{$susKey}"/>
          	           <input type="hidden" name="contKey" id="contKey" value="{$contKey}"/>
          	           <!-- Core Dependency changes -->
...
<TR >
		...
		<!--Ticket ID: 190700 Changes Begin -->
		<TD  nowrap="true" valign ="top" class="d1" style='width:25%'><xsl:value-of select="$configLabels_1[@name='DemographicBO.ChannelsAccessed']/@configLabel"/></TD>
		<TD width="25%" >
		<!--Ticket ID: 190700 Changes end -->
...
<!--Field Addition Tracker 172089:end of Changes-->
	...
	<table  bgcolor='FFFFFF' width="100%" border = "0" cellspacing="0" vspace="0" hspace="0" >
		<tr style="cursor:pointer" STYLE="border-bottom: 10px black;" ID="rowdemo1" name="rowdemo1">
...
<!-- End DataArray -->
		...
		<xsl:template name="mode2">
			...
			<input type="hidden" name="miscInfoType" value=""/>
			<input type="hidden" name="Profession" value=""/>
			<input type="hidden" name="ProfessionCode" value=""/>
