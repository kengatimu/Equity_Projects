...
var custDocType = "INDIV";
var custDocCode = "DOC03";
var custDocCodeP = "PSSPT";
var custDocCodeP = "PSSPR";
if (document.getElementsByName("DemographicBO.Nationality")[0].value == cntry)
{
	...
	if(docType == custDocType)
	{
		if(docCode != custDocCode)
		{
			alert("Enter National ID Card Details");
			document.getElementsByName("EntityDocumentBO.DocTypeCode")[0].focus();
			return "false";
		}
	}
	else
...
else
{
	...
	if(docType == custDocType)
	{
		if((docCode != custDocCodeP)||(docCode != custDocCodeP1))
		{
...
{
	//alert('In else');	
	document.frm2.currencyCode.value="KES";
}
...
/*Changes by Niharika to call a new screen like Customer Onboard*/
	...
	//Commenting for BIO changes starts
