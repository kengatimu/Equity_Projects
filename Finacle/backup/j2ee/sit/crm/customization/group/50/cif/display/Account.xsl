<?xml version="1.0"?>
 <xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:variable name="file1">../Renderer/Customization/50/cif/resource/AccountFields_<xsl:value-of select="$locale"/>.xml</xsl:variable>
...
<!--sonali changes 131246-->
	...
	<xsl:variable name="Selectvalues" select="//SRMData[@SRMDataSpace='Main']/SRMComposite/Z[@n=concat($boName,'.Selectvalues')]"></xsl:variable>
...
<!--Changes for tracker id 338696 starts-->	
	...
	<xsl:variable name="Selectvalues1" select="//SRMData[@SRMDataSpace='Main']/SRMComposite/Z[@n=concat($boName,'.Selectvalues1')]"></xsl:variable>
...
<script type="text/javascript" src="../cif/js/Message_cif_{$locale}.js" language="javascript"></script>
	 ...
	 <script type="text/javascript" language="javascript" src="../Customization/cif/js/Account.js"></script>
	<!-- Deceased Start-->
   ...
   if(operationType =='Edit Entity' || operationType =='Create')
    {
		...
		//alert("test");
		ISICValue(AccKEY,'StrUserField1');
		var StrUsercheck = document.getElementsByName('AccountBO.StrUserField1')[0].value;

		document.getElementsByName('AccountBO.StrUserField1')[0].value = StrUsercheck;
		
		ISICValidation('SUB_SECTOR_CODE','.StrUserField1','.StrUserField2','SECTOR_CODE');
		ISICValue(AccKEY,'StrUserField2');

		ISICValidation('ISICP1','.StrUserField2','.StrUserField25','SUB_SECTOR_CODE');
		ISICValue(AccKEY,'StrUserField25');
			
		ISICValidation('ISICP2','.StrUserField25','.StrUserField24','ISICP1');		
		ISICValue(AccKEY,'StrUserField24');
		...
		//alert("test xxx");
        	...
        	ISICValidation('ISICP1','.StrUserField7','.StrField16','SUB_SECTOR_CODE')
        	ISICValue(AccKEY,'StrField16');
        
        	ISICValidation('ISICP2','.StrField16','.StrField18','ISICP1')
        	ISICValue(AccKEY,'StrField18');

        	ISICValidation('ISIC_DEMAND2','.StrField19','.StrUserField20','ISIC_DEMAND1')
        	ISICValue(AccKEY,'StrUserField20');       
...
function clearNIDACookies()
{
	var emptyVal = "";
	setCookie("Filter_lastName",emptyVal);
	setCookie("Filter_firstName",emptyVal);
	setCookie("Filter_dob",emptyVal);
	setCookie("Filter_city",emptyVal);
	setCookie("Filter_gender",emptyVal);
	setCookie("Filter_identNum",emptyVal);
	setCookie("Filter_placeOfBirth",emptyVal);
	setCookie("Filter_cell",emptyVal);
	setCookie("Filter_state",emptyVal);
	setCookie("Filter_issueDate",emptyVal);
	setCookie("Filter_issueLocation",emptyVal);
	setCookie("Filter_expiryDate",emptyVal);
	setCookie("Filter_photo",emptyVal);
	setCookie("Filter_docType",emptyVal);
	setCookie("Filter_sector",emptyVal);
	setCookie("Filter_NIDAResp",emptyVal);
...
function NidaLoad()
{
	...
	var onboard_time = getCookie('Filter_timeNow');
	time_diff = timeNow - onboard_time;
	//alert("time_diff>>"+time_diff);
	if(time_diff>60000)
	{
		clearNIDACookies();
	}
	var nidaDown = getCookie('Filter_NIDADown');
		//var nidaDown ="Y";
		//alert("nida"+nidaDown);
		document.getElementsByName('AccountBO.strField12')[0].readOnly = true;
		document.getElementsByName('AccountBO.strField11')[0].readOnly = true;
		if(nidaDown =="Y")
		{
		//alert("1");
			document.getElementsByName('AccountBO.strField12')[0].value = "Y";
			//alert("1123");
		}
		else{
		//alert("21");
			document.getElementsByName('AccountBO.strField12')[0].value = "N";
		}
		
		var NIDAResp = getCookie('Filter_NIDAResp');
		
	if(NIDAResp == "")
	{
		document.getElementsByName('AccountBO.strField11')[0].value = "";
		
	}
	else
	{
		document.getElementsByName('AccountBO.strField11')[0].value = NIDAResp;
		
	}
	var LastName = getCookie('Filter_lastName');
	if(LastName == "")
	{
		document.getElementsByName('AccountBO.Cust_Last_Name')[0].value = "";
		document.getElementsByName('AccountBO.Cust_Last_Name')[0].readOnly = false;
	}
	else
	{
		document.getElementsByName('AccountBO.Cust_Last_Name')[0].value = LastName.toUpperCase();
		document.getElementsByName('AccountBO.Cust_Last_Name')[0].readOnly = true;
		concatName();
		set_isName(this,true);
	}
	var FirstName = getCookie('Filter_firstName');
	if(FirstName == "")
	{
		document.getElementsByName('AccountBO.Cust_First_Name')[0].value = "";
		document.getElementsByName('AccountBO.Cust_First_Name')[0].readOnly = false;
	}
	else
	{
		document.getElementsByName('AccountBO.Cust_First_Name')[0].value = FirstName.toUpperCase();
		document.getElementsByName('AccountBO.Cust_First_Name')[0].readOnly = true;
		concatName();
		set_isName(this,true);
	}
	
	var dateOfBirth = getCookie('Filter_dob');
	if(dateOfBirth == "")
	{
		document.getElementsByName('3_AccountBO.Cust_DOB')[0].value = "";
		document.getElementsByName('3_AccountBO.Cust_DOB')[0].readOnly = false;
		document.getElementsByName('cal_AccountBO.Cust_DOB')[0].readOnly = false;
		document.getElementsByName('cal_AccountBO.Cust_DOB')[0].style.visibility = "visible";
	}
	else
	{
		dateOfBirth = convertDate(dateOfBirth);
		//alert("dateOfBirth>>"+dateOfBirth);
		document.getElementsByName('3_AccountBO.Cust_DOB')[0].value = dateOfBirth;
		document.getElementsByName('3_AccountBO.Cust_DOB')[0].readOnly = true;
		document.getElementsByName('cal_AccountBO.Cust_DOB')[0].readOnly = true;
		document.getElementsByName('cal_AccountBO.Cust_DOB')[0].style.visibility = "hidden";
	...
	var gender = getCookie('Filter_gender');
	if(gender == "")
	{
		document.getElementsByName(boName+'.Gender')[0].value = "";
		document.getElementsByName(boName+'.Gender')[0].disabled = false;
	}
	else
	{
		document.getElementsByName(boName+'.Gender')[0].value = gender;
		document.getElementsByName(boName+'.Gender')[0].disabled = true;
	}
	
	var village = getCookie('Filter_placeOfBirth');
	if(village == "")
	{
		document.getElementsByName('Cat_AccountBO.PlaceOfBirth')[0].value = "";
		document.getElementsByName('Cat_AccountBO.PlaceOfBirth')[0].readOnly = false;
	}
	else
	{
		document.getElementsByName('Cat_AccountBO.PlaceOfBirth')[0].value = village.toUpperCase();
		document.getElementsByName('Cat_AccountBO.PlaceOfBirth')[0].readOnly = true;
		fnNIDAVillageCode();
	}
	
	var cell = getCookie('Filter_cell');
	if(cell == "")
	{
		document.getElementsByName('Cat_AccountBO.strField8')[0].value = "";
		document.getElementsByName('Cat_AccountBO.strField8')[0].readOnly = false;
	}
	else
	{
		document.getElementsByName('Cat_AccountBO.strField8')[0].value = cell;
		document.getElementsByName('Cat_AccountBO.strField8')[0].readOnly = true;
		fnNIDACellCode();
	}
	document.getElementById("img").src = "data:image/jpg;base64,"+getCookie('Filter_photo');
	
	var sector = getCookie('Filter_sector');
	if(sector == "")
	{
		document.getElementsByName('Cat_AccountBO.strField9')[0].value = "";
		document.getElementsByName('Cat_AccountBO.strField9')[0].readOnly = false;
	}
	else
	{
		document.getElementsByName('Cat_AccountBO.strField9')[0].value = sector;
		document.getElementsByName('Cat_AccountBO.strField9')[0].readOnly = true;
		fnNIDASectorCode();
	}
}
function fnNIDAVillageCode()
{
	var locale = document.getElementsByName('Cat_AccountBO.PlaceOfBirth')[0].value;
	//alert("fnNIDAVillageCode start");
	var cat_type = "VILLAGE";
	var s_xmlHttp;
	var nida_village;
	try{
		//alert("fnNIDAVillageCode try start");
		...
		var strURL1 = "../servlet/com.infy.cis.custom.Cat_Code_From_Value?category="+cat_type+"&amp;value="+locale+"";
		s_xmlHttp.open("GET",strURL1,false);
		s_xmlHttp.send();
		//alert("s_xmlHttp.status>>"+s_xmlHttp.status);
		if(s_xmlHttp.status == 200)
		{
			//alert("Connection Success");
			var nodecat_1 = s_xmlHttp.responseXML.selectSingleNode("OUTPUT/CATEGORYCODE");
			nida_village = nodecat_1.text;
			//alert("nida_village>>"+nida_village);
		}
		s_xmlHttp.abort();
		if(nida_village=="")
		{
			document.getElementsByName('Cat_AccountBO.PlaceOfBirth')[0].value = "";
			document.getElementsByName('Cat_AccountBO.PlaceOfBirth')[0].readOnly = false;
			document.getElementsByName('AccountBO.PlaceOfBirth')[0].value = "";
		}
		else
		{
			document.getElementsByName('Cat_AccountBO.PlaceOfBirth')[0].value = locale.toUpperCase();
			document.getElementsByName('Cat_AccountBO.PlaceOfBirth')[0].readOnly = true;
			document.getElementsByName('AccountBO.PlaceOfBirth')[0].value = nida_village;
		}
	}
	catch(e)
	{
...
function fnNIDACellCode()
{
	var locale = document.getElementsByName('Cat_AccountBO.strField8')[0].value;
	//alert("fnNIDACellCode start");
	var cat_type = "NIDA_CELL";
	var s_xmlHttp;
	var nida_cell;
	try{
		//alert("fnNIDACellCode try start");
		if (window.XMLHttpRequest)
		{
			//alert("inside if");
			// code for IE7+, Firefox, Chrome, Opera, Safari
		...
		if(s_xmlHttp.status == 200)
		{
			//alert("Connection Success");
			var nodecat_1 = s_xmlHttp.responseXML.selectSingleNode("OUTPUT/CATEGORYCODE");
			nida_cell = nodecat_1.text;
			//alert("nida_cell>>"+nida_cell);
		}
		s_xmlHttp.abort();
		if(nida_cell=="")
		{
			document.getElementsByName('Cat_AccountBO.strField8')[0].value = "";
			document.getElementsByName('Cat_AccountBO.strField8')[0].readOnly = false;
			document.getElementsByName('AccountBO.strField8')[0].value = "";
		}
		else
		{
			document.getElementsByName('Cat_AccountBO.strField8')[0].value = locale;
			document.getElementsByName('Cat_AccountBO.strField8')[0].readOnly = true;
			document.getElementsByName('AccountBO.strField8')[0].value = nida_cell;
		}
	}
	catch(e)
	{
...
function fnNIDASectorCode()
{
	var locale = document.getElementsByName('Cat_AccountBO.strField9')[0].value;
	//alert("fnNIDASectorCode start");
	var cat_type = "NIDA_SECTOR";
	var s_xmlHttp;
	var nida_sector;
	try{
		//alert("fnNIDASectorCode try start");
		if (window.XMLHttpRequest)
		{
			//alert("inside if");
			// code for IE7+, Firefox, Chrome, Opera, Safari
		...
		if(s_xmlHttp.status == 200)
		{
			//alert("Connection Success");
			var nodecat_1 = s_xmlHttp.responseXML.selectSingleNode("OUTPUT/CATEGORYCODE");
			nida_sector = nodecat_1.text;
			//alert("nida_sector>>"+nida_sector);
		}
		s_xmlHttp.abort();
		if(nida_sector=="")
		{
			document.getElementsByName('Cat_AccountBO.strField9')[0].value = "";
			document.getElementsByName('Cat_AccountBO.strField9')[0].readOnly = false;
			document.getElementsByName('AccountBO.strField9')[0].value = "";
		}
		else
		{
			document.getElementsByName('Cat_AccountBO.strField9')[0].value = locale;
			document.getElementsByName('Cat_AccountBO.strField9')[0].readOnly = true;
			document.getElementsByName('AccountBO.strField9')[0].value = nida_sector;
		}
	}
	catch(e)
	{
...
/* ***** Tracker# 97236 CIF - EBanking Changes : End ***** */
	...
	<xsl:attribute name="onload">NidaLoad();loadSector();load();validateStaffFlag();loadDisable();custFnLoad();loadSalutation();introdSalutation();selectFieldAcc();
...
<!-- Changes for 400757 and recon for 392665 and 561329 starts -->
      <xsl:attribute name="onload">bodyOnLoad();loadSector();showInReadOnlyMode('<xsl:value-of select="$readMode" />');introdSalutation();validateStaffFlag();load2();loadSubSeg();changeSubSeg();loadSegVal();setCurrencyArraysOnConvToCust();loadID();hideMinor();checkAge();loadDisable();setDefaultRadio();disable_LookUp();populateAccContAttr();checkEbankFields();isTFPartyFlag();loadBasel();Toggle('native');swifta();chkBSN();isSMSOrWAPEnabled();isCard_holder();formatAmountCust();formatUser();bodyOnLoad();getSelectedItem();selectFieldAcc();SwiftCodeOnLoad();<!--fix for ticket 281657 -->
...
<!--Changes for recon 399817,callid 395609 starts -->
      ...
      <xsl:attribute name="onload">loadCurr();bodyOnLoad();loadSector();showInReadOnlyMode('<xsl:value-of select="$readMode" />');introdSalutation();validateStaffFlag();load2();loadSubSeg();changeSubSeg();loadSegVal();loadID();hideMinor();checkAge();loadDisable();setDefaultRadio();disable_LookUp();populateAccContAttr();checkEbankFields();isTFPartyFlag();loadBasel();Toggle('native');swifta();chkBSN();isSMSOrWAPEnabled();isCard_holder();formatAmountCust();formatUser();bodyOnLoad();getSelectedItem();selectFieldAcc();</xsl:attribute>
      </xsl:when>
     <xsl:otherwise>
...
<!-- CRM10: Other Maintenence Change by Mamta: Flag, if the field is a NameField: ENDS  -->
	...
	<xsl:template name="AccountBO.Cust_First_Name">
	    <xsl:call-template name="label">
	        ...
	        <xsl:with-param name="checkASCII">false</xsl:with-param>
<!-- CRM10: Other Maintenence Change by Mamta: Flag, if the field is a NameField: STARTS  -->
                <xsl:with-param name="fn_onBlur">concatName();set_isName(this,true);fnNameLength(this);</xsl:with-param>
<!-- CRM10: Other Maintenence Change by Mamta: Flag, if the field is a NameField: ENDS  -->
	    </xsl:call-template>
	</xsl:template>
...
<!-- CRM10: Other Maintenence Change by Mamta: Flag, if the field is a NameField: ENDS  -->
	...
	<!--Religion customization  end-->
		<xsl:template name="AccountBO.strField12">
				   <xsl:call-template name="label">
				    ...
				    <xsl:with-param name="ele_name">AccountBO.strField12</xsl:with-param>
				    <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.strField12</xsl:with-param>
	...
	<xsl:template name="AccountBO.strField11">
				   <xsl:call-template name="label">
				    ...
				    <xsl:with-param name="ele_name">AccountBO.strField11</xsl:with-param>
				    <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.strField11</xsl:with-param>
				    <xsl:with-param name="starshow">false</xsl:with-param>
				    <xsl:with-param name="checkASCII">false</xsl:with-param>
				   </xsl:call-template>
	</xsl:template>
...
<!-- Changes End for Tracker#  88635-->
		...
		<xsl:with-param name="buttonone_name" select="$configLabels[@name='LOOKUP']/@configLabel"/>
		<xsl:with-param name="buttontwo_name" select="$configLabels[@name='CLEAR']/@configLabel"/>
	        <xsl:with-param name="buttonone_fnc">categoryLookup('VILLAGE', 'AccountBO.PlaceOfBirth')</xsl:with-param>
...
<xsl:template name="AccountBO.StrUserField1">
    <xsl:call-template name="mdrpdown">
        ...
        <xsl:with-param name="selectdisp">AccountBO.StrUserField1</xsl:with-param>
        <xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField1</xsl:with-param>
        <xsl:with-param name="choice_name">AccountBO.StrUserField1</xsl:with-param>
        	<xsl:with-param name="onchangefn">ISICValidation('SUB_SECTOR_CODE','.StrUserField1','.StrUserField2','SECTOR_CODE')</xsl:with-param>
        <xsl:with-param name="search_type">value</xsl:with-param>
        <xsl:with-param name="presdata" select="$PresData"/>
    </xsl:call-template>
</xsl:template>
...
<xsl:template name="AccountBO.StrUserField2">
    <xsl:call-template name="mdrpdown">
        ...
        <xsl:with-param name="choice_name">AccountBO.StrUserField2</xsl:with-param>
        	<xsl:with-param name="onchangefn">ISICValidation('ISICP1','.StrUserField2','.StrUserField25','SUB_SECTOR_CODE')</xsl:with-param>
        <xsl:with-param name="search_type">value</xsl:with-param>
        <xsl:with-param name="presdata" select="$PresData"/>
    </xsl:call-template>
</xsl:template>
...
<xsl:template name="AccountBO.StrUserField25">
    <xsl:call-template name="mdrpdown">
        ...
        <xsl:with-param name="onchangefn">ISICValidation('ISICP2','.StrUserField25','.StrUserField24','ISICP1')</xsl:with-param>
        <xsl:with-param name="search_type">value</xsl:with-param>
        <xsl:with-param name="presdata" select="$PresData"/>
    </xsl:call-template>
</xsl:template>
...
<xsl:template name="AccountBO.StrUserField7">
    <xsl:call-template name="mdrpdown">
        ...
        <xsl:with-param name="onchangefn">ISICValidation('ISICP1','.StrUserField7','.StrField16','SUB_SECTOR_CODE')</xsl:with-param>
        <xsl:with-param name="search_type">value</xsl:with-param>
        <xsl:with-param name="presdata" select="$PresData"/>
    </xsl:call-template>
</xsl:template>
...
<xsl:template name="AccountBO.StrField19">
        <xsl:call-template name="mdrpdown">
            ...
            <xsl:with-param name="onchangefn">ISICValidation('ISIC_DEMAND2','.StrField19','.StrUserField20','ISIC_DEMAND1')</xsl:with-param>
            <xsl:with-param name="search_type">value</xsl:with-param>
            <xsl:with-param name="presdata" select="$PresData"/>
        </xsl:call-template>
    </xsl:template>

    <!-- DEMAND ISIC2 Customization [SECONDARY ECONOMIC ACTIVITIES] -->

    <xsl:template name="AccountBO.StrUserField20">
        <xsl:call-template name="mdrpdown">
            <xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrUserField20']"/>
            <xsl:with-param name="selectdisp">AccountBO.StrUserField20</xsl:with-param>
            <xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField20</xsl:with-param>
            <xsl:with-param name="choice_name">AccountBO.StrUserField20</xsl:with-param>
            <xsl:with-param name="search_type">value</xsl:with-param>
            <xsl:with-param name="presdata" select="$PresData"/>
        </xsl:call-template>
    </xsl:template>
...
<!--TrackerID: 113227 end of changes-->
	...
	<!-- PEP FIELD End -->
        ...
        <xsl:template name="AccountBO.StrUserField15">
            <xsl:call-template name="label">
                ...
                <xsl:with-param name="ele_name">AccountBO.StrUserField15</xsl:with-param>
                <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.StrUserField15</xsl:with-param>
				<xsl:with-param name="checkASCII">false</xsl:with-param>
            </xsl:call-template>
        </xsl:template>
	...
	<!-- Cell Field Start -->
		<!--<xsl:template name="AccountBO.strField8">
            <xsl:call-template name="label">
                ...
                <xsl:with-param name="ele_name">AccountBO.strField8</xsl:with-param>
                <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.strField8</xsl:with-param>
				<xsl:with-param name="checkASCII">false</xsl:with-param>
            </xsl:call-template>
        </xsl:template>-->
	<xsl:template name="AccountBO.strField8">
	             <xsl:call-template name="lookup">
		     <xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.strField8']"/>
	             <xsl:with-param name="elename">AccountBO.strField8</xsl:with-param>
	             <xsl:with-param name="eleval">AccountBO.strField8</xsl:with-param>
	             <xsl:with-param name="buttonone_name" select="$configLabels[@name='LOOKUP']/@configLabel"/>
	             <xsl:with-param name="buttontwo_name" select="$configLabels[@name='CLEAR']/@configLabel"/>
	             <xsl:with-param name="buttonone_fnc">categoryLookup('NIDA_CELL', 'AccountBO.strField8')</xsl:with-param>
	             <xsl:with-param name="buttontwo_fnc">clearCategoryValue('AccountBO.strField8')</xsl:with-param>
	             <xsl:with-param name="checkASCII">false</xsl:with-param>
		     <xsl:with-param name="UsrDataSpace">Main</xsl:with-param>	     
		     </xsl:call-template>
    </xsl:template>
	...
	<xsl:template name="AccountBO.strField9">
	             <xsl:call-template name="lookup">
		     <xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.strField9']"/>
	             <xsl:with-param name="elename">AccountBO.strField9</xsl:with-param>
	             <xsl:with-param name="eleval">AccountBO.strField9</xsl:with-param>
	             <xsl:with-param name="buttonone_name" select="$configLabels[@name='LOOKUP']/@configLabel"/>
	             <xsl:with-param name="buttontwo_name" select="$configLabels[@name='CLEAR']/@configLabel"/>
	             <xsl:with-param name="buttonone_fnc">categoryLookup('NIDA_SECTOR', 'AccountBO.strField9')</xsl:with-param>
	             <xsl:with-param name="buttontwo_fnc">clearCategoryValue('AccountBO.strField9')</xsl:with-param>
	             <xsl:with-param name="checkASCII">false</xsl:with-param>
		     <xsl:with-param name="UsrDataSpace">Main</xsl:with-param>	     
				 </xsl:call-template>
    </xsl:template>
...
<!--Nithin-->
	...
	<xsl:template name="AccountBO.StrUserField12">
		<xsl:call-template name="mdrpdown">
			...
			<xsl:with-param name="defValByUrl">true</xsl:with-param>
			<xsl:with-param name="onchangefn">custType()</xsl:with-param>
			<xsl:with-param name="presdata" select="$PresData"/>
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template name="AccountBO.strField10">
                <xsl:call-template name="mdrpdown">
                        ...
                        <xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.AccountBO.strField10</xsl:with-param>
	...
	<xsl:template name="AccountBO.strField13">
            <xsl:call-template name="label">
                ...
                <xsl:with-param name="ele_name">AccountBO.strField13</xsl:with-param>
                <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.AccountBO.strField13</xsl:with-param>
                <xsl:with-param name="checkASCII">false</xsl:with-param>
            </xsl:call-template>
        </xsl:template>
	...
	<xsl:template name="AccountBO.strField14">
            <xsl:call-template name="label">
                ...
                <xsl:with-param name="ele_name">AccountBO.strField14</xsl:with-param>
                <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.AccountBO.strField14</xsl:with-param>
                <xsl:with-param name="checkASCII">false</xsl:with-param>
            </xsl:call-template>
        </xsl:template>
<!--End-->
	...
	<xsl:template name="Photo">
		<img id="img" src="" width ="140" height="150"></img>
	</xsl:template>
...
<xsl:template name="AccountBO.StrUserField16">
		     ...
		     <xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrUserField16']"/>
	             <xsl:with-param name="elename">AccountBO.StrUserField16</xsl:with-param>
	             <xsl:with-param name="eleval">AccountBO.StrUserField16</xsl:with-param>
	             <xsl:with-param name="buttonone_name" select="$configLabels[@name='LOOKUP']/@configLabel"/>
	             <xsl:with-param name="buttontwo_name" select="$configLabels[@name='CLEAR']/@configLabel"/>
	             <xsl:with-param name="buttonone_fnc">categoryLookup('NAICS_CODE', 'AccountBO.StrUserField16')</xsl:with-param>
	             <xsl:with-param name="buttontwo_fnc">clearCategoryValue('AccountBO.StrUserField16')</xsl:with-param>
	             <xsl:with-param name="checkASCII">false</xsl:with-param>
		     <xsl:with-param name="UsrDataSpace">Main</xsl:with-param>	     
		     </xsl:call-template>
    </xsl:template>
...
<!-- Change done for PEP start -->
<xsl:call-template name="AccountBO.StrUserField19"/>
<!-- Change done for PEP end -->
...
<xsl:call-template name="Begin"/>
    ...
    <xsl:call-template name="AccountBO.StrUserField20"/>
<xsl:call-template name="End"/>
