...
<xsl:variable name="fileName">../Renderer/Customization/corpcif/resource/CorpEntityQDE_<xsl:value-of select="$locale"/>.xml</xsl:variable>
				  ...
				  { 
			      ...
			      catch(e)
				   {
					...
					function custFnOnload()
					{
						...
						custCrncyCorpPopulate();

						custCrncyCorpPopulate1();
						custCrncyCorpPopulate2();
						custCrncyCorpPopulate3();
...
<!-- Corp CIF changes for SaveSubmit LastEditedPage By Mamta : END -->
					...
					<script type="text/javascript" language="javascript" src="../Customization/corpcif/js/CorpEntityQDE.js"></script>
...
function loadAddressType(){
	...
	if(DefAdress1 != ""){
		...
		document.getElementsByName("CorporateModBO.Address.preferredAddress")[0].value = "Registered";
				...
				function custCrncyCorpPopulate()
				{                
						var accountid="";
				...
				function custCrncyCorpPopulate1()
				{                
						var accountid="";
						var strProcessURL = '../servlet/com.infy.cis.custom.EquityGetCurrency?entityId='+accountid;
						fnEquityGetCurrency(strProcessURL);
						//alert("Currency QDE "+Currency);
						var propCurrency="USD";
						//alert("propCurrency QDE "+propCurrency);
				...
				function custCrncyCorpPopulate2()
				{                
						var accountid="";
						var strProcessURL = '../servlet/com.infy.cis.custom.EquityGetCurrency?entityId='+accountid;
						fnEquityGetCurrency(strProcessURL);
						//alert("Currency QDE "+Currency);
						var propCurrency="EUR";
						//alert("propCurrency QDE "+propCurrency);
				...
				function custCrncyCorpPopulate3()
				{                
						var accountid="";
						var strProcessURL = '../servlet/com.infy.cis.custom.EquityGetCurrency?entityId='+accountid;
						fnEquityGetCurrency(strProcessURL);
						//alert("Currency QDE "+Currency);
						var propCurrency="GBP";
						//alert("propCurrency QDE "+propCurrency);
...
<!-- Fix for call id: 428627 Starts -->
				<xsl:with-param name="fn_onBlur">corpNameTrim();set_isName(this,true);</xsl:with-param>
