	...
	if(document.frm2.byPassFlag.value=="Y"){
        ...
        try{
	     if(blFlag==true){
            ...
            var var_Nationality = document.getElementsByName(DemographicBO + '.Nationality')[0].value)
            alert(var_Nationality)
            if(var_Nationality != "KE")
	    {
		    alert("checkPassport")
		    retStatNRE = checkPassport();
	    else
		    alert("DontcheckPassport")
		    retStatNRE = "true"
	    }
...

{
				  ...
				  alert("The identification document details do not match with the details entered in customer onboard menu test");
