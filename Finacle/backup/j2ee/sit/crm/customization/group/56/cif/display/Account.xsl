<?xml version="1.0"?>
 <xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:variable name="file1">../Renderer/Customization/56/cif/resource/AccountFields_<xsl:value-of select="$locale"/>.xml</xsl:variable>
...
{
	//alert(Sector);
	if(operationType =='Edit Entity' || operationType =='Create' ||  operationType =='Queue')
	{
		...
		ISICValidation('SUB_SECTOR_CODE','.Sector_code','.Subsector_code','SECTOR_CODE');
		document.getElementsByName("AccountBO.Subsector_code")[0].value = Subsector;
		//alert("hello");
		
		ISICValidation('ISICP1','.Subsector_code','.StrUserField7','SUB_SECTOR_CODE');
		ISICValue(acckey,'StrUserField7');		
			
		ISICValidation('ISICP2','.StrUserField7','.StrUserField8','ISICP1');		
		ISICValue(acckey,'StrUserField8');

		ISICValidation('ISIC_DEMAND2','.StrUserField9','.StrUserField12','ISIC_DEMAND1');		
		ISICValue(acckey,'StrUserField12');

		ISICValidation('SUB_SECTOR_CODE','.StrUserField14','.StrUserField15','SECTOR_CODE')
		ISICValue(acckey,'StrUserField15');
		
		ISICValidation('ISICP1','.StrUserField15','.StrUserField16','SUB_SECTOR_CODE')
		ISICValue(acckey,'StrUserField16');
		
		ISICValidation('ISICP2','.StrUserField16','.StrUserField17','ISICP1')
		ISICValue(acckey,'StrUserField17');

		ISICValidation('ISIC_DEMAND2','.StrUserField18','.StrUserField20','ISIC_DEMAND1')
...
/* ***** Tracker# 97236 CIF - EBanking Changes : End ***** */
	...
	<xsl:attribute name="onload">LoadSector();load();validateStaffFlag();loadDisable();custFnLoad();loadSalutation();introdSalutation();selectFieldAcc();
...
<!-- Changes for 400757 and recon for 392665 and 561329 starts -->
      <xsl:attribute name="onload">LoadSector();bodyOnLoad();showInReadOnlyMode('<xsl:value-of select="$readMode" />');introdSalutation();validateStaffFlag();load2();loadSubSeg();changeSubSeg();loadSegVal();setCurrencyArraysOnConvToCust();loadID();hideMinor();checkAge();loadDisable();setDefaultRadio();disable_LookUp();populateAccContAttr();checkEbankFields();isTFPartyFlag();loadBasel();Toggle('native');swifta();chkBSN();isSMSOrWAPEnabled();isCard_holder();formatAmountCust();formatUser();bodyOnLoad();getSelectedItem();selectFieldAcc();SwiftCodeOnLoad();<!--fix for ticket 281657 -->
...
<!--Changes for recon 399817,callid 395609 starts -->
      ...
      <xsl:attribute name="onload">LoadSector();loadCurr();bodyOnLoad();showInReadOnlyMode('<xsl:value-of select="$readMode" />');introdSalutation();validateStaffFlag();load2();loadSubSeg();changeSubSeg();loadSegVal();loadID();hideMinor();checkAge();loadDisable();setDefaultRadio();disable_LookUp();populateAccContAttr();checkEbankFields();isTFPartyFlag();loadBasel();Toggle('native');swifta();chkBSN();isSMSOrWAPEnabled();isCard_holder();formatAmountCust();formatUser();bodyOnLoad();getSelectedItem();selectFieldAcc();</xsl:attribute>
      </xsl:when>
     <xsl:otherwise>
...
<!-- CRM10: Other Maintenence Change by Mamta: Flag, if the field is a NameField: ENDS  -->
	...
	<!--Equity bank adding new field for PEP-->
...
<!-- Changes for tracker id 338696 Starts  -->
	 <xsl:template name="AccountBO.Sector">
 		...
 		<xsl:with-param name="choice_name">AccountBO.Sector_code</xsl:with-param>
	          <xsl:with-param name="onchangefn">ISICValidation('SUB_SECTOR_CODE','.Sector_code','.Subsector_code','SECTOR_CODE')</xsl:with-param> 
 		<xsl:with-param name="max_length">50</xsl:with-param>
 		<xsl:with-param name="search_type">value</xsl:with-param>
 		<xsl:with-param name="presdata" select="$PresData"/>
 		</xsl:call-template>
...
<!--  Changes for tracker id 338696 starts	-->
 		...
 		<xsl:with-param name="selectdisp">AccountBO.Subsector_code</xsl:with-param>
 		<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.Subsector_code</xsl:with-param>
 		<xsl:with-param name="choice_name">AccountBO.Subsector_code</xsl:with-param>
		<xsl:with-param name="onchangefn">ISICValidation('ISICP1','.Subsector_code','.StrUserField7','SUB_SECTOR_CODE')</xsl:with-param> 
 		<xsl:with-param name="max_length">50</xsl:with-param>
 		<xsl:with-param name="search_type">value</xsl:with-param>
 		<xsl:with-param name="presdata" select="$PresData"/>
 		</xsl:call-template>
...
<xsl:template name="AccountBO.StrUserField7">
		...
		<xsl:with-param name="onchangefn">ISICValidation('ISICP2','.StrUserField7','.StrUserField8','ISICP1')</xsl:with-param> 
 		<xsl:with-param name="max_length">50</xsl:with-param>
 		<xsl:with-param name="search_type">value</xsl:with-param>
 		<xsl:with-param name="presdata" select="$PresData"/>
 		</xsl:call-template>
...
<!-- Changes on ISIC3 end  -->


<!-- Changes on ISIC4 start  -->

<xsl:template name="AccountBO.StrUserField8">
 		<xsl:call-template name="mdrpdown">
 		<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrUserField8']"/>
 		<xsl:with-param name="selectdisp">AccountBO.StrUserField8</xsl:with-param>
 		<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField8</xsl:with-param>
 		<xsl:with-param name="choice_name">AccountBO.StrUserField8</xsl:with-param>
 		<xsl:with-param name="max_length">50</xsl:with-param>
 		<xsl:with-param name="search_type">value</xsl:with-param>
 		<xsl:with-param name="presdata" select="$PresData"/>
 		</xsl:call-template>
...
<!-- Changes on ISIC4 end  -->


<!-- Changes on Demand ISIC1 start  -->
...
<xsl:template name="AccountBO.StrUserField9">
 		...
 		<xsl:with-param name="max_length">50</xsl:with-param>
		<xsl:with-param name="onchangefn">ISICValidation('ISIC_DEMAND2','.StrUserField9','.StrUserField12','ISIC_DEMAND1')</xsl:with-param> 
 		<xsl:with-param name="search_type">value</xsl:with-param>
 		<xsl:with-param name="presdata" select="$PresData"/>
 		</xsl:call-template>
 		</xsl:template>
...
<!-- Changes on Demand ISIC1 end  -->

<!-- Changes on Demand ISIC2 start  -->
...
<!-- Changes on Demand ISIC2 end  -->

<!--Purity Harry Categorization Customization Start -->


<!-- Secondary Economic Activity Field Customization  -->
...
<!-- Environment Categorization Field Customization  -->
...
<!-- Climate Categorization Field Customization  -->
...
<!--Purity Harry Categorization Customization End -->
    ...
    <xsl:call-template name="label">
            ...
            <xsl:with-param name="selectname">AccountBO.StrUserField2</xsl:with-param>
...
<!-- Changes on Sector  start silvester -->
...
<xsl:template name="AccountBO.StrUserField14">
 		...
 		<xsl:with-param name="max_length">50</xsl:with-param>
	    	<xsl:with-param name="onchangefn">ISICValidation('SUB_SECTOR_CODE','.StrUserField14','.StrUserField15','SECTOR_CODE')</xsl:with-param> 
		<xsl:with-param name="search_type">value</xsl:with-param>
 		<xsl:with-param name="presdata" select="$PresData"/>
 		</xsl:call-template>
 		</xsl:template>
<!-- Changes on Sector start  -->

<!-- Changes on Sub-Sector  start  -->
...
<xsl:template name="AccountBO.StrUserField15">
 		...
 		<xsl:with-param name="max_length">50</xsl:with-param>
		<xsl:with-param name="onchangefn">ISICValidation('ISICP1','.StrUserField15','.StrUserField16','SUB_SECTOR_CODE')</xsl:with-param> 
 		<xsl:with-param name="search_type">value</xsl:with-param>
 		<xsl:with-param name="presdata" select="$PresData"/>
 		</xsl:call-template>
 		</xsl:template>
...
<xsl:template name="AccountBO.StrUserField16">
		...
		<xsl:with-param name="onchangefn">ISICValidation('ISICP2','.StrUserField16','.StrUserField17','ISICP1')</xsl:with-param> 
 		<xsl:with-param name="max_length">50</xsl:with-param>
 		<xsl:with-param name="search_type">value</xsl:with-param>
 		<xsl:with-param name="presdata" select="$PresData"/>
 		</xsl:call-template>
...
<xsl:template name="AccountBO.StrUserField18">
 		...
 		<xsl:with-param name="max_length">50</xsl:with-param>
 		<xsl:with-param name="search_type">value</xsl:with-param>
		<xsl:with-param name="onchangefn">ISICValidation('ISIC_DEMAND2','.StrUserField18','.StrUserField20','ISIC_DEMAND1')</xsl:with-param> 
 		<xsl:with-param name="presdata" select="$PresData"/>
 		</xsl:call-template>
 		</xsl:template>
