...
<!-- caching changes end -->
	...
	<head>
		...
		<script type="text/javascript" src="/FinacleCRM/common/js/Entity_Document.js" language="javascript"></script>
	...
	<xsl:template name="EntityDocumentBO.DocTypeCode">
		<xsl:choose>
				...
				<xsl:call-template name="mdrpdown">
					...
					<xsl:with-param name="loadFrompresdata">No</xsl:with-param>
				</xsl:call-template>
			</xsl:when>
			<xsl:otherwise>
				<xsl:call-template name="label">
