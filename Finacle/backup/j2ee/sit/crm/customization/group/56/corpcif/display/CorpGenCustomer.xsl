    ...
    <!-- load() function is renamed to loadGen() -->  
     ...
     <!--tracker id 554568 changes starts-->
      <!--Changes for not auto populating Primary Sol id starts-->
        ...
        <xsl:attribute name="onload">loadSector();crncyDefaultPop();langDesc();populateAccContAttr();loadID();loadGen();makekeyMand();loadKYC();focusFirstField();loadrel();DisableGcifIdLookUp();loadZakat();loadBaseCurrency();isTFPartyFlag();loadBasel();makeSwiftFldMand();storeSegment();showbuttonsVisible(45);swifta();loadAddressType();
...
<!--tracker id 231104 changes ends-->
     ...
     <xsl:when test="normalize-space($IsDummy)='Y'">
        ...
        <!--tracker id 231104 changes starts-->
        <!--tracker id 554568 changes starts-->        
             <xsl:attribute name="onload">loadSector();langDesc();loadID();loadKYC();loadGen();changeSubSeg();loadrel();DisableGcifIdLookUp();focusFirstField();loadBackEnd();showbuttonsVisible(30);showFormTips();loadSubSeg();loadSegVal();clearDummyAddress('<xsl:value-of select="$IsDummy"/>');fnNullifyDummyCustFlds('<xsl:value-of select="$IsDummy"/>');chkBSN();populateAccContAttr();loadBaseCurrency();makekeyMand();storeSegment();loadCode();makeSwiftFldMand();isTFPartyFlag();loadBasel();swifta();
    <!--tracker id 554568 changes ends-->
    <!--tracker id 231104 changes ends-->
    <!-- Tracker ID 131246 CHANGES END BY sonali -->
             </xsl:attribute>
...
<!--ticket id 438296 changes starts-->
	   <!-- Changes for the tracker id 351596 STARTS -->
        <xsl:attribute name="onload">loadSector();langDesc();loadID();showInReadOnlyMode('<xsl:value-of select="$readMode"/>');loadGen();changeSubSeg();loadSegVal();loadrel();loadKYC();loadBaseCurrency();DisableGcifIdLookUp();populateAccContAttr();swifta();loadBackEnd();chkBSN();isTFPartyFlag();loadBasel();loadCode();makeSwiftFldMand();
...
<!-- changes for tracker 336728: removing call to loadSubSeg() -->
 ...
 <!--tracker id 554568 changes starts-->
 <xsl:attribute name="onload">loadSector();langDesc();loadID();changeSubSeg();loadSegVal();loadGen();onLoadCurrency();loadrel();DisableGcifIdLookUp();loadbutton();focusFirstField();hideFields();loadBackEnd();showbuttonsVisible(30);showFormTips();clearDummyAddress('<xsl:value-of select="$IsDummy"/>');fnNullifyDummyCustFlds('<xsl:value-of select="$IsDummy"/>');chkBSN();populateAccContAttr();loadBaseCurrency();makekeyMand();storeSegment();loadCode();makeSwiftFldMand();isTFPartyFlag();loadBasel();swifta();loadKYC();loadAddressType();
<!--tracker id 554568 changes ends-->
		...
		<!--  jn Customization KYC starts	-->
			<xsl:template name="CorporateBO.StrUserField20">
				 <xsl:call-template name="mdrpdown">
					 ...
					 <xsl:with-param name="onchangefn">setStrUserField20();</xsl:with-param>
					 <xsl:with-param name="presdata" select="$PresData"/>

				 </xsl:call-template>
			 </xsl:template>

<!--  jn Customization KYC Ends  -->
...
<xsl:template name="CorporateBO.StrUserField1">
	...
	<xsl:with-param name="onchangefn">ISICValidation('ISICP2','.StrUserField1','.StrUserField2','ISICP1')</xsl:with-param>
        <xsl:with-param name="max_length">30</xsl:with-param>
        <xsl:with-param name="search_type">value</xsl:with-param>
        <xsl:with-param name="presdata" select="$PresData"/>
    </xsl:call-template>
...
<xsl:template name="CorporateBO.StrUserField3">
	...
	<xsl:with-param name="onchangefn">ISICValidation('ISIC_DEMAND2','.StrUserField3','.StrUserField4','ISIC_DEMAND1')</xsl:with-param>
        <xsl:with-param name="max_length">30</xsl:with-param>
        <xsl:with-param name="search_type">value</xsl:with-param>
        <xsl:with-param name="presdata" select="$PresData"/>
    </xsl:call-template>
...
<xsl:template name="CorporateBO.StrUserField4">
    <xsl:call-template name="mdrpdown">
        ...
        <xsl:with-param name="selectdisp">CorporateBO.StrUserField4</xsl:with-param>
        <xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField4</xsl:with-param>
        <xsl:with-param name="choice_name">CorporateBO.StrUserField4</xsl:with-param>
        <xsl:with-param name="max_length">30</xsl:with-param>
        <xsl:with-param name="search_type">value</xsl:with-param>
        <xsl:with-param name="presdata" select="$PresData"/>
    </xsl:call-template>
...
<xsl:template name="CorporateBO.StrUserField6">
    <xsl:call-template name="mdrpdown">
		<xsl:with-param name="res_name" select="$configLabels[@name='CorporateBO.StrUserField6']"/>
        ...
        <xsl:with-param name="choice_name">CorporateBO.StrUserField6</xsl:with-param>
        <xsl:with-param name="max_length">30</xsl:with-param>
        <xsl:with-param name="search_type">value</xsl:with-param>
        <!-- DEF-578 Begin of changes-->
        <!--<xsl:with-param name="defValByUrl">true</xsl:with-param>-->
...
<xsl:template name="CorporateBO.StrUserField7">
    <xsl:call-template name="mdrpdown">
        ...
        <xsl:with-param name="choice_name">CorporateBO.StrUserField7</xsl:with-param>
        <xsl:with-param name="max_length">30</xsl:with-param>
        <xsl:with-param name="search_type">value</xsl:with-param>
        <!-- caching changes start -->
        <xsl:with-param name="presdata" select="$PresData"/>
...
<!-- ECO-SYSTEM -->
<!-- DPF INC0142848/INC0055375 START -->
...
<xsl:template name="CorporateBO.StrUserField25">
    ...
    <xsl:call-template name="label">
            ...
            <xsl:with-param name="selectname">CorporateBO.StrUserField26</xsl:with-param>
...
<xsl:template name="CorporateBO.StrUserField17">
	...
	<xsl:with-param name="onchangefn">ISICValidation('SUB_SECTOR_CODE','.StrUserField17','.StrUserField16','SECTOR_CODE')</xsl:with-param>
        <xsl:with-param name="max_length">30</xsl:with-param>
        <xsl:with-param name="search_type">value</xsl:with-param>
        <xsl:with-param name="presdata" select="$PresData"/>
    </xsl:call-template>
...
<xsl:template name="CorporateBO.StrUserField16">
	...
	<xsl:with-param name="onchangefn">ISICValidation('ISICP1','.StrUserField16','.StrUserField11','SUB_SECTOR_CODE')</xsl:with-param>
        <xsl:with-param name="max_length">30</xsl:with-param>
        <xsl:with-param name="search_type">value</xsl:with-param>
        <!-- caching changes start -->
        <xsl:with-param name="presdata" select="$PresData"/>
...
<xsl:template name="CorporateBO.StrUserField11">
	...
	<xsl:with-param name="onchangefn">ISICValidation('ISICP2','.StrUserField11','.StrUserField12','ISICP1')</xsl:with-param>
        <xsl:with-param name="max_length">30</xsl:with-param>
        <xsl:with-param name="search_type">value</xsl:with-param>
        <!-- caching changes start -->
        <xsl:with-param name="presdata" select="$PresData"/>
...
<xsl:template name="CorporateBO.StrUserField13">
	...
	<xsl:with-param name="onchangefn">ISICValidation('ISIC_DEMAND2','.StrUserField13','.StrUserField15','ISIC_DEMAND1')</xsl:with-param>
        <xsl:with-param name="max_length">30</xsl:with-param>
        <xsl:with-param name="search_type">value</xsl:with-param>
        <!-- caching changes start -->
        <xsl:with-param name="presdata" select="$PresData"/>
...
<xsl:call-template name="CorporateBO.StrUserField20"/>			
 <xsl:call-template name="End"/>
<!-- Bank customization KYC by Jane Ends-->
<xsl:call-template name="Begin"/>
