...
//		IdentificationDetails[9] = trim(''+document.getElementsByName('Cat_EntityDocumentBO.IdentificationType')[0].value);
	...
	if(document.getElementsByName('EntityDocumentBO.USERFIELD5')[0]!=null)
		IdentificationDetails[26] = trim(''+document.getElementsByName('EntityDocumentBO.USERFIELD5')[0].value);
...
//Fix for TOL id:451789 Ends
	...
	if((DocumentType=="Passport Number"||DocumentType=="Driving Licence"||DocumentType=="PAN") && ReferenceNo.length > 25 )
	 ...
	 if(DocumentType=="National Card Number" && ReferenceNo.length > 16 )
	  ...
	  if((DocumentType=="IDTypeR1"||DocumentType=="IDTypeR2"||DocumentType=="IDTypeR3"||DocumentType=="IDTypeR4"||DocumentType=="IDTypeR5"||DocumentType=="IDTypeR6"||DocumentType=="IDTypeR7"||DocumentType=="IDTypeR8") && ReferenceNo.length > 50 )
	    {
