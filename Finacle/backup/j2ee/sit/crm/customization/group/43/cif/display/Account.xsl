<?xml version="1.0"?>
 <xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:variable name="file1">../Renderer/Customization/43/cif/resource/AccountFields_<xsl:value-of select="$locale"/>.xml</xsl:variable>
	 <!-- Tracker ID :756914 - Chrome Porting Changes -->
...
<script type="text/javascript" src="../cif/js/Message_cif_{$locale}.js" language="javascript"></script>
	 ...
	 <script type="text/javascript" language="javascript" src="../Customization/43/cif/js/Account.js"></script>
	<!-- Deceased Start-->
...
<script type="text/javascript" src="../Customization/cif/js/EquityProcessCustom.js" language="javascript"></script>
	...
	<!-- TRACKER ID 321176 currency changes start -->
	          <script type="text/javascript" language="javascript" src="../Customization/43/cif/js/CIFCustomerAddress.js"></script>
...
<!--CRM61SR:SRCIUICU :TRACKER# 44233 **BEGIN OF CHANGES-->
        <script type="text/javascript" src="../Customization/43/cif/js/AccountCustom.js" language="javascript"></script>
        <!--TrackerID:209607,Division of js Start-->
...
<!-- Field Rationalization changes end -->
	...
	<!--IDENTIFICATION DOCUMENT CHANGES TRACKER ID 321176 start-->
		<script type="text/javascript" language="javascript" src="../Customization/43/cif/js/EntityDocument_Form.js"></script>
	<!--IDENTIFICATION DOCUMENT CHANGES TRACKER ID 321176 end-->
...
function custFnLoad()
{
	...
	{		   
		...
		document.getElementsByName("AccountBO.Address.preferredAddress")[0].value = "Mailing";
		
		document.getElementsByName("AccountBO.PhoneEmail.PhoneEmailType")[0].value = "CELLPH"
		document.getElementsByName("AccountBO.Preferred_Mobile_Alert_Type")[0].value = "CELLPH"
	}
...
<!-- changes for tracker 356432 ends -->
	...
	<!--Changes for Tracker id: 347074 ends-->
	//var segment = '<xsl:value-of select="$segmentValues"/>';
	//alert ("Account.xsl ::segment"+segment);
...
/*******************************
 ...
 <!-- FATCA Changes Begin -->
 <!-- Equity bank DRC CGCR-3 changes begins -->  
 function fnLoadFatcaReasons(){
 try{
 
 var Fatca_Reasons=document.getElementsByName("AccountBO.StrUserField6")[0].value;
 
document.getElementsByName("AccountBO.StrUserField6")[0].style.visibility="hidden";
 
 var z=document.getElementsByName("FATCAReasonsSelected")[0];
 var a =z.length;
 var options="US nationality,us residence,P.O. address,In care of address,Hold mail address,US phone number,Standing instruction  to transfer or receive funds from usa,US birth place,signatory authority granted to a person with a U.S. address";
 var reasonCode="Reason1,Reason2,Reason3,Reason4,Reason5,Reason6,Reason7,Reason8,Reason9";
 var AvailOptions    =    	new Array();
AvailOptions        =    	options.split(",");
var AvailReason    =    	new Array();
AvailReason        =    	reasonCode.split(",");

 var reasonCode=Fatca_Reasons;
  var SelectReason  =    	new Array();
SelectReason        =    	reasonCode.split(",");


var reasonlength=SelectReason.length;


var y=document.getElementsByName("AvailableFATCAReasons")[0];

for(var j=0; j &lt; reasonlength ; j++){

		for (var i=0;i &lt;AvailReason.length ; i++){
	
		if(AvailReason[i] == SelectReason[j]){
		
		z.length = a + 1;
		z.options[a].text = AvailOptions[i];
		z.options[a].value = AvailReason[i];
		a=a+1;
		...
		for(var k=0;k&lt; b; k++){
			...
			if(y.options[k].value== AvailReason[i]){			
			y.options[k]=null;
			b=b-1;
			}
		}
...
//document.getElementsByName("AvailableFATCAReasons").options.add(0);
var z=document.getElementsByName("AvailableFATCAReasons")[0];
...
AvailReason        =    	reasonCode.split(",");
	...
	for(var j=0; j &lt; 9; j++){
		for(var i=0; i &lt; a; i++){
			if(z.options[i].text == AvailOptions[j]){
				return;
			}
		}
		z.length = a + 1;
		z.options[a].text = AvailOptions[j];
		z.options[a].value = AvailReason[j];
		a=a+1;
		if(z.length &gt; 9){
			z.size = z.length;
		}
...
DebugMessage(e.message);
 ...
 function selfieldFatca(x,y) {
		...
		if (x.name == 'AvailableFATCAReasons')
		{
			if ( x.options.length == 0 )
			{
			  showUserMessage("MSG2018",'MSGJ50379');
			}
			else
			{
			  showUserMessage("MSG012",'MSGJ50379');
			}
		}
		else
		{
			if ( x.options.length == 0 )
			{
			  showUserMessage("MSG2019",'MSGJ50379');
			}
			else
			{
			  showUserMessage("MSG1037",'MSGJ50379');
                      }
                  }
              }
 
 function fnCustomCheckForeignAccTaxReport(){
 
  var v=document.getElementsByName(boName+".ForeignAccTaxReportingReq")[0].value;
       if(v=='Y'){
	    document.getElementsByName("AccountBO.StrUserField1")[0].disabled = false;
	   
       document.getElementsByName("AccountBO.StrUserField2")[0].disabled = false;
	   
       document.getElementsByName("AccountBO.StrUserField4")[0].disabled = false;
	   
	   document.getElementsByName(boName+".StrUserField5")[0].disabled = false;
	   document.getElementsByName(boName+".StrUserField5")[0].IsMandatory = "true";
	
	   document.getElementsByName("mandStar"+boName+".StrUserField5")[0].style.visibility="visible";
	  
	   
	   document.getElementsByName("AvailableFATCAReasons")[0].disabled = false;
	   
	  document.getElementsByName("FATCAReasonsSelected")[0].disabled = false;

	   }
	   else{
	   document.getElementsByName("AccountBO.StrUserField1")[0].value = "";
	   document.getElementsByName("AccountBO.StrUserField2")[0].value = "";
	   document.getElementsByName("AccountBO.StrUserField4")[0].value = "";
	   document.getElementsByName(boName+".StrUserField5")[0].selectedIndex = 0;
	   
	   var y=document.getElementsByName("FATCAReasonsSelected")[0];
	   var b=y.length;
	   for(var k=0;k&lt; b; k++){	
		  ...
		  var x=document.getElementsByName("AvailableFATCAReasons")[0];
	   var c=x.length;
	   for(var k1=0;k1&lt; c; k1++){	
	  ...
	  //document.getElementsByName("FATCAReasonsSelected")[0].value = "";
	   
	    document.getElementsByName("AccountBO.StrUserField1")[0].disabled = true;
	   
       document.getElementsByName("AccountBO.StrUserField2")[0].disabled = true;
	   
       document.getElementsByName("AccountBO.StrUserField4")[0].disabled = true;
	 
	   document.getElementsByName(boName+".StrUserField5")[0].IsMandatory = "false";
	     
	   document.getElementsByName("mandStar"+boName+".StrUserField5")[0].style.visibility="hidden";
	 
	   
	   document.getElementsByName(boName+".StrUserField5")[0].disabled = true;
	   
	   
	   document.getElementsByName("AvailableFATCAReasons")[0].disabled = true;
	   
	  document.getElementsByName("FATCAReasonsSelected")[0].disabled = true;

	   }
 }
  function fnChangeFATCAReason(){
  
  var fatcacust= document.getElementsByName(boName+".StrUserField5")[0].value;
     if(fatcacust!='Y'){
 ...
 <!-- FATCA chnages Ends -->
<!-- Equity bank DRC CGCR-3 changes ends -->    
...
//address- CIF
       ...
       /* function canDelete()
				...
				{	
					if(operationType != 'Queue')
					{
						if(operationType != 'ConvtoCust')
						{
							...
							document.getElementsByName("AccountBO.Primary_sol_id")[0].value = bcName;
							document.getElementsByName("Cat_AccountBO.Primary_sol_id")[0].disabled = true;   
							document.getElementsByName("AccountBO.Primary_sol_id")[0].disabled = true;
						}
					}
		...
		document.getElementsByName("AccountBO.short_name")[0].readOnly = true;
		document.getElementsByName("AccountBO.PreferredName")[0].readOnly=true;
...
//CRM ALERT CHANGES ENDS
	...
	<!--Equity DRC, Customization changes for CR11-onload issue starts --> 
	document.getElementsByName(boName+".Constitution_ref_code")[0].value = constcode;	
	
	document.getElementsByName("Cat_"+boName+".Constitution_ref_code")[0].value = constLang;
	<!--Equity DRC, Customization changes for CR11-onload issue ends --> 
	...
	// ERPBOCF1 : CIF addition of fields changes Tracker ID 113276 end
       ...
       // CRM70t-ST :TRACKER# 78380 **BEGIN OF CHANGES **
		...
		//Changes for Tracker Id 337885 Starts  
		 ...
		 //Changes for call id 802296 starts
		if(!(operationType =='Edit Entity' || operationType == 'Queue'))
		{
	   ...
	   // document.getElementsByName("Cat_"+boName+".Crncy_code")[0].value = baseCurrency;
		...
		//Changes for call id 802296 ends
...
function changeSMSBanking()
{
 	...
 	// Changes for the Tracker id: 361934 END
	{
       ...
       /* Changes Begin for Tracker 126433 SMS Banking Mobile Number should
		...
		document.getElementsByName("AccountBO.SMSBankingMobileNumber")[0].value="243";
...
/* ***** Tracker# 97236 CIF - EBanking Changes : End ***** */
	...
	<xsl:attribute name="onload">loadSector();fnLoadFatca();bodyOnLoad();custFnLoad();validateStaffFlag();loadDisable();loadSalutation();introdSalutation();selectFieldAcc();populateDedupData();
	...
	<!-- Fix for ticket 297660 ,removed call to function clearsol()--><!--Changes for tracker id 336788 STARTS-->load2();fnSetCustStatus();fnCheckCustStatus('Y');checkEbankFields();loadSubSeg();changeSubSeg();loadSegVal();DisableGcifIdLookUp();Toggle('native');focusFirstField();populateAccContAttr();disable_LookUp();loadZakat();setCurrencyArraysOnConvToCust();loadID();isTFPartyFlag();loadBasel();hideMinor();checkAge();checkAgeSC();makeDateMand();showbuttonsVisible(45);introCreate();formatAmountCust();formatUser();storeSegment();setFocusOnComp(boName+'.Cust_First_Name');setDefStatus();showFormTips();DisplayLookUPIntro();swifta();SwiftCodeOnLoad();load();<!--Changes for tracker id 336788 ENDS-->
...
<!-- Changes for 400757 and recon for 392665 and 561329 starts -->
      <xsl:attribute name="onload">loadSector();fnLoadFatca();fnLoadFatcaReasons();bodyOnLoad();showInReadOnlyMode('<xsl:value-of select="$readMode" />');introdSalutation();validateStaffFlag();load2();loadSubSeg();changeSubSeg();loadSegVal();setCurrencyArraysOnConvToCust();loadID();hideMinor();checkAge();loadDisable();setDefaultRadio();disable_LookUp();populateAccContAttr();checkEbankFields();isTFPartyFlag();loadBasel();Toggle('native');swifta();chkBSN();isSMSOrWAPEnabled();isCard_holder();formatAmountCust();formatUser();bodyOnLoad();getSelectedItem();selectFieldAcc();SwiftCodeOnLoad();populateDedupData();<!--fix for ticket 281657 -->
...
<!--   Fix for ticket id 549260 ends    -->
	  ...
	  <!--Tracker 239165 changes ends -->
      <!-- Change done as a part of ticket 296094 Ends -->
     <!-- checkEbankFields();loadSubSeg();loadSegVal();bodyOnLoad();isTFPartyFlag();hideMinor();checkAge();checkAgeSC();Toggle('native');load2();swifta();loadID();chkBSN();isSMSOrWAPEnabled();setDefaultRadio();populateAccContAttr();isCard_holder();formatAmountCust();formatUser();bodyOnLoad();populateDedupData();-->
        </xsl:attribute>
...
<!--Changes for recon 399817,callid 395609 starts -->
      ...
      <xsl:attribute name="onload">loadSector();fnLoadFatca();fnLoadFatcaReasons();loadCurr();bodyOnLoad();showInReadOnlyMode('<xsl:value-of select="$readMode" />');introdSalutation();validateStaffFlag();load2();loadSubSeg();changeSubSeg();loadSegVal();loadID();hideMinor();checkAge();loadDisable();setDefaultRadio();disable_LookUp();populateAccContAttr();checkEbankFields();isTFPartyFlag();loadBasel();Toggle('native');swifta();chkBSN();isSMSOrWAPEnabled();isCard_holder();formatAmountCust();formatUser();bodyOnLoad();getSelectedItem();selectFieldAcc();disablePrimaryIntroFields();populateDedupData();</xsl:attribute>
      </xsl:when>
     <xsl:otherwise>
...
function loadSector()
{
	...
	if(operationType =='Edit Entity' || operationType =='Create' )
	{
		//alert("operation type 7:"+Sector);
		...
		ISICValidation('SUB_SECTOR_CODE','.Sector_code','.Subsector','SECTOR_CODE');
		//document.getElementsByName("AccountBO.Subsector")[0].value = Subsector;
		ISICValue(acckey,'Subsector');

		ISICValidation('ISICP1','.Subsector','.strField14','SUB_SECTOR_CODE');
		ISICValue(acckey,'strField14');		
			
		ISICValidation('ISICP2','.strField14','.strField15','ISICP1');		
		ISICValue(acckey,'strField15');

		ISICValidation('ISIC_DEMAND2','.strField8','.StrField20','ISIC_DEMAND1');		
		ISICValue(acckey,'StrField20');

		ISICValidation('SUB_SECTOR_CODE','.StrField18','.StrUserField3','SECTOR_CODE')
		ISICValue(acckey,'StrUserField3');
		
		ISICValidation('ISICP1','.StrUserField3','.StrField16','SUB_SECTOR_CODE')
		ISICValue(acckey,'StrField16');
		
		ISICValidation('ISICP2','.StrField16','.strField10','ISICP1')
		ISICValue(acckey,'strField10');

		ISICValidation('ISIC_DEMAND2','.strField11','.strField13','ISIC_DEMAND1')
		ISICValue(acckey,'strField13');
   ...
   <!--***** FATCA Template Definitions Begins Here*****-->
    ...
    <xsl:template name="AccountBO.ForeignAccTaxReportingReq">
   	<xsl:call-template name="mdrpdown">
   		  ...
   		  <xsl:with-param name="onchangefn">checkForeignAccTaxReport();fnCustomCheckForeignAccTaxReport();</xsl:with-param> 
...
<!-- CRM10: Other Maintenence Change by Mamta: Flag, if the field is a NameField: ENDS  -->
	...
	<!--
	 <xsl:template name="AccountBO.StrField17">
            ...
            <xsl:call-template name="lookup">
	        <xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrField17']"/>
	        <xsl:with-param name="elename">AccountBO.StrField17</xsl:with-param>
	        <xsl:with-param name="eleval"><xsl:value-of select="$boName"/>.StrField17</xsl:with-param>
	        <xsl:with-param name="UsrDataSpace">Main</xsl:with-param>
		<xsl:with-param name="buttonone_name" select="$configLabels[@name='LOOKUP']/@configLabel"/>
		<xsl:with-param name="buttontwo_name" select="$configLabels[@name='CLEAR']/@configLabel"/>
	        <xsl:with-param name="buttonone_fnc">categoryLookup('CITY', 'AccountBO.StrField17')</xsl:with-param>
	        <xsl:with-param name="buttontwo_fnc">clearCategoryValue('AccountBO.StrField17')</xsl:with-param>
	        <xsl:with-param name="checkASCII">false</xsl:with-param>
            </xsl:call-template>           
        </xsl:template> -->
	    ...
	    <xsl:call-template name="label">
	        <xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrField17']"/>
	        <xsl:with-param name="ele_name">AccountBO.StrField17</xsl:with-param>
	        <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.StrField17</xsl:with-param>
	    	<xsl:with-param name="starshow">true</xsl:with-param>
	    </xsl:call-template>
	</xsl:template>
...
<!--  RefCode Changes	-->
	<!-- Changes for tracker 356432 starts -->
	<!-- Equity DRC, Customization changes for CR11 starts --> 
        <xsl:template name="AccountBO.Cust_Type">
		          ...
		          <xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.Cust_type_code']"/>
		           ...
		           <xsl:with-param name="buttonone_name" select="$configLabels[@name='LOOKUP']/@configLabel"/>
		           <xsl:with-param name="buttontwo_name" select="$configLabels[@name='CLEAR']/@configLabel"/>
		           <xsl:with-param name="buttonone_fnc">categoryLookup('ACCOUNT_TYPE', 'AccountBO.Cust_type_code');</xsl:with-param>
		           <xsl:with-param name="buttontwo_fnc">clearCategoryValue('AccountBO.Cust_type_code')</xsl:with-param>
		           <xsl:with-param name="fn_onBlur"></xsl:with-param>
		           <xsl:with-param name="checkASCII">true</xsl:with-param>
		          </xsl:call-template>
   	</xsl:template>
	<!-- Equity DRC, Customization changes for CR11 ends --> 
	<!-- Changes for tracker 356432 ends -->
...
<!-- Changes End for Tracker#  88635-->
		...
		<!--CGCR12: Country of Birth changes by Bhaswanth M Begin -->
	...
	<xsl:with-param name="buttontwo_name" select="$configLabels[@name='CLEAR']/@configLabel"/>
		...
		<!--CGCR12: Country of Birth changes by Bhaswanth M End -->	

<!--Equity DRC, Customization changes for CGCR21 starts-->	     
	<xsl:template name="AccountBO.StrUserField30">
		...
		<!--Equity DRC, Customization changes for CGCR21 end -->	
...
<xsl:template name="AccountBO.StrUserField24">
	...
	<xsl:template name="AccountBO.StrUserField14">
			<xsl:call-template name="mdrpdown">
			<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrUserField14']"/>
			<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField14</xsl:with-param>
			<xsl:with-param name="selectdisp">AccountBO.StrUserField14</xsl:with-param>
			<xsl:with-param name="presdata" select="$PresData"/>
			<xsl:with-param name="search_type">value</xsl:with-param>
			<xsl:with-param name="choice_name">AccountBO.StrUserField14</xsl:with-param>
			</xsl:call-template>
	</xsl:template>
	
	<!-- Equity bank DRC CGCR-3 changes begins -->    

	  <xsl:template name="AccountBO.StrUserField1">
                 <xsl:call-template name="label">
                 <xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrUserField1']"/>
                   <xsl:with-param name="ele_name">AccountBO.StrUserField1</xsl:with-param>
                   <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.StrUserField1</xsl:with-param>
	 ...
	 <xsl:template name="AccountBO.StrUserField2">
                 ...
                 <xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrUserField2']"/>
                   ...
                   <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.StrUserField2</xsl:with-param>
				   <xsl:with-param name="max_length">100</xsl:with-param>
                 </xsl:call-template>
             </xsl:template>
	<xsl:template name="AccountBO.StrUserField4">
                 <xsl:call-template name="label">
                 <xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrUserField4']"/>
                   <xsl:with-param name="ele_name">AccountBO.StrUserField4</xsl:with-param>
                   <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.StrUserField4</xsl:with-param>
				   <xsl:with-param name="max_length">100</xsl:with-param>
                 </xsl:call-template>
             </xsl:template>
		...
		<xsl:template name="AccountBO.StrUserField6">
                 <xsl:call-template name="label">
                 <xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrUserField61']"/>
                   <xsl:with-param name="ele_name">AccountBO.StrUserField6</xsl:with-param>
                   <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.StrUserField6</xsl:with-param>
				   <xsl:with-param name="max_length"></xsl:with-param>
                 </xsl:call-template>
             </xsl:template>
			 
		 <xsl:template name="AccountBO.StrUserField5">
   	<xsl:call-template name="mdrpdown">
   			<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrUserField5']"/>
			<xsl:with-param name="selectdisp">AccountBO.StrUserField5</xsl:with-param>
   			<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField5</xsl:with-param>
   			<xsl:with-param name="choice_name">AccountBO.StrUserField5</xsl:with-param>
   			<xsl:with-param name="search_type">url</xsl:with-param>
   		  <xsl:with-param name="onchangefn">fnChangeFATCAReason();</xsl:with-param>   
<xsl:with-param name="starshow">true</xsl:with-param>		  
   			<xsl:with-param name="presdata" select="$PresData"/>
      </xsl:call-template>
			</xsl:template>
			
			 <xsl:template name="AvailableFATCAReasons">
            <xsl:call-template name="listview">
                <xsl:with-param name="ele_name">AvailableFATCAReasons</xsl:with-param>
                <xsl:with-param name="size">9</xsl:with-param>
                <xsl:with-param name="multiple">false</xsl:with-param>
                <xsl:with-param name="class">listBox</xsl:with-param>
  	      <xsl:with-param name="ondblclick">selfieldFatca(AvailableFATCAReasons,FATCAReasonsSelected)</xsl:with-param>
                <xsl:with-param name="selectname">AvailableFATCAReasons</xsl:with-param>
  	      <xsl:with-param name="selectdisp">AvailableFATCAReasons</xsl:with-param>
    	      <xsl:with-param name="search_type">url</xsl:with-param>
    	      <xsl:with-param name="presdata" select="$PresData"/>
            </xsl:call-template>
        </xsl:template>

        <xsl:template name="FATCAReasonsSelected">
            <xsl:call-template name="listview">
                <xsl:with-param name="ele_name">FATCAReasonsSelected</xsl:with-param>
                <xsl:with-param name="size">9</xsl:with-param>
                <xsl:with-param name="multiple">false</xsl:with-param>
                <xsl:with-param name="class">listBox</xsl:with-param>
                <xsl:with-param name="ondblclick">selfieldFatca(FATCAReasonsSelected,AvailableFATCAReasons)</xsl:with-param>
	...
	<xsl:template name="AccountBO.StrUserField15">
			<xsl:call-template name="mdrpdown">
			<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrUserField15']"/>
			<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField15</xsl:with-param>
			<xsl:with-param name="selectdisp">AccountBO.StrUserField15</xsl:with-param>
			<xsl:with-param name="presdata" select="$PresData"/>
			<xsl:with-param name="search_type">value</xsl:with-param>
			<xsl:with-param name="choice_name">AccountBO.StrUserField15</xsl:with-param>
			</xsl:call-template>
	</xsl:template>
	
		
	<xsl:template name="AccountBO.StrUserField16">
			<xsl:call-template name="mdrpdown">
			<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrUserField16']"/>
			<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField16</xsl:with-param>
			<xsl:with-param name="selectdisp">AccountBO.StrUserField16</xsl:with-param>
			<xsl:with-param name="presdata" select="$PresData"/>
			<xsl:with-param name="search_type">value</xsl:with-param>
			<xsl:with-param name="choice_name">AccountBO.StrUserField16</xsl:with-param>
			</xsl:call-template>
	</xsl:template>
	<xsl:template name="AccountBO.StrUserField17">
			<xsl:call-template name="mdrpdown">
			<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrUserField17']"/>
			<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField17</xsl:with-param>
			<xsl:with-param name="selectdisp">AccountBO.StrUserField17</xsl:with-param>
			<xsl:with-param name="presdata" select="$PresData"/>
			<xsl:with-param name="search_type">value</xsl:with-param>
			<xsl:with-param name="choice_name">AccountBO.StrUserField17</xsl:with-param>
			</xsl:call-template>
	</xsl:template>
	

	<xsl:template name="AccountBO.StrUserField8">
 	   <xsl:call-template name="label">
 		 <xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrUserField8']"/>
 		 <xsl:with-param name="ele_name">AccountBO.StrUserField8</xsl:with-param>
	...
	<xsl:template name="AccountBO.StrUserField9">
 	   <xsl:call-template name="label">
 		 ...
 		 <xsl:with-param name="ele_name">AccountBO.StrUserField9</xsl:with-param>
 		 <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.StrUserField9</xsl:with-param>
 	    </xsl:call-template>
 	</xsl:template>
	...
	<xsl:template name="AccountBO.StrUserField7">
 	   <xsl:call-template name="label">
 		 ...
 		 <xsl:with-param name="ele_name">AccountBO.StrUserField7</xsl:with-param>
 		 <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.StrUserField7</xsl:with-param>
 	    </xsl:call-template>
 	</xsl:template>
	
		 <xsl:template name="AccountBO.Amount4">
        <xsl:call-template name="amountlabel">
        <xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.Amount4']"/>
        <xsl:with-param name="ele_name">AccountBO.Amount4</xsl:with-param>
       ...
       <xsl:with-param name="showdropdown">false</xsl:with-param>
	     <xsl:with-param name="linkshow">false</xsl:with-param>
		  <xsl:with-param name="fn_onBlur">formatAmount("2_AccountBO.Amount4",'<xsl:value-of select="$boName"/>.revenueUnits',"N");</xsl:with-param>
        </xsl:call-template>
        </xsl:template>
...
<!--tracker id 113227 defect fix start here-->
	    <!--<xsl:with-param name="fn_onBlur">set_isName(this,true);</xsl:with-param>-->
	    <xsl:with-param name="fn_onBlur">fnDefaultPrefName();set();set_isName(this,true);</xsl:with-param>
<!--tracker id 113227 defect fix ends here-->
<!-- CRM10: Other Maintenence Change by Mamta: Flag, if the field is a NameField: ENDS  -->
	   </xsl:call-template>
</xsl:template>
...
<xsl:template name="AccountBO.Tds_cust_id">
    ...
    <xsl:with-param name="buttonone_fnc">fnBlurFunction('Tds_cust_id_retail')</xsl:with-param>
...
<xsl:template name="AccountBO.Subsector">
		<xsl:call-template name="mdrpdown">
			...
			<xsl:with-param name="onchangefn">ISICValidation('ISICP1','.Subsector','.strField14','SUB_SECTOR_CODE')</xsl:with-param> 
...
<xsl:template name="AccountBO.strField14">
				<xsl:call-template name="mdrpdown">
					<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.strField14']"/>
					<xsl:with-param name="selectdisp">AccountBO.strField14</xsl:with-param>
					<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.strField14</xsl:with-param>
					<xsl:with-param name="choice_name">AccountBO.strField14</xsl:with-param>
					<xsl:with-param name="search_type">value</xsl:with-param>
					<xsl:with-param name="onchangefn">ISICValidation('ISICP2','.strField14','.strField15','ISICP1')</xsl:with-param> 
					<xsl:with-param name="presdata" select="$PresData"/>
				</xsl:call-template>
		</xsl:template>  

	  	<xsl:template name="AccountBO.strField15">
				<xsl:call-template name="mdrpdown">
					<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.strField15']"/>
					<xsl:with-param name="selectdisp">AccountBO.strField15</xsl:with-param>
					<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.strField15</xsl:with-param>
					<xsl:with-param name="choice_name">AccountBO.strField15</xsl:with-param>
					<xsl:with-param name="search_type">value</xsl:with-param>
					<!--<xsl:with-param name="onchangefn">ISICValidation('ISIC_DEMAND1','.strField15','.StrField19','ISICP2')</xsl:with-param> -->
					<xsl:with-param name="presdata" select="$PresData"/>
				</xsl:call-template>
		</xsl:template>

<xsl:template name="AccountBO.strField8">
	<xsl:call-template name="mdrpdown">
		<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.strField8']"/>
		<xsl:with-param name="selectdisp">AccountBO.strField8</xsl:with-param>
		<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.strField8</xsl:with-param>
		<xsl:with-param name="choice_name">AccountBO.strField8</xsl:with-param>
		<xsl:with-param name="search_type">value</xsl:with-param>
		<xsl:with-param name="onchangefn">ISICValidation('ISIC_DEMAND2','.strField8','.StrField20','ISIC_DEMAND1')</xsl:with-param> 
		<xsl:with-param name="presdata" select="$PresData"/>
	</xsl:call-template>
</xsl:template>

<xsl:template name="AccountBO.StrField20">
	<xsl:call-template name="mdrpdown">
		<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrField20']"/>
		<xsl:with-param name="selectdisp">AccountBO.StrField20</xsl:with-param>
		<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrField20</xsl:with-param>
		<xsl:with-param name="choice_name">AccountBO.StrField20</xsl:with-param>
		<xsl:with-param name="search_type">value</xsl:with-param>
		<xsl:with-param name="presdata" select="$PresData"/>
	</xsl:call-template>
</xsl:template>
...
<xsl:template name="AccountBO.strField12">
	<xsl:call-template name="mdrpdown">
			<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.strField12']"/>
			<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.strField12</xsl:with-param>
			<xsl:with-param name="selectdisp">AccountBO.strField12</xsl:with-param>
			<xsl:with-param name="presdata" select="$PresData"/>
			<xsl:with-param name="search_type">value</xsl:with-param>
			<xsl:with-param name="choice_name">AccountBO.strField12</xsl:with-param>
	</xsl:call-template>
</xsl:template>

<xsl:template name="AccountBO.Flg1">
		<xsl:call-template name="mdrpdown">
			<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.Flg1']"/>
			<xsl:with-param name="selectdisp">AccountBO.Flg1</xsl:with-param>
			<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.Flg1</xsl:with-param>
			<xsl:with-param name="choice_name">AccountBO.Flg1</xsl:with-param>
			<xsl:with-param name="search_type">value</xsl:with-param>
			<xsl:with-param name="presdata" select="$PresData"/>
		</xsl:call-template>
	</xsl:template>

<xsl:template name="AccountBO.StrField22">
		<xsl:call-template name="mdrpdown">
			<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrField22']"/>
			<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrField22</xsl:with-param>
			<xsl:with-param name="selectdisp">AccountBO.StrField22</xsl:with-param>
			<xsl:with-param name="presdata" select="$PresData"/>
			<xsl:with-param name="search_type">value</xsl:with-param>
			<xsl:with-param name="choice_name">AccountBO.StrField22</xsl:with-param>
		</xsl:call-template>
	</xsl:template>
...
<xsl:template name="AccountBO.strField9">
		  ...
		  <xsl:with-param name="selectname">AccountBO.strField9</xsl:with-param>
		  <xsl:with-param name="selectdisp">AccountBO.strField9</xsl:with-param>
		  <xsl:with-param name="ele_name">AccountBO.strField9</xsl:with-param>
		  <!-- Last Edited Page changes starts -->
		  <xsl:with-param name="ele_val"><xsl:value-of select="$boName"/>.strField9</xsl:with-param>
...
<xsl:template name="AccountBO.StrField18">
	<xsl:call-template name="mdrpdown">
		...
		<!-- Changes for ISIC Subsector by Sundar Starts  -->
		<xsl:with-param name="onchangefn">ISICValidation('SUB_SECTOR_CODE','.StrField18','.StrUserField3','SECTOR_CODE')</xsl:with-param>
		 <!-- Changes for ISIC Subsector by Sundar ENDS  -->
		<xsl:with-param name="search_type">value</xsl:with-param>
		<xsl:with-param name="presdata" select="$PresData"/>
	</xsl:call-template>
...
<xsl:template name="AccountBO.StrUserField3">
	<xsl:call-template name="mdrpdown">
		...
		<!-- Changes for ISIC Subsector by Sundar Starts  -->
		<xsl:with-param name="onchangefn">ISICValidation('ISICP1','.StrUserField3','.StrField16','SUB_SECTOR_CODE')</xsl:with-param> 
		 <!-- Changes for ISIC Subsector by Sundar ENDS  -->
		<xsl:with-param name="search_type">value</xsl:with-param>
		<xsl:with-param name="presdata" select="$PresData"/>
	</xsl:call-template>
...
<xsl:template name="AccountBO.StrField16">
	<xsl:call-template name="mdrpdown">
		...
		<!-- Changes for ISIC Subsector by Sundar Starts  -->
		<xsl:with-param name="onchangefn">ISICValidation('ISICP2','.StrField16','.strField10','ISICP1')</xsl:with-param>
		 <!-- Changes for ISIC Subsector by Sundar ENDS  -->
		<xsl:with-param name="search_type">value</xsl:with-param>
		<xsl:with-param name="presdata" select="$PresData"/>
	</xsl:call-template>
</xsl:template>
<xsl:template name="AccountBO.strField10">
	<xsl:call-template name="mdrpdown">
		<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.strField10']"/>
		<xsl:with-param name="selectdisp">AccountBO.strField10</xsl:with-param>
		<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.strField10</xsl:with-param>
		<xsl:with-param name="choice_name">AccountBO.strField10</xsl:with-param>
		<!-- Changes for ISIC Subsector by Sundar Starts  -->
		<xsl:with-param name="onchangefn">ISICValidation('ISICP2','.strField10','.strField11','ISICP1')</xsl:with-param> 
		 <!-- Changes for ISIC Subsector by Sundar ENDS  -->
		<xsl:with-param name="search_type">value</xsl:with-param>
		<xsl:with-param name="presdata" select="$PresData"/>
	</xsl:call-template>
...
<xsl:template name="AccountBO.strField11">
	<xsl:call-template name="mdrpdown">
		<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.strField11']"/>
		<xsl:with-param name="selectdisp">AccountBO.strField11</xsl:with-param>
		<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.strField11</xsl:with-param>
		<xsl:with-param name="choice_name">AccountBO.strField11</xsl:with-param>
		<!-- Changes for ISIC Subsector by Sundar Starts  -->
		<xsl:with-param name="onchangefn">ISICValidation('ISIC_DEMAND2','.strField11','.strField13','ISIC_DEMAND1')</xsl:with-param>
		 <!-- Changes for ISIC Subsector by Sundar ENDS  -->
		<xsl:with-param name="search_type">value</xsl:with-param>
		<xsl:with-param name="presdata" select="$PresData"/>
	</xsl:call-template>
</xsl:template>
<xsl:template name="AccountBO.strField13">
	<xsl:call-template name="mdrpdown">
		<xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.strField13']"/>
		<xsl:with-param name="selectdisp">AccountBO.strField13</xsl:with-param>
		<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.strField13</xsl:with-param>
		<xsl:with-param name="choice_name">AccountBO.strField13</xsl:with-param>
		<xsl:with-param name="search_type">value</xsl:with-param>
		<xsl:with-param name="presdata" select="$PresData"/>
	</xsl:call-template>
</xsl:template>
...
<xsl:template name="AccountBO.riskRating">
	...
	<!--Begin of changes risk category -->

						<xsl:template name="AccountBO.StrUserField18">
                                 <xsl:call-template name="mdrpdown">
                                         <xsl:with-param name="res_name" select="$configLabels[@name='AccountBO.StrUserField18']"/>
                                         <xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField18</xsl:with-param>
                                         <xsl:with-param name="selectdisp">AccountBO.StrUserField18</xsl:with-param>
                                         <xsl:with-param name="search_type">value</xsl:with-param>
                                         <xsl:with-param name="choice_name">AccountBO.StrUserField18</xsl:with-param>
                                         <xsl:with-param name="presdata" select="$PresData"/>
                                 </xsl:call-template>
                         </xsl:template>
...
<!-- Changes for Deceased CIF Ends-->
		...
		<input type="hidden" name="StrUserField6" value=""/>
...
<!--saving identifier_type (unique id, Issue_Date, Valid_Date) in EntityTable for Retail start-->
		...
		<!-- TRACKER ID: 113279 Ends -->
		<!--Equity DRC, Customization changes for custom porting starts-->	
		<input type="hidden" name="IDTypeR6.txt_ID"/>
		<input type="hidden" name="IDTypeR6.txt_Issue_Date"/>
		<input type="hidden" name="IDTypeR6.txt_Valid_Date"/>
		<input type="hidden" name="IDTypeR6.txt_Issue_Place"/>
		<input type="hidden" name="IDTypeR7.txt_ID"/>
		<input type="hidden" name="IDTypeR7.txt_Issue_Date"/>
		<input type="hidden" name="IDTypeR7.txt_Valid_Date"/>
		<input type="hidden" name="IDTypeR7.txt_Issue_Place"/>
		<input type="hidden" name="IDTypeR8.txt_ID"/>
		<input type="hidden" name="IDTypeR8.txt_Issue_Date"/>
		<input type="hidden" name="IDTypeR8.txt_Valid_Date"/>
		<input type="hidden" name="IDTypeR8.txt_Issue_Place"/>
		<!--Equity DRC, Customization changes for custom porting ends-->	
...
<xsl:call-template name="Begin"/>
    <xsl:call-template name="AccountBO.nick_name"/>
	 <xsl:call-template name="AccountBO.StrField17"/>
...
<xsl:call-template name="End"/>
<xsl:call-template name="Begin"/>
	<xsl:call-template name="AccountBO.strField14"/>
	<xsl:call-template name="AccountBO.strField15"/>
<xsl:call-template name="End"/>
 <xsl:call-template name="Begin"/>
	<xsl:call-template name="AccountBO.strField8"/>
	<xsl:call-template name="AccountBO.StrField20"/>
<xsl:call-template name="End"/>
<xsl:call-template name="Begin"/>
	<xsl:call-template name="AccountBO.StrField19"/>
	<xsl:call-template name="AccountBO.strField12"/>
<xsl:call-template name="End"/>
<xsl:call-template name="Begin"/>
	<xsl:call-template name="AccountBO.Flg1"/>
	<xsl:call-template name="AccountBO.StrField22"/>
<xsl:call-template name="End"/>
<xsl:call-template name="Begin"/>
...
<xsl:call-template name="Begin"/>
<xsl:call-template name="AccountBO.StrUserField18"/>
<xsl:call-template name="End"/>
...
<xsl:call-template name="AccountBO.StrUserField14"/>
<xsl:call-template name="End"/>

<xsl:call-template name="Begin"/>
<xsl:call-template name="AccountBO.StrUserField15"/>
<xsl:call-template name="AccountBO.StrUserField16"/>
<xsl:call-template name="End"/>

<xsl:call-template name="Begin"/>
<xsl:call-template name="AccountBO.StrUserField17"/>

<xsl:call-template name="AccountBO.Amount4"/>


<xsl:call-template name="End"/>

<xsl:call-template name="Begin"/>
<xsl:call-template name="AccountBO.StrUserField8"/>
...
<xsl:call-template name="Begin"/>
	...
	<xsl:call-template name="AccountBO.strField10"/>    
<xsl:call-template name="End"/>
<xsl:call-template name="Begin"/>
	<xsl:call-template name="AccountBO.strField11"/>
	<xsl:call-template name="AccountBO.strField13"/>    
<xsl:call-template name="End"/>
...
<!-- View : Identification Details :Start   -->
		                ...
		                <xsl:call-template name="BeginTabPage">
		                   ...
		                   <xsl:with-param name="tabPageDisplayNameRes">Identification</xsl:with-param>
<!--<xsl:with-param name="tabPageDisplayNameRes" select="$configLabels_9[@name='Identification Details']/@configLabel"/>-->
							<!--MATT Bug Fixing - CRM11.0 MT for Defect Ticket Id 201181 and 210240 BEGIN -->
...
<tr>
		...
		<td>
		<xsl:call-template name="AccountBO.StrUserField1"/>
		</td>
	<td>
...
<tr>
	...
	<td>
		<xsl:call-template name="AccountBO.StrUserField4"/>
		</td>
		<td>
		<xsl:call-template name="AccountBO.StrUserField5"/>
		</td>
		</tr>
<tr>
	<td>
...
<table  bgcolor='FFFFFF' width="100%" border = "0" cellspacing="0" vspace="0" hspace="0" >
	<TR >
			<TD nowrap="true" align="left" valign ="top" class="d1" style='width:17%'><xsl:value-of select="$configLabels[@name='AvailableFATCAReasons']/@configLabel"/></TD>
			<TD  width="20%"  align='left' >
				<xsl:call-template name="AvailableFATCAReasons"/>
			</TD>
			...
			<TD align='center' width="8%">
				...
				<TD align='center'>
				<input class="frmBttnsAddRmv" Type='button' value='&gt;&gt;'
					onclick="selfieldFatca(AvailableFATCAReasons, FATCAReasonsSelected)"/>
				</TD>
				</TR>
				<TR>
				<TD align='center'>
				<input class="frmBttnsAddRmv" Type='button' value='&lt;&lt;'
					onclick="selfieldFatca(FATCAReasonsSelected,AvailableFATCAReasons)"/>
				</TD>
				</TR>
				</TABLE>

			</TD>
			<TD  nowrap="true" valign ="top" class="d1" style='width:17%'><xsl:value-of select="$configLabels[@name='AccountBO.StrUserField6']/@configLabel"/></TD>
			<TD width="10%">
				<xsl:call-template name="FATCAReasonsSelected"/>
			</TD>
			<td>&#160;</td>
		</TR>
</table>
...
<!-- Tracker ID :756914 - Chrome Porting Changes -->
	 ...
	 <!-- Change for tracker id 336884  start --> 
	  ...
	  <input name="dateofissue" type="hidden" value=""> 
			  ...
			  </input>   	   <input type="hidden" name="hidUserField5" value="">
