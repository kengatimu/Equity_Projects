...
<!--changes for recon -->
	...
	<xsl:variable name="UserField5" select="$customfields[@n='EntityDocumentBO.USERFIELD5']"/>
...
<!-- caching changes end -->
	...
	<head>
		...
		<script type="text/javascript" src="/FinacleCRM/Customization/43/common/js/Entity_Document.js" language="javascript"></script>
		<script type="text/javascript" src = "/FinacleCRM/Customization/43/common/js/DocDetailsDedupVal.js" language = "javascript"></script>
		...
		function functionBodyOnload(){
			...
			if(readMode=='Y'){
				populateDocTypeOnLoad();
				loadCodeforType('<xsl:value-of select="$customfields[@n='EntityDocumentBO.DocTypeCode']"/>');populateDocCode();
				bodyload();
...
<!-- changes for recon -->
	...
	<!-- Call id 433921 Changes End-->
			...
			{
//alert('ChangeStatusDaterec>>Status: ' + recStatus);
...
<!-- Tracker ID :756914 - Chrome Porting Changes -->
				...
				document.getElementsByName("EntityDocumentBO.DocRemarks")[0].setAttribute('IsMandatory','false');
				document.getElementsByName("mandStarEntityDocumentBO.DocRemarks")[0].style.visibility="hidden";
				document.getElementsByName("EntityDocumentBO.ReferenceNumber")[0].setAttribute('IsMandatory','false');
				document.getElementsByName("mandStarEntityDocumentBO.ReferenceNumber")[0].style.visibility="hidden";
				document.getElementsByName("Cat_EntityDocumentBO.PlaceOfIssue")[0].setAttribute('IsMandatory','false');
				document.getElementsByName("mandStarEntityDocumentBO.PlaceOfIssue")[0].style.visibility="hidden";
				document.getElementsByName("Cat_EntityDocumentBO.CountryOfIssue")[0].setAttribute('IsMandatory','false');
				document.getElementsByName("mandStarEntityDocumentBO.CountryOfIssue")[0].style.visibility="hidden";
				document.getElementsByName("3_EntityDocumentBO.DocIssueDate")[0].setAttribute('IsMandatory','false');
				document.getElementsByName("mandStarEntityDocumentBO.DocIssueDate")[0].style.visibility="hidden";

				document.getElementsByName("3_EntityDocumentBO.DocReceivedDate")[0].setAttribute('IsMandatory','false');
...
//				document.getElementsByName('3_EntityDocumentBO.DocReceivedDate')[0].value = "";
				...
				document.getElementsByName("3_EntityDocumentBO.WaivedOrDeferedDate")[0].setAttribute('IsMandatory','false');
				...
				<!-- change for callid 392983 begins -->
                                document.getElementsByName("3_EntityDocumentBO.DocDueDate")[0].setAttribute('IsMandatory','false');
			  ...
			  if(recStatus.toUpperCase() == "RECEIVED") {
					...
					document.getElementsByName("3_EntityDocumentBO.DocReceivedDate")[0].setAttribute('IsMandatory','true');
					...
					document.getElementsByName("3_EntityDocumentBO.WaivedOrDeferedDate")[0].setAttribute('IsMandatory','true');
					...
					document.getElementsByName("EntityDocumentBO.DocRemarks")[0].setAttribute('IsMandatory','true');
					document.getElementsByName("mandStarEntityDocumentBO.DocRemarks")[0].style.visibility="visible";
					document.getElementsByName("EntityDocumentBO.PlaceOfIssue")[0].setAttribute('IsMandatory','false');
					document.getElementsByName("Cat_EntityDocumentBO.PlaceOfIssue")[0].setAttribute('IsMandatory','false');
					document.getElementsByName("mandStarEntityDocumentBO.PlaceOfIssue")[0].style.visibility="hidden";
					document.getElementsByName("EntityDocumentBO.CountryOfIssue")[0].setAttribute('IsMandatory','false');
					document.getElementsByName("Cat_EntityDocumentBO.CountryOfIssue")[0].setAttribute('IsMandatory','false');
					document.getElementsByName("mandStarEntityDocumentBO.CountryOfIssue")[0].style.visibility="hidden";																									
	 
					<!-- change for callid 392983 begins -->
					if(recStatus.toUpperCase() == "DEFERRED") {
					document.getElementsByName("3_EntityDocumentBO.DocDueDate")[0].setAttribute('IsMandatory','true');
					...
					document.getElementsByName("EntityDocumentBO.Scanned")[0].selectedIndex = 0;
					 //Changes for Tracker ID 430228 - TOL 414857 starts
						document.getElementsByName("EntityDocumentBO.PlaceOfIssue")[0].setAttribute('IsMandatory','true');
						document.getElementsByName("mandStarEntityDocumentBO.PlaceOfIssue")[0].style.visibility="visible";				
		
						document.getElementsByName("EntityDocumentBO.CountryOfIssue")[0].setAttribute('IsMandatory','true');
						document.getElementsByName("mandStarEntityDocumentBO.CountryOfIssue")[0].style.visibility="visible";		
...
//					alert(DateVal);
			   ...
			   function CheckWaivedOrDefered()
			   {
			   	...
			   	<!-- dedup check new start-->
				
	function fnCustomDedupCheck_1()
	{
		//alert("fnCustomDedupCheck_1");
		
		//alert("document.cookie - >" + document.cookie)
		
		if(CIF_Type == "Retail")
		{
			if((mode == "Edit Entity") || (mode == 'Queue'))
			{
				<!--Call function to validate the unique id-->
				//alert("validateUniqueId");
				//validateUniqueId();	
			}
			else 
			{
				if((mode == "add" ) || (mode.toUpperCase() == "ADD"))
				{
					var myReferenceNumber = document.getElementsByName("EntityDocumentBO.ReferenceNumber")[0].value;
					//alert("myReferenceNumber -> " + myReferenceNumber)
					
					var myUniqueID = getCookie('myUniqueID');
					//alert("myUniqueID -> " + myUniqueID);
					
					//alert(myReferenceNumber + " -> " + myUniqueID);
				
					if(myUniqueID === "" || myUniqueID === null)
					{
						
						if(myReferenceNumber !=="" || myReferenceNumber === null)
						{
							try
							{
								var s_xmlHttp;
								...
								var sucMsg = "";
								s_xmlHttp.abort();
								var strURL = '../servlet/com.infy.cis.custom.DRCCustomIDDedupcheck?UniqueID='+myReferenceNumber;
								...
								{	
									...
									{
										alert("THE UNIQUE ID: "+ myReferenceNumber +" ENTERED ALREADY EXISTS IN THE SYSTEM. DUPLICATED RECORD!!!");
									...
									else
									{
										if(statusValue == "NOMATCH")
										{
											...
											document.getElementsByName('EntityDocumentBO.ReferenceNumber')[0].value = myReferenceNumber;
											document.getElementsByName("EntityDocumentBO.ReferenceNumber")[0].readOnly = true;
											document.cookie = "myUniqueID=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/";
										}
										else
										{
					...
					else
					{
						var myUniqueID = getCookie('myUniqueID');
						//alert(myUniqueID);
						document.getElementsByName("EntityDocumentBO.ReferenceNumber")[0].value = myUniqueID;
						document.getElementsByName("EntityDocumentBO.ReferenceNumber")[0].readOnly = true;
						document.cookie = "myUniqueID=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/";
					}
					//alert("fnCustomDedupCheck end ok1");
				}
			}
		}
	...
	function fnCustomDedupCheck_1_bkp()
	{
		//alert("fnCustomDedupCheck_1");
	...
	<!-- dedup check new ends-->

			   
			   <!-- dedup check starts-->
						function fnCustomDedupCheck(){
								//alert("fnCustomDedupCheck");
								//alert("mode : " + mode);
								...
								if(mode == "add" )
								{
									...
									//alert(myUniqueID)
									//alert("populateRefNumDocCodeDedupData start");
									//populateRefNumDocCodeDedupData();
									//alert("populateRefNumDocCodeDedupData end");
								}
							}
			  <!-- dedup check ends-->
				...
				/*-------Silvester check to disable Military Id expriry mandatorization start----------------------->*/
				function MilitaryCheck()
				{
					var militaryId=document.getElementsByName ('EntityDocumentBO.DocCode')[0].value
					if(militaryId==11)
					{
						...
						document.getElementsByName("3_EntityDocumentBO.DocExpiryDate")[0].setAttribute('IsMandatory','false');
						document.getElementsByName("mandStarEntityDocumentBO.DocExpiryDate")[0].style.visibility="hidden";
						//alert("Expiry disabled");
					}
					var studentcard=document.getElementsByName ('EntityDocumentBO.DocCode')[0].value
					//alert(studentcard);
					if(studentcard=="CET")
					{
				...
				/*-------Silvester check to disable Military Id expriry mandatorization ends----------------------->*/
	  ...
	  <xsl:choose>
		<xsl:when test="normalize-space($mode)='add' or 'edit'">
			<xsl:call-template name="mdrpdown">
				...
				<xsl:with-param name="onchangefn">loadDocDesc(this);MilitaryCheck();</xsl:with-param>
			</xsl:call-template>
		</xsl:when>
		<xsl:otherwise>
	...
	<xsl:template name="EntityDocumentBO.ScanRequired">
	 ...
	 <xsl:template name="EntityDocumentBO.ReferenceNumber">
		 <xsl:call-template name="label">
			...
			<xsl:with-param name="fn_onBlur">fnCustomDedupCheck_1();</xsl:with-param>
...
<!-- Fix for TrackerId: 275751 ticketId:455462 End -->
	...
	<xsl:template name="EntityDocumentBO.DocIssueDate">
	 ...
	 <xsl:template name="EntityDocumentBO.USERFIELD5">
		 <xsl:call-template name="label">
			<xsl:with-param name="res_name" select="$configLabels[@name='EntityDocumentBO.USERFIELD5']"/>
			<xsl:with-param name="ele_name">EntityDocumentBO.USERFIELD5</xsl:with-param>
			<xsl:with-param name="ele_val">EntityDocumentBO.USERFIELD5</xsl:with-param>
			<xsl:with-param name="UsrDataSpace">CustomData</xsl:with-param>
			<xsl:with-param name="starshow">true</xsl:with-param>
		</xsl:call-template>
	</xsl:template>
		...
		<xsl:call-template name="Begin"/>
			<td>
				...
				<!--<form name="frm2"  method="post" action=""> -->
					...
					<xsl:call-template name="Begin"/>
						<xsl:call-template name="EntityDocumentBO.USERFIELD5"/>
