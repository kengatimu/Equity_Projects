				...
				if(!regExp.test(clName)){
					...
					return false;
                        ...
                        if (document.forms[0].idNuma.value == ""){
                                ...
                                return false;
                        //}else{
			    //var idnumval = document.getElementById('idNuma').value;
			    //if( /[^a-zA-Z0-9\-\/]/.test( idnumval ) ) {
			    //	alert('Identication Number is not alphanumeric');
			    //return false;
			    //}
			}
		}
...
write('<td class="textfield" style="width: 526px">');
write('<input type="text" class="textfieldfont" name="srcPurp" id="srcPurp" size=30 maxlength=25>');
