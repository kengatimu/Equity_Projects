...
function acxfrscdet_pre_ONCLICK(obj)
{
	if((obj.id=="Submit") || (obj.id=="Validate"))
		...
		if (profileId !="43")
			...
			if ((document.forms[0].sourceSchm.value=="SB777") || (document.forms[0].sourceSchm.value=="VA300") || (document.forms[0].sourceSchm.value=="CA207") || (document.forms[0].sourceSchm.value=="SB126"))
				{
