<!------------------------------------------------------------------------------------------------>
<!--    Name            :       lachrg_details_custom.jsp                                       
<!--    Menu            :       HOAACLA,HOAACMLA,HOAACCL,HOAACMCL                                                  
<!--    Author          :       Priya K                                               
...
{
	if( (mopId == "HOAACLA") || (mopId == "HOAACMLA") || (mopId == "HOAACCL") || (mopId == "HOAACMCL") || (mopId == "HACMLA") || (mopId == "HACMCL"))
	{ 
