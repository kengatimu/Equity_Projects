...
<%
	...
	String funcCode=request.getParameter("cmemo.funcCode")!=null ?request.getParameter("cmemo.funcCode"):"";
	String custID=request.getParameter("cmemo.custID")!=null ?request.getParameter("cmemo.custID"):"";
%>
<script>
