...
function milaschdet_pre_TAB_SWITCH(obj)
{
...
function milaschdet_pre_ONCLICK(obj)
{
	if(mopId.toUpperCase()=="MILA")
	{
		setFieldsToCustomData("flgRadioSwitch");
...
function milaschdet_pre_ONLOAD(obj)
{
