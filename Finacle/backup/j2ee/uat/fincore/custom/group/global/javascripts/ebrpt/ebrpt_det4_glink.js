function printBlock(){
	...
	write('<input  hotKeyId="calender2"  type="text" class="textfieldfont" fdt="uidate"  mnebl="false" onBlur="javascript:return ebrpt_det4_ONBLUR1(this,this,this);" name="' + subGroupName + '.fromDate_ui" id="fromDate_ui"  style="width: 186px;">');
...
//OAB
	...
	write('<td class="textfield">');
	//write('<input hotKeyId="search1" type="text" class="textfieldfont" name="' + subGroupName + '.OabAcctId" id="OabAcctId"  fmnd="' + ebrptProps.get("OabAcctId_MANDATORY") + '" ' + ebrptProps.get("OabAcctId_ENABLED") + ' size="16" maxlength="16" onchange="javascript:return ebrpt_det4_ONCHANGE50(this,this,\'opacctName\',\'opacctSolId\',\'opacctCrncy\',true,\'VALCUSTACCTID\');" onclick="javascript:return ebrpt_det4_ONCHANGE10(this,this,\'opacctName\',\'opacctSolId\',\'opacctCrncy\',true,\'VALCUSTACCTID\');">&nbsp;');
	write('<input hotKeyId="search1" type="text" class="textfieldfont" name="' + subGroupName + '.OabAcctId" id="OabAcctId"  fmnd="' + ebrptProps.get("OabAcctId_MANDATORY") + '" ' + ebrptProps.get("OabAcctId_ENABLED") + ' size="16" maxlength="16" onchange="javascript:return ebrpt_det4_ONCHANGE50(this,this,\'opacctName\',\'opacctSolId\',\'opacctCrncy\',true,\'VALACCTID\');" onclick="javascript:return ebrpt_det4_ONCHANGE10(this,this,\'opacctName\',\'opacctSolId\',\'opacctCrncy\',true,\'VALACCTID\');">&nbsp;');
...
function printFooterBlock(){
	...
	write('<input id="Submit" name="Submit" type="button" class="button"	onClick="javascript:return ebrpt_det4_ONCLICK3(this,this);"" value="' + jspResArr.get("FLT000193") + '" hotKeyId="Submit">');
	write('<input id="Validate" name="Validate" type="button" class="button" value="' + jspResArr.get("FLT000194") + '"	onClick="javascript:return ebrpt_det4_ONCLICK4(this,this);"" hotKeyId="Validate">');
	write('<input id="Cancel" name="Cancel" type="button" class="button" value="' + jspResArr.get("FLT001721") + '"	onClick="javascript:return ebrpt_det4_ONCLICK5(this,this.id);"" hotKeyId="Cancel">');
	}else{
	write('<div class="ctable">');
...
function ebrpt_det4_ONBLUR1(obj,p1,p2){
	var retVal = "";
	if (pre_ONBLUR('ebrpt_det4',obj) == false) { 
		return false;
	}
	...
	if (post_ONBLUR('ebrpt_det4',obj) == false) { 
		return false;
	}
	return (retVal == undefined) ? true : retVal;
}
function ebrpt_det4_ONBLUR2(obj,p1,p2){
	var retVal = "";
	if (pre_ONBLUR('ebrpt_det4',obj) == false) { 
		return false;
	}
...
function ebrpt_det4_ONCLICK3(obj,p1){
	var retVal = "";
	if (pre_ONCLICK('ebrpt_det4',obj) == false) { 
		return false;
	}
	if ((retVal =  fnValAndSubmit(p1)) == false) {
		return false;
	}
	if (post_ONCLICK('ebrpt_det4',obj) == false) { 
		return false;
	}
	return (retVal == undefined) ? true : retVal;
}
function ebrpt_det4_ONCLICK4(obj,p1){
	var retVal = "";
	if (pre_ONCLICK('ebrpt_det4',obj) == false) { 
		return false;
	}
...
function ebrpt_det4_ONCLICK5(obj,p1){
	var retVal = "";
	if (pre_ONCLICK('ebrpt_det4',obj) == false) { 
		return false;
	}
...
function ebrpt_det4_ONCHANGE50(obj,p1,p2,p3,p4,p5,p6){
	       if ((retVal = opfetchAcctDtls(p1,p2,p3,p4,p5,p6)) == false){
		                       return false;
		               }
}
function ebrpt_det4_ONCHANGE10(obj,p1,p2,p3,p4,p5,p6){
	       if ((retVal = opfetchAcctDtls(p1,p2,p3,p4,p5,p6)) == false){
		                       return false;
		               }
}
