...
<script>
	...
	var OperaccNum = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".OperaccNum",""))%>';
	...
	var reshDate = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".reshDate",""))%>';
	var lstAdjDate = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".lstAdjDate",""))%>';
