...
function printFooterBlock()
{
	...
	write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return cichqd_res_ONCLICK1(this);" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function cichqd_res_ONCLICK1(obj)
{
	var retVal = "";
	/*
	if (pre_ONCLICK('cichqd_res',obj) == false) { 
		return false;
	}
	*/
	...
	/*
	if (post_ONCLICK('cichqd_res',obj) == false) { 
		return false;
	}
	*/
