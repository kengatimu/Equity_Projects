...
function printFooterBlock()
{
    ...
    write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return cscupp_res_ONCLICK1(this);" hotKeyId="Go">');
    writeFooter();
    write('</div>');
    }
}//End function
...
function cscupp_res_ONCLICK1(obj)
{
    var retVal = "";
    /*if (pre_ONCLICK('cscupp_res',obj) == false) { 
        return false;
    }*/
    if ((retVal = fnLastButtonClick()) == false) {
        return false;
    }
    /*if (post_ONCLICK('cscupp_res',obj) == false) { 
        return false;
    }*/
