...
function printFooterBlock()
{
	...
	write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return cochbm_res_ONCLICK1(this);" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function cochbm_res_ONCLICK1(obj)
{
	var retVal = "";
	/*
	if (pre_ONCLICK('cochbm_res',obj) == false) { 
		return false;
	}
	*/
	...
	/*
	if (post_ONCLICK('cochbm_res',obj) == false) { 
		return false;
	}
	*/
