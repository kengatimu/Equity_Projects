...
<%
	...
	String funCode=request.getParameter("ccpm.funCode")!=null ?request.getParameter("ccpm.funCode"):"";
	String roleID=request.getParameter("ccpm.roleID")!=null ?request.getParameter("ccpm.roleID"):"";
    String currency= request.getParameter("ccpm.currency")!=null ?request.getParameter("ccpm.currency"):"";
%>
