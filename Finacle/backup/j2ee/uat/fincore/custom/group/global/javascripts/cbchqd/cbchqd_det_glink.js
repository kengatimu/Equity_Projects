function printBlock()
{
	...
	write('<tr>');
	write('<td class="page-heading">Bankers Chq Code Maintenance</td>');
	write('</tr>');
	write('</table>');
	...
	write('<tr>');
	write('<a href="javascript:showHelpFile(\'cbchqd_det_help.htm\');" id="sLnk1">');
...
function printFooterBlock()
{
	...
	write('<div class="ctable">');
        write('<input name="Submit" type="button" class="button" onClick="javascript:return cbchqd_det_ONCLICK1(this,this);" id="Submit" value="Submit" hotKeyId="Submit">');
        write('<input name="Clear" type="button" class="button" onClick="javascript:return cbchqd_det_ONCLICK2(this);" id="Clear" value="Clear">');
...
function cbchqd_det_ONCLICK1(obj,p1)
{
/*	var retVal = "";
	if (pre_ONCLICK('cbchqd_det',obj) == false) { 
		return false;
	}
*/
	...
	var frm = document.forms[0];
       ...
       frm.submit();
	*/
	if (post_ONCLICK('cbchqd_det',obj) == false) { 
	return false;
	}
	return (retVal == undefined) ? true : retVal;
}

function cbchqd_det_ONCLICK2(obj)
{
	var retVal = "";
/*
	if (pre_ONCLICK('cbchqd_det',obj) == false) { 
