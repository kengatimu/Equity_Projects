...
function printFooterBlock()
{
	...
	write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return cmpad_res_ONCLICK1(this);" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function cmpad_res_ONCLICK1(obj)
{
	var retVal = "";
	/*
	if (pre_ONCLICK('cmpad_res',obj) == false) { 
		return false;
	}
	*/
	...
	/*
	if (post_ONCLICK('cmpad_res',obj) == false) { 
		return false;
	}
	*/
