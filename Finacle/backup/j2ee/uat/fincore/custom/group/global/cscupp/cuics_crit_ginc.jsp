...
<script>
	...
	var funcCode = '<%=ParseValue.checkString(ARJspCurr.getInput("funcCode",""))%>';
	var roleId = '<%=ParseValue.checkString(ARJspCurr.getInput("roleId",""))%>';
	var currency = '<%=ParseValue.checkString(ARJspCurr.getInput("currency",""))%>';
