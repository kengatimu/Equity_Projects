...
function printFooterBlock()
{
	...
	write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return ccsm_res_ONCLICK1(this);" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function ccsm_res_ONCLICK1(obj)
{
	var retVal = "";
	/*
	if (pre_ONCLICK('ccsm_res',obj) == false) { 
		return false;
	}
	*/
	...
	/*
	if (post_ONCLICK('ccsm_res',obj) == false) { 
		return false;
	}
	*/
