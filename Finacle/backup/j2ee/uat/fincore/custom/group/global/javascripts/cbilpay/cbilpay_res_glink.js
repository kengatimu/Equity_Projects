...
function printFooterBlock()
{
    ...
    write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return cbilpay_res_ONCLICK(this);" hotKeyId="Go">');
    writeFooter();
    write('</div>');
    }
}//End function
...
function cbilpay_res_ONCLICK(obj)
{
    var retVal = "";
    /*if (pre_ONCLICK('cbilpay_res',obj) == false) { 
        return false;
    }*/
    if ((retVal = fnLastButtonClick()) == false) {
        return false;
    }
    /*if (post_ONCLICK('cbilpay_res',obj) == false) { 
        return false;
    }*/
