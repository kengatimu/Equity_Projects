...
<script>
	...
	var roleId = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".roleId",""))%>';
        var frmccyCode = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".frmccyCode",""))%>';
        var toccyCode = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".toccyCode",""))%>';
	var txnType = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".txnType",""))%>';
	var roleDesc = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".roleDesc",""))%>';

</script>
<script language="javascript" src="../Renderer/javascripts/lists/<%=VRPKeys.getFile("showCurrency.js",sProfileId)%>"></script>
<script language="javascript" src="../Renderer/javascripts/lists/<%=VRPKeys.getFile("showUserIdList.js",sProfileId)%>" > </script>
<script language="javascript" src="../Renderer/javascripts/<%=VRPKeys.getFile("cust_common_functions.js",sProfileId)%>" > </script>
<script language="javascript" src="../Renderer/javascripts/lists/<%=VRPKeys.getFile("showRoleList.js",sProfileId)%>" > </script>
