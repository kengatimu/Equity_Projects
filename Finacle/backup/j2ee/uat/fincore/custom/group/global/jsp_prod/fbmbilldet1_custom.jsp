       ...
       String[] custData1 = (String[]) ARJspCurr.getInput(com.infy.bbu.ons.common.CommonConstants.KEY_CUSTOM_DATA, null);
		if (custData1 == null) {
           ...
           custData1[0] = "";
			...
			int fbmIndex = Arrays.asList(result).indexOf("~fbmbilldet1");
			if (fbmIndex >= 0) {
...
function fbmbilldet1_post_ONLOAD() 
{
...
function fbmbilldet1_pre_ONCLICK(obj) 
{
...
function fbmbilldet1_pre_TAB_SWITCH(obj) 
{
