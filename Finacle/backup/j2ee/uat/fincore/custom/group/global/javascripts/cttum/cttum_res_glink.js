...
function printFooterBlock()
{
	...
	write('<input id="Ok" name="Ok" type="button" class="button" value="' + jspResArr.get("FLT700124") + '"	onClick="javascript:return cttum_res_ONCLICK1(this);"" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function cttum_res_ONCLICK1(obj)
{
	var retVal = "";
	if (preEventCall('cttum_res',obj,'ONCLICK') == false) { 
		return false;
	}
	if ((retVal = fnLastButtonClick()) == false) {
		return false;
	}
	if (postEventCall('cttum_res',obj,'ONCLICK') == false) { 
		return false;
	}
