...
<!--Description		: This is to validate loan disbursement account
<!--Date		: 31-03-2013
<!--Author		: Saurabh 
<!--Called By		: None    
...
<!--	 0.2			13-06-2013			 Prashanth			adding some fields to custom data
<!---------------------------------------------------------------------------------------------------------------->
<script type="text/javascript">
//ebl start customization Defaultingtransaction type to transfer
