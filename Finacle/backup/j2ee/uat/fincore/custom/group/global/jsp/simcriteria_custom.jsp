	...
	if (profileId ==54)
	{
		...
		if(obj.id == "Accept" && fvalue != "I"){
			...
			if ((fvalue == "A")||(fvalue == "M")||(fvalue == "C")||(fvalue == "D"))
			{
				...
				if ((a=="055")|(a=="060")||(a=="062")||(a=="065")||(a=="070")||(a=="080")||(a=="081")||(a=="110")||(a=="116")||(a=="150")||(a=="200")||(a=="201")||(a=="071")||(a=="650"))
				{
				}
				else
				{			
					alert("Only Workclass 055,060,062,065,070,071,080,081,110,116,150,200,650... allowed for fxn A,M,C,D");				
					return false;
				}
			}			
