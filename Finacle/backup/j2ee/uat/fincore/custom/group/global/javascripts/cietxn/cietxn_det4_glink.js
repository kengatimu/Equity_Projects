function printBlock()
{
        writeCustomHeader("cietxn_det4");
        with (document){
	write('<input name="' + subGroupName + '.varbiotest" id="varbiotest" ' + cietxnProps.get("varbiotest_ENABLED") + ' type="hidden">');
	write('<input name="' + subGroupName + '.returnValue" id="returnValue" ' + cietxnProps.get("returnValue_ENABLED") + ' type="hidden">');
	...
	write('<input name="' + subGroupName + '.targetCcy" id="targetCcy" ' + cietxnProps.get("targetCcy_ENABLED") + ' type="hidden">');
	...
	write('<input type="radio" name="' + subGroupName + '.cashTxn" id="cashTxn" value="Y"  onClick="javascript:fnChkCashTxn(this)" checked>Yes');
        write('<input type="radio" name="' + subGroupName + '.cashTxn" id="cashTxn" value="N"  onClick="javascript:fnChkCashTxn(this)">No');
	write('<input name="' + subGroupName + '.cashTxnFlg" id="cashTxnFlg" ' + cietxnProps.get("cashTxnFlg_ENABLED") + ' hotKeyId="search1" type="hidden" class="textfieldfont" size="23" maxlength="20">&nbsp;');
        write('</td>');
	...
	write('<tr id="debitEntityRow">');
        ...
        write('<td class="textfield">');
        write('<input name="' + subGroupName + '.debitEntity" id="debitEntity" ' + cietxnProps.get("debitEntity_ENABLED") + ' hotKeyId="search1" type="text" class="textfieldfont" size="24" maxlength="2" onBlur="javascript:return cietxn_det4_ONBLUR8(this);">&nbsp;');
        write('<a id="debitEntityImg" href="javascript:showEntityList1()">');
        write('<img border="0" alt="Search List" height="17" hotKeyId="search1" src="../Renderer/images/'+applangcode+'/search_icon.gif" width="16">');
        write('</a>&nbsp;');
        write('</td>');
        write('<td class="textlabel">');
        write('<input name="' + subGroupName + '.debitEntityDesc" id="debitEntityDesc" ' + cietxnProps.get("debitEntityDesc_ENABLED") + ' hotKeyId="search1" type="text" class="label" size="50" maxlength="50" >&nbsp;');
        write('</td>');
        write('<td class="textfield">');
        write('</td>');
        write('</tr>');
	...
	write('<tr id="drAcctNumRow">');
        write('<td class="textlabel">' + jspResArr.get("FLT000715") + '<script>setMandatory("Y");</script></td>');
        write('<td class="textfield">');
        write('<input name="' + subGroupName + '.drAcctNum" id="drAcctNum" ' + cietxnProps.get("drAcctNum_ENABLED") + ' hotKeyId="search1" type="text" class="textfieldfont" size="24" maxlength="16" onChange="javascript:return cietxn_det4_ONCHANGE1(this);">&nbsp;');
	...
	write('<input name="' + subGroupName + '.drAcctName" id="drAcctName" ' + cietxnProps.get("drAcctName_ENABLED") + ' hotKeyId="search1" type="text" class="label" size="40" maxlength="80" >');
        ...
        write('<td class="textfield">');
        write('<input name="' + subGroupName + '.creditEntity" id="creditEntity" ' + cietxnProps.get("creditEntity_ENABLED") + ' hotKeyId="search1" type="text" class="textfieldfont" size="24" maxlength="2" onBlur="javascript:return cietxn_det4_ONBLUR9(this);">&nbsp;');
	...
	write('<tr id="crAcctNumRow">');
        write('<td class="textlabel">' + jspResArr.get("FLT000702") + '<script>setMandatory("Y");</script></td>');
        write('<td class="textfield">');
        write('<input name="' + subGroupName + '.crAcctNum" id="crAcctNum" ' + cietxnProps.get("crAcctNum_ENABLED") + ' hotKeyId="search1" type="text" class="textfieldfont" size="24" maxlength="16" onChange="javascript:return cietxn_det4_ONCHANGE2(this);">&nbsp;');
	...
	write('<tr id="refCrncyRow">');
        write('<td class="textlabel">' + jspResArr.get("FLT000703") + '<script>setMandatory("Y");</script></td>');
        write('<td class="textfielddisplaylabel">');
        write('<input name="' + subGroupName + '.refCrncy" id="refCrncy" ' + cietxnProps.get("refCrncy_ENABLED") + ' hotKeyId="search1" type="text" class="textfieldcode" size="2" maxlength="3" fdt="currency" onBlur="javascript:return cietxn_det4_ONBLUR3(this);" onChange="javascript:return cietxn_det4_ONCHANGE6(this);">&nbsp;');
	...
	write('<input name="' + subGroupName + '.refAmt" id="refAmt" ' + cietxnProps.get("refAmt_ENABLED") + ' hotKeyId="search1" type="text" class="textfieldamount" size="23" maxlength="23" fdt="amount" onBlur="javascript:return cietxn_det4_ONBLUR7(this);" onChange="javascript:return cietxn_det4_ONCHANGE7(this);">&nbsp;');
        write('</td>');
        write('<td class="textlabel">' + jspResArr.get("FLT000704") + '</td>');
	write('<td width="29%" class="textfielddisplaylabel"><input id="rateCode" name="' + subGroupName + '.rateCode" hotKeyId="search1" ' + cietxnProps.get("rateCode_ENABLED") + ' type="text" class="twotextfieldsearchicon" size="9" maxlength="5" onBlur="javascript:return cietxn_det4_ONBLUR6(this);" onChange="javascript:return cietxn_det4_ONCHANGE8(this);">');
        ...
        write('&nbsp;<input id="rate" name="' + subGroupName + '.rate" ' + cietxnProps.get("rate_ENABLED")+ ' type="text" class="twotextfieldsearchicon" size="9" maxlength="20" onBlur="javascript:return cietxn_det4_ONBLUR5(this);" onChange="javascript:return cietxn_det4_ONCHANGE9(this);" >');
        write('</td>');
        write('</tr>');
	...
	write('<tr>');
        ...
        write('<td class="textfielddisplaylabel">');
        write('<input name="' + subGroupName + '.chargeAmtCcy" id="chargeAmtCcy" ' + cietxnProps.get("chargeAmtCcy_ENABLED") + ' hotKeyId="search1" type="text" class="label" size="2" maxlength="3" >&nbsp;');
        write('<input name="' + subGroupName + '.chargeAmt" id="chargeAmt" ' + cietxnProps.get("chargeAmt_ENABLED") + ' hotKeyId="search1" type="text" class="label" size="23" maxlength="23" fdt="amount">');
        write('<input name="' + subGroupName + '.chargeEventId" id="chargeEventId" ' + cietxnProps.get("chargeEventId_ENABLED") + ' type="hidden">');
        write('</td>');
        write('</tr>');

        write('<tr id="receivableRow">');
        write('<td class="textlabel">Target Entity<script>setMandatory("Y");</script></td>');
        write('<td class="textfield">');
        write('<input name="' + subGroupName + '.targetEntity" id="targetEntity" ' + cietxnProps.get("targetEntity_ENABLED") + ' hotKeyId="search1" type="text" class="textfieldfont" size="24" maxlength="2" onBlur="javascript:return cietxn_det4_ONBLUR10(this);">&nbsp;');
        write('<a id="targetEntitymg" href="javascript:showEntityList3()">');
        write('<img border="0" alt="Search List" height="17" hotKeyId="search1" src="../Renderer/images/'+applangcode+'/search_icon.gif" width="16">');
        write('</a>&nbsp;');
        //write('</td>');
        //write('<td class="textlabel">');
        write('<input name="' + subGroupName + '.targetEntityDesc" id="targetEntityDesc" ' + cietxnProps.get("targetEntityDesc_ENABLED") + ' hotKeyId="search1" type="text" class="label" size="50" maxlength="50" readonly >&nbsp;');
        write('</td>');
        write('<td class="textlabel">Receivable Currency<script>setMandatory("Y");</script></td>');
        write('<td class="textfield">');
//        write('<input name="' + subGroupName + '.targetCrncy" id="targetCrncy" ' + cietxnProps.get("targetCrncy_ENABLED") + ' hotKeyId="search1" type="text" class="textfieldcode" size="24" maxlength="3" fdt="currency" onChange="javascript:return cietxn_det4_ONCHANGE11();">&nbsp;');
        write('<input name="' + subGroupName + '.targetCrncy" id="targetCrncy" ' + cietxnProps.get("targetCrncy_ENABLED") + ' hotKeyId="search1" type="text" class="textfieldcode" size="24" maxlength="3" fdt="currency" onBlur="javascript:return cietxn_det4_ONBLUR11();">&nbsp;');
        write('<a id="sLnk8" href="javascript:gettargetCrncyList()">');
        write('<img src="../Renderer/images/' + applangcode + '/search_icon.gif" width="16" height="17" border="0" alt="Search list" hotKeyId="search2"></a>');
        write('</td>');
        write('</tr>');
	...
	write('<tr id="instrumentTypeRow">');
        ...
        write('<td>');
        write('<input  type="text" class="textfieldfont"   onChange="javascript:return cietxn_det2_ONCHANGE10(this,this,this);" name="' + subGroupName + '.instrumentDate_ui" id="instrumentDate_ui"  class="textfieldfont" size="21" maxlength="10" fdt="uidate">&nbsp;');
	...
	write('<tr class="subhdrbg">');
        write('<td colspan="4">');
        write('<h2 class="subhdr">Sender Details</h2>');
        write('</td>');
        write('</tr>');

	write('<tr>');
        write('<td class="textlabel">' + jspResArr.get("FLT000725") + '<script>setMandatory("Y");</script></td>');
	write('<td class="textfield"><input id="senderName" name="' + subGroupName + '.senderName" ' + cietxnProps.get("senderName_ENABLED") + ' type="text" class="textfieldfont" size="25" onChange="javascript:fnOnChangeSenderName();" maxlength="50">');
        write('</td>');
	write('<td class="textlabel">' + jspResArr.get("FLT000721") + '<script>setMandatory("Y");</script></td>');
        write('<td class="textfield">');
        write('<select name="' + subGroupName + '.senderDocType" id="senderDocType" ' + cietxnProps.get("senderDocType_ENABLED") + ' class="listboxfont" onChange="javascript: fnOnChangeSenderDocType();">');
        write('<option value="">' + jspResArr.get("FLT000722") + '</option>');
        write('<option value="PASSPORT">' + jspResArr.get("FLT000723") + '</option>');
	write('<option value="NATIONAL ID">' + jspResArr.get("FLT000728") + '</option>');
        write('</select>');
        write('</td>');
        write('</tr>');

	write('<tr>');
	write('<td class="textlabel">' + jspResArr.get("FLT000724") + '<script>setMandatory("Y");</script></td>');
        write('<td class="textfield"><input id="senderDocId" name="' + subGroupName + '.senderDocId" ' + cietxnProps.get("senderDocId_ENABLED") + ' type="text" class="textfieldfont" size="25" onChange="javascript:fnOnChangeSenderDocId();" maxlength="30">');
        write('</td>');
	write('<td class="textlabel">' + jspResArr.get("FLT000726") + '</td>');
        write('<td class="textfield"><textarea id="senderNote" name="' + subGroupName + '.senderNote" ' + cietxnProps.get("senderNote_ENABLED") + ' class="textfieldfont" size="25"  onChange="javascript:fnOnChangeSenderNote();" maxlength="80"></textarea>');
        write('</td>');
	write('</tr>');

	write('<tr>');
        write('<td class = "textlabel">' + jspResArr.get("FLT000730") + '<script>setMandatory("Y");</script></td>');
	write('<td class="textfield"><input id="phoneNo" name="' + subGroupName + '.phoneNo" ' + cietxnProps.get("phoneNo_ENABLED") + ' type="text" class="textfieldfont" onBlur="javascript:fnOnBlurPhoneNo();" maxlength="12">&nbsp;&nbsp;');
        write('</td>');
        write('</tr>');

	write('<tr class="subhdrbg">');
        write('<td colspan="4">');
        write('<h2 class="subhdr">Receiver Details</h2>');
        write('</td>');
        write('</tr>');

	write('<tr>');
        write('<td class="textlabel">' + jspResArr.get("FLT000727") + '<script>setMandatory("Y");</script></td>');
        write('<td class="textfield"><input id="receiverName" name="' + subGroupName + '.receiverName" ' + cietxnProps.get("receiverName_ENABLED") + ' type="text" class="textfieldfont" size="25" onChange="javascript:fnOnChangeReceiverName();" maxlength="50">');
        write('</td>');
        write('<td class="textlabel">' + jspResArr.get("FLT000721") + '<script>setMandatory("Y");</script></td>');
        write('<td class="textfield">');
        write('<select name="' + subGroupName + '.receiverDocType" id="receiverDocType" ' + cietxnProps.get("receiverDocType_ENABLED") + ' class="listboxfont" onChange="javascript: fnOnChangeReceiverDocType();">');
        write('<option value="">' + jspResArr.get("FLT000722") + '</option>');
        write('<option value="PASSPORT">' + jspResArr.get("FLT000723") + '</option>');
	write('<option value="NATIONAL ID">' + jspResArr.get("FLT000728") + '</option>');
        write('</select>');
        ...
        write('<tr>');
        write('<td class="textlabel">' + jspResArr.get("FLT000724") + '<script>setMandatory("Y");</script></td>');
        write('<td class="textfield"><input id="receiverDocId" name="' + subGroupName + '.receiverDocId" ' + cietxnProps.get("receiverDocId_ENABLED") + ' type="text" class="textfieldfont" size="25" onChange="javascript:fnOnChangeReceiverDocId();" maxlength="30">');
        write('</td>');
        write('<td class="textlabel"></td>');
        write('<td class="textfield">');
        write('</td>');
	...
	write('<tr testRow>');
        write('<td class="textlabel">Test Quetion<script>setMandatory("Y");</script></td>');
        write('<td class="textfield"><textarea id="testQns" name="' + subGroupName + '.testQns" ' + cietxnProps.get("testQns_ENABLED") + ' class="textfieldfont" size="25"  maxlength="80"></textarea>');
        write('</td>');
        write('<td class="textlabel">Test Answer<script>setMandatory("Y");</script></td>');
        write('<td class="textfield"><textarea id="testAnswr" name="' + subGroupName + '.testAnswr" ' + cietxnProps.get("testAnswr_ENABLED") + ' class="textfieldfont" size="25"  maxlength="80"></textarea>');
        write('</td>');
        write('</tr>');
...
function printFooterBlock()
{
	...
	write('<input id="Submit" name="Submit" type="button" class="button" value="Submit"	onClick="javascript:return cietxn_det4_ONCLICK4(this,this);"" hotKeyId="Submit">');
	write('<input id="Cancel" name="Cancel" type="button" class="button" value="Cancel"	onClick="javascript:return cietxn_det4_ONCLICK5(this,this.id);"" hotKeyId="Cancel">');
	}else{
...
function fnOnLoad()
{
	...
	if(funcCode == "A"){
                if(cashTxnFlg == "N"){
                        ObjForm.cashTxn[1].checked = true;
                }else{
                        cashTxnFlg = "Y";
                        ObjForm.cashTxn[0].checked = true;
                }
	}

	pre_ONLOAD('cietxn_det4',this);
...
{
	var ObjForm = document.forms[0];
	ObjForm.cashTxnFlg.value = cashTxnFlg;
	...
	ObjForm.senderName.value = senderName;
	ObjForm.senderDocType.value = senderDocType;
	ObjForm.senderDocId.value = senderDocId;
	ObjForm.senderNote.value = senderNote;
	ObjForm.phoneNo.value = phoneNo;
	ObjForm.receiverName.value = receiverName;
	ObjForm.receiverDocType.value = receiverDocType;
	ObjForm.receiverDocId.value = receiverDocId;
        ...
        ObjForm.targetCrncy.value = targetCrncy;
        ObjForm.testQns.value = testQns;
        ObjForm.testAnswr.value = testAnswr;
...
function cietxn_det4_ONCHANGE1(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det4',obj,'ONCHANGE') == false) {
                return false;
        }
        if ((retVal = fnGetDrAcctDetails()) == false) {
                return false;
        }
        if (postEventCall('cietxn_det4',obj,'ONCHANGE') == false) {
                return false;
        }
        return (retVal == undefined) ? true : retVal;
}

function cietxn_det4_ONCHANGE2(obj)
{
	var retVal = "";
	if (preEventCall('cietxn_det4',obj,'ONBLUR') == false) {
		return false;
	}
	if ((retVal = fnGetCrAcctDetails()) == false) {
		return false;
	}
	if (postEventCall('cietxn_det4',obj,'ONBLUR') == false) {
		return false;
	}
	return (retVal == undefined) ? true : retVal;
}

function cietxn_det4_ONBLUR3(obj)
{
	var retVal = "";
	if (preEventCall('cietxn_det4',obj,'ONBLUR') == false) {
		return false;
	}
	if ((retVal = fnPopulateCrAcctNum()) == false) {
                return false;
        }
...
function cietxn_det4_ONCHANGE4(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det4',obj,'ONCHANGE') == false) {
                return false;
...
function cietxn_det4_ONBLUR5(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det4',obj,'ONBLUR') == false) {
                return false;
...
function cietxn_det4_ONBLUR6(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det4',obj,'ONBLUR') == false) {
                return false;
...
function cietxn_det4_ONBLUR7(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det4',obj,'ONBLUR') == false) {
                return false;
...
function cietxn_det4_ONBLUR8(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det4',obj,'ONBLUR') == false) {
                return false;
        }
        if ((retVal = fnGetEntityDesc1(obj)) == false) {
                return false;
        }
        if (postEventCall('cietxn_det4',obj,'ONBLUR') == false) {
                return false;
...
function cietxn_det4_ONBLUR9(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det4',obj,'ONBLUR') == false) {
                return false;
...
function cietxn_det4_ONCHANGE10(obj,p1,p2)
{
        var retVal = "";
        if (preEventCall('cietxn_det4',obj,'ONCHANGE') == false) {
                return false;
...
function cietxn_det4_ONCLICK4(obj,p1)
{
	var retVal = "";
	if (preEventCall('cietxn_det4',obj,'ONCLICK') == false) {
		return false;
	}
	if ((retVal =  fnValAndSubmit(p1)) == false) {
		return false;
	}
	if (postEventCall('cietxn_det4',obj,'ONCLICK') == false) {
		return false;
	}
	return (retVal == undefined) ? true : retVal;
}

function cietxn_det4_ONCLICK5(obj,p1)
{
	var retVal = "";
	if (preEventCall('cietxn_det4',obj,'ONCLICK') == false) {
		return false;
...
function cietxn_det4_ONCHANGE6(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det4',obj,'ONCHANGE') == false) {
                return false;
...
function cietxn_det4_ONCHANGE7(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det4',obj,'ONCHANGE') == false) {
                return false;
...
function cietxn_det4_ONCHANGE8(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det4',obj,'ONCHANGE') == false) {
                return false;
...
function cietxn_det4_ONCHANGE9(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det4',obj,'ONCHANGE') == false) {
                return false;
...
function cietxn_det4_ONBLUR10(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det4',obj,'ONBLUR') == false) {
                return false;
        }
        if ((retVal = fnGetEntityDesc3(obj)) == false) {
                return false;
        }
        if (postEventCall('cietxn_det4',obj,'ONBLUR') == false) {
                return false;
...
function cietxn_det4_ONBLUR11()
{
  var ObjForm = document.forms[0];
        var targetCrncy = ObjForm.targetCrncy.value;
        var targetEntity = ObjForm.targetEntity.value;

                var inputNameValues = "targetCrncy|"+targetCrncy + "|targetEntity|"+ targetEntity;
                var outputNames = "errorFlg|errorMsg|targetCrncy";
                var scriptName = "cietxndp069.scr"
                var retVal = appFnExecuteScript(inputNameValues,outputNames,scriptName,false);
                var token = retVal.split("|");
                if(token != undefined){
                        var errorFlg = token[1];
                        var errorMsg = token[3];
                        var targetCrncy = token[5];
                        
                        if(errorFlg == "Y"){
                                alert(errorMsg);
                                setFieldFocus(ObjForm.targetCrncy);
                                return false;
                        }else{
                                ObjForm.targetCrncy.value = targetCrncy;
                                                        }
