...
<script>
	...
	var download = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".download",""))%>';
	var fileField = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".fileField",""))%>';
