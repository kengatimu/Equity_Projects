...
function printFooterBlock()
{
	...
	write('<div class="ctable">');
        write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return coupl_res_ONCLICK1(this);" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function coupl_res_ONCLICK1(obj)
{
	var retVal = "";
	/*
	if (pre_ONCLICK('coupl_res',obj) == false) { 
		return false;
	}
	*/
	...
	/*
	if (post_ONCLICK('coupl_res',obj) == false) { 
		return false;
	}
	*/
