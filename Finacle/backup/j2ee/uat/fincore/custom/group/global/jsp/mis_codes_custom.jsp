...
function mis_codes_pre_TAB_SWITCH(obj){
	...
	if(bankId=="56")
	{
		if(mopId == "HOAACSB" || mopId == "HOAACCA" || mopId == "HACM" || mopId == "HACI" || mopId == "HMACI" || mopId == "HACLINQ" || mopId == "HACLI")
		{
			var freeCode2 = document.forms[0].freeCode2.value;
			if(freeCode2 == "" )
			{
				alert("Enter The DPF Category");
				document.forms[0].freeCode2.focus(); 
				return false;
			}
			else
			{
				...
				{
					var freeCode5 = document.forms[0].freeCode5.value;
					var FreeText13= document.forms[0].misFreeText13.value;
					var FreeText12= document.forms[0].misFreeText12.value;

					if(freeCode5== "")
					{
						alert("Enter The Other Bank Name");
						document.forms[0].freeCode5.focus(); 
						return false;
					}
					if(FreeText12=="")
					{
						alert("Enter Acct No");
						document.forms[0].misFreeText12.focus(); 
						return false;
					}
					if(FreeText13=="")
					{
						alert("Enter Acct Name");
						document.forms[0].misFreeText13.focus(); 
						return false;
					}
				}
				else if(freeCode2=="DPF")
				{
					var FreeText9= document.forms[0].misFreeText9.value;
					var FreeText12= document.forms[0].misFreeText12.value;
					var FreeText13= document.forms[0].misFreeText13.value;
					if(FreeText12=="")
					{
						alert("Enter Mobile Money No.");
						document.forms[0].misFreeText12.focus(); 
						return false;
					}
					if(FreeText13=="")
					...
					if(FreeText9== "")
					{
						alert("Enter Telco Name");
						document.forms[0].misFreeText9.focus(); 
						return false;
					}				
...
function post_ONLOAD(){
	if(mopId == "HOAACSB" || mopId == "HOAACCA" )
		...
		if(schmCode == "SB100")
		{
			document.forms[0].misFreeText10.value = "FARMER";
		}
}
function pre_ONLOAD(obj)
{
	...
	if(bankId=="54")
		...
		if(bankId=="56")
		{
			if(mopId == "HOAACSB" || mopId == "HOAACCA" || mopId == "HACM" || mopId == "HACI" || mopId == "HMACI" || mopId == "HACLINQ" || mopId == "HACLI")
			{
				document.getElementById('freeCode2').parentNode.previousSibling.innerHTML =  document.getElementById('freeCode2').parentNode.previousSibling.innerHTML.replace("Free Code 2","DPF Category");
				document.getElementById('freeCode5').parentNode.previousSibling.innerHTML =  document.getElementById('freeCode5').parentNode.previousSibling.innerHTML.replace("Free Code 5","Other Bank Name");
				document.getElementById('misFreeText13').parentNode.previousSibling.innerHTML =  document.getElementById('misFreeText13').parentNode.previousSibling.innerHTML.replace("Free Text 13","Acct Name/Registered Name/Draft Name");
				document.getElementById('misFreeText12').parentNode.previousSibling.innerHTML =  document.getElementById('misFreeText12').parentNode.previousSibling.innerHTML.replace("Free Text 12","Acct No/Mobile money number");
				document.getElementById('misFreeText9').parentNode.previousSibling.innerHTML =  document.getElementById('misFreeText9').parentNode.previousSibling.innerHTML.replace("Free Text 9","Telco Name");
