...
function fnValidateData() {
   if (document.forms[0].lAcctId.value == ""){
        	alert("Please enter the account no");
        	document.forms[0].lAcctId.focus();
        	return false;
        }
if(isNaN(document.forms[0].lAcctId.value))
{
...
function fnProductList_acctId()
{
	...
	//Please check the usage of this product searcher in product glink file and pass the arguments accordingly
       showAccountIdList(objForm.lAcctId,'','','F','','','','');
}
function fnshowAccountIdList(obj){
	var objForm = document.forms[0];
	showAccountIdListt(objForm.lAcctId,objForm.acctSolId,objForm.acctName,'F',objForm.acctCrncy,'','','');
}
