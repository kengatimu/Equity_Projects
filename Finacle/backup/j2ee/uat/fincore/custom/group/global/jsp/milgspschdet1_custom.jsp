...
var objForm = document.forms[0];
	...
	// Fields added for MILGSP

	if(schmCode != "" && (mopId.toUpperCase()=="MILGSP"))
	{
		with (document) {
		write('<html>');
...
/*******************************************************************	
*Name:		milgspschdet1_pre_ONLOAD
*Description: 	Pre on Load functions for tagspmgendet1   
*******************************************************************/

function milgspschdet1_pre_ONLOAD(obj)
{
...
/*******************************************************************	
*Name:		milgspschdet1_pre_TAB_SWITCH
*Description: 	Gets called on switching tab 
*               
*******************************************************************/
function milgspschdet1_pre_TAB_SWITCH(obj)
{
...
/*******************************************************************	
*Name:		milgspschdet1_pre_ONCLICK
*Description: 	Gets called on pre onclick 
*               
*******************************************************************/
function milgspschdet1_pre_ONCLICK(obj)
{
   if(obj!="Cancel")
   {
	if((document.forms[0].flgRadioSwitch.value=="Y") && (document.forms[0].withdTaxPrcnt.value==""))
