...
<script>
	...
	var rejReasCode = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".rejReasCode",""))%>';
	var newRejCode = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".newRejCode",""))%>';
