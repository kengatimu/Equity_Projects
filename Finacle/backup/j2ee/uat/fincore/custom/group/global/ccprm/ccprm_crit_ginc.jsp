...
<script>
	...
	var modName = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".modName",""))%>';
        var evntId = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".evntId",""))%>';
	 var evntType = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".evntType",""))%>';
	 var schmCode = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".schmCode",""))%>';
        ...
        var srlNum= '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".srlNum",""))%>';
...
<script language="javascript" src="../Renderer/javascripts/lists/<%=VRPKeys.getFile("getSchemeCodes.js",sProfileId)%>" > </script>
...
<script language="javascript" src="../Renderer/javascripts/lists/<%=VRPKeys.getFile("showAmtCode.js",sProfileId)%>" > </script>
...
<script language="javascript" src="../Renderer/javascripts/lists/<%=VRPKeys.getFile("factoring_frwk_functions.js",sProfileId)%>" > </script>
