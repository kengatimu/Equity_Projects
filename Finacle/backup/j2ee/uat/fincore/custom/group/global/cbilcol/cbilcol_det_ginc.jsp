...
<script>
	...
	var upldFileName = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".upldFileName",""))%>';
	...
	var renInputFile = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".renInputFile",""))%>';
	var funcCode = 'A';
