...
function printFooterBlock()
{
	...
	write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return cuics_res_ONCLICK1(this);" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function cuics_res_ONCLICK1(obj)
{
	var retVal = "";
	/*
	if (pre_ONCLICK('cuics_res',obj) == false) { 
		return false;
	}
	*/
	...
	/*
	if (post_ONCLICK('cuics_res',obj) == false) { 
		return false;
	}
	*/
