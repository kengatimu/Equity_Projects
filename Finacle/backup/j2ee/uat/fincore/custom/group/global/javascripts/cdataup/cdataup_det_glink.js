function printBlock()
{
	...
	write('<tr>');
	write('<td class="page-heading"> BULK BILLER DATA UPLOAD </td>');
	write('</tr>');
	write('</table>');
	...
	write('<tr>');
	write('<a href="javascript:showHelpFile(\'cdataup_det_help.htm\');" id="sLnk1">');
	...
	write('<td><select name="' + subGroupName + '.funcCode" id="funcCode" ' + cdataupProps.get("funcCode_ENABLED") + ' class="textfieldfont" onchange="javascript:f1()">');
	...
	//write('<td><input name="' + subGroupName + '.foracid" id="foracid" ' + cdataupProps.get("foracid_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" onBlur="javascript:return cdataup_ONBLUR12(this);"  onchange="javascript:return cdataup_ONCHANGE1(this,this,\'acctName\',\'acctSolId\',\'acctCrncy\',true,\'VALCUSTACCTID\');">');
	...
	//write('<td><input name="' + subGroupName + '.employer" id="employer" ' + cdataupProps.get("employer_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" >');
	...
	//write('<td><input name="' + subGroupName + '.amount" id="amount" ' + cdataupProps.get("amount_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" onBlur="javascript:valAmount();">');
	//write('</td>');
	//write('<td>&nbsp;</td>');
	//write('<td>&nbsp;</td>');
	//write('<td>&nbsp;</td>');
	...
	//write('<td><input name="' + subGroupName + '.score" id="score" ' + cdataupProps.get("score_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" onBlur="javascript:valScore();">');
	//'wrhite('</td>');
	//write('<td>&nbsp;</td>');
	//write('<td>&nbsp;</td>');
	//write('<td>&nbsp;</td>');
	...
	//write('<td><input name="' + subGroupName + '.period" id="period" ' + cdataupProps.get("period_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" onBlur="javascript:valPeriod();">');
	//write('</td>');
	//write('<td>&nbsp;</td>');
	//write('<td>&nbsp;</td>');
	//write('<td>&nbsp;</td>');
	...
	write('<td class="textfield"><input type="file" name="' + subGroupName + '.fileName" id="fileName" ' + cdataupProps.get("fileName_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="100" /></td>');
	write('<td>&nbsp;</td>');
	write('<td>&nbsp;</td>');
	write('<td>&nbsp;</td>');
	write('</tr>');
...
function printFooterBlock()
{
	...
	write('<div class="ctable">');
        write('<input name="Submit" type="button" class="button" onClick="javascript:return cdataup_det_ONCLICK1(this,this);" id="Submit" value="Submit" hotKeyId="Submit">');
	write('<input name="Clear" type="button" class="button" onClick="javascript:return cdataup_det_ONCLICK2(this);" id="Clear" value="Clear">');
	}else{
...
function cdataup_det_ONCLICK1(obj,p1)
{
	var retVal = "";
...
function cdataup_det_ONCLICK2(obj)
{
	var retVal = "";
	/*if (pre_ONCLICK('cdataup_det',obj) == false) { 
		return false;
	}*/
	if ((retVal = fnClearFields()) == false) {
		return false;
	}
	/*if (post_ONCLICK('cdataup_det',obj) == false) { 
		return false;
	}*/
	return (retVal == undefined) ? true : retVal;
}
...
function cdataup_ONCHANGE1(obj,p1,p2,p3,p4,p5,p6)
{
