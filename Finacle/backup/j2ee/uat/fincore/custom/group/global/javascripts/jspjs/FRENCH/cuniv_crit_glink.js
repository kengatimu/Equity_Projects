...
function printFooterBlock()
{
    ...
    write('<input name=" Accepter" type="button" class="button" onClick="javascript:return cuniv_crit_ONCLICK1(this,this);" id=" Accepter" value=" (Aller)" hmtKeyId="Envoyer  (soumettre) ">');
    }else{
