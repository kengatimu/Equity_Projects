...
function printFooterBlock()
{
	...
	write('<div class="ctable">');
        write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return cdataup_res_ONCLICK1(this);" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function cdataup_res_ONCLICK1(obj)
{
	var retVal = "";
	/*
	if (pre_ONCLICK('cdataup_res',obj) == false) { 
		return false;
	}
	*/
	...
	/*
	if (post_ONCLICK('cdataup_res',obj) == false) { 
		return false;
	}
	*/
