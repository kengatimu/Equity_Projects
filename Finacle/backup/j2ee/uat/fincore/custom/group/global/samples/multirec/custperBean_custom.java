...
public class custperBean_custom extends custperBean
{
	String sAction;
	String sNextPage;
	String llName;
	...
	{
		sNextPage = sApplLangCode +"/cust_per.jsp";

		sAction = httpRequest.getParameter("submitform");
		...
		if (llName != null)
		{
			...
			*/
			...
			if (sAction.equals("MULTIRECNAVIGATION"))
			{
				setDataInContext();
				return sNextPage;
			}
		...
		*/
		...
		if (!sAction.equals("MULTIRECNAVIGATION") && !sAction.equals("Cancel"))
		{
