...
function printFooterBlock()
{
    ...
    write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return cuniv_res_ONCLICK1(this);" hotKeyId="Go">');
    writeFooter();
    write('</div>');
    }
}//End function
...
function cuniv_res_ONCLICK1(obj)
{
    var retVal = "";
   /*if (pre_ONCLICK('cuniv_res',obj) == false) { 
        return false;
    }*/
    if ((retVal = fnLastButtonClick()) == false) {
        return false;
    }
   /*if (post_ONCLICK('cuniv_res',obj) == false) { 
        return false;
    }*/
