...
<!-- 	-----------	------		----------	---------------------------
<!--	0.1		18-07-2013	kate		Original version
<!---------------------------------------------------------------------------------------------------------------->
<script>
...
function clspaycrit_post_ONCHANGE(obj)
...
function clspaycrit_ONBLUR(obj)
...
function clspaycrit_pre_ONCLICK(obj)
{
	if(mopId == "HCLSPAY")
	{
		 if (obj.id=="Accept")
