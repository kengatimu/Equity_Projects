...
<script>
	...
	var commVat = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".commVat",""))%>';
	var funcCode = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".funcCode",""))%>';
	var placeHolder = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".placeHolder",""))%>';
	var placeHldrDesc = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".placeHldrDesc",""))%>';
