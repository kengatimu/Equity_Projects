...
function post_ONLOAD() {
	...
	{
		document.getElementById('chnlLvlCode').parentNode.previousSibling.innerHTML =  document.getElementById('chnlLvlCode').parentNode.previousSibling.innerHTML.replace("Tertiary RMID","Channel Level Code");
		document.getElementById('chnlLvlCodeDesc').parentNode.previousSibling.innerHTML =  document.getElementById('chnlLvlCodeDesc').parentNode.previousSibling.innerHTML.replace("Tertiary RMID","Channel Level Code");
	}
