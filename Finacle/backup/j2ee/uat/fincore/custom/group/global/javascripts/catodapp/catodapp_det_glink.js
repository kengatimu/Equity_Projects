function printBlock()
{
	writeCustomHeader("catodapp_det");
	with (document){
	...
	write('<tr>');
	write('<td class="page-heading">CATOD Score Maintenance </td>');
	write('</tr>');
	write('</table>');
	...
	write('<tr>');
	write('<a href="javascript:showHelpFile(\'catodapp_det_help.htm\');" id="sLnk1">');
	...
	write('<td><select name="' + subGroupName + '.funcCode" id="funcCode" ' + catodappProps.get("funcCode_ENABLED") + ' class="textfieldfont" onchange="javascript:f1()">');
	...
	write('<td><input name="' + subGroupName + '.foracid" id="foracid" ' + catodappProps.get("foracid_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" onBlur="javascript:return catodapp_ONBLUR12(this);"  onchange="javascript:return catodapp_ONCHANGE1(this,this,\'acctName\',\'acctSolId\',\'acctCrncy\',true,\'VALCUSTACCTID\');">');
	...
	write('<td><input name="' + subGroupName + '.employer" id="employer" ' + catodappProps.get("employer_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" >');
	...
	write('<td><input name="' + subGroupName + '.amount" id="amount" ' + catodappProps.get("amount_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" onBlur="javascript:valAmount();">');
	write('</td>');
	write('<td>&nbsp;</td>');
	write('<td>&nbsp;</td>');
	write('<td>&nbsp;</td>');
	...
	write('<td><input name="' + subGroupName + '.score" id="score" ' + catodappProps.get("score_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" onBlur="javascript:valScore();">');
	write('</td>');
	write('<td>&nbsp;</td>');
	write('<td>&nbsp;</td>');
	write('<td>&nbsp;</td>');
	...
	write('<td><input name="' + subGroupName + '.period" id="period" ' + catodappProps.get("period_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" onBlur="javascript:valPeriod();">');
	write('</td>');
	write('<td>&nbsp;</td>');
	write('<td>&nbsp;</td>');
	write('<td>&nbsp;</td>');
...
function printFooterBlock()
{
	...
	write('<div class="ctable">');
        write('<input name="Submit" type="button" class="button" onClick="javascript:return catodapp_det_ONCLICK1(this,this);" id="Submit" value="Submit" hotKeyId="Submit">');
	write('<input name="Clear" type="button" class="button" onClick="javascript:return catodapp_det_ONCLICK2(this);" id="Clear" value="Clear">');
	}else{
...
function catodapp_det_ONCLICK1(obj,p1)
{
	var retVal = "";
...
function catodapp_det_ONCLICK2(obj)
{
	var retVal = "";
	/*if (pre_ONCLICK('catodapp_det',obj) == false) { 
		return false;
	}*/
	if ((retVal = fnClearFields()) == false) {
		return false;
	}
	/*if (post_ONCLICK('catodapp_det',obj) == false) { 
		return false;
	}*/
	return (retVal == undefined) ? true : retVal;
}
...
function catodapp_ONBLUR12(obj)
{
...
function autopopulate(obj)
{
	...
	if(funcCode != 'A')
	{
		...
		var outputNames     = "";
		var scrName         = "catodscoredp005.scr";
...
function catodapp_ONCHANGE1(obj,p1,p2,p3,p4,p5,p6)
{
