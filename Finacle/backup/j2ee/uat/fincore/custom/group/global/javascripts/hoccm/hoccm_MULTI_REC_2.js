...
function fnGetSelectedRow(obj)
{
	...
	if(fnValidateData()){
		...
		if(!(ObjForm.d2InstAmt.value)&&!(ObjForm.d2InstNum.value)&&!(ObjForm.d2InstDate.value)&&!(ObjForm.d2PayingAcctNum.value)&&!(ObjForm.d2BankCode.value)&&!(ObjForm.d2TranCode.value)&&!(ObjForm.d2BatchNum.value)&&!(ObjForm.d2TranId.value)&&!(ObjForm.d2InstFreetext.value)&&!(ObjForm.d2BrCode.value)&& !(currentPosition  == totalRec))
		{
...
function fnNextRecord(dirType)
{
	...
	if(fnValidateData())
	{
		...
		{
			if(!(ObjForm.d2InstAmt.value)&&!(ObjForm.d2InstNum.value)&&!(ObjForm.d2InstDate.value)&&!(ObjForm.d2PayingAcctNum.value)&&!(ObjForm.d2BankCode.value)&&!(ObjForm.d2TranCode.value)&&!(ObjForm.d2BatchNum.value)&&!(ObjForm.d2TranId.value)&&!(ObjForm.d2InstFreetext.value)&&!(ObjForm.d2BrCode.value))
			{
				alert("There are no more records");
				iCount++;
				iFlag=1;	
		...
		if(!(ObjForm.d2InstAmt.value)&&!(ObjForm.d2InstNum.value)&&!(ObjForm.d2InstDate.value)&&!(ObjForm.d2PayingAcctNum.value)&&!(ObjForm.d2BankCode.value)&&!(ObjForm.d2TranCode.value)&&!(ObjForm.d2BatchNum.value)&&!(ObjForm.d2TranId.value)&&!(ObjForm.d2InstFreetext.value)&&!(ObjForm.d2BrCode.value)&& iCount<=0)
		{
			alert("Enter the value in the field.");
			iFlag=1;
		}
