...
function printFooterBlock()
{
	...
	write('<input id="Ok" name="Ok" type="button" class="button" value="' + jspResArr.get("FLT700008") + '"	onClick="javascript:return hcashxres_ONCLICK1(this);"" hotKeyId="Go">');
	write('<input id="Print" name="Print" type="button" class="button" value="PRINT DENOM DETAILS"	onClick="javascript:return hcashxres_ONCLICK2(this);"" >');
...
function hcashxres_ONCLICK1(obj)
{
	var retVal = "";
	if (preEventCall('hcashxres',obj,'ONCLICK') == false) { 
		return false;
	}
	if ((retVal = fnLastButtonClick()) == false) {
		return false;
	}
	if (postEventCall('hcashxres',obj,'ONCLICK') == false) { 
		return false;
	}
	return (retVal == undefined) ? true : retVal;
}

function hcashxres_ONCLICK2(obj)
{
	var retVal = "";
	if (preEventCall('hcashxres',obj,'ONCLICK') == false) { 
		return false;
...
// Changes made in below function for TOL 368861
...
function showDenomDetails()
{
	...
	var outputNames = "creditCoins|creditNotes|debitCoins|debitNotes|creditCoinsValue|creditNotesValue|debitCoinsValue|debitNotesValue|bankName|branchName|empName|creditCrncy|debitCrncy|homeCrncy|userId|bodDate";
