...
<%!
    public static final String _ARJSP_JSP_NAME = "bpapd/bpapddet.jsp";
%>
...
<script language="javascript" src="../Renderer/custom/javascripts/<%=VRPKeys.getCustomFile("bpapddet_custom_link.js",sProfileId)%>"> </script>
...
<script>
function bpapddet_post_ONLOAD(obj) 
	{
		document.forms[0].printReceiptChkBox.checked=true;
