...
<%!
        public static final String _ARJSP_JSP_NAME = "custom/ubp_acctBal.jsp";
%>
...
function fnPrintAcctBal(){
	...
	write('<tr>');
        ...
        write('<td class="textfielddisplaylabel">A - Active</td>');
	...
	write('<tr>');
        ...
        write('<td class="textfielddisplaylabel">N</td>');
