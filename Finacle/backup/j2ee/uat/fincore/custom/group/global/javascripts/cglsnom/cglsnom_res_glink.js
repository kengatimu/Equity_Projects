function printBlock()
{
	...
	write('<tr>');
	write('<td class="page-heading">NOMINAL ACCOUNT CREATION</td>');
	write('</tr>');
	write('</table>');
	write('</td>');
	write('</tr>');
...
function printFooterBlock()
{
	...
	write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return cglsnom_res_ONCLICK1(this);" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function cglsnom_res_ONCLICK1(obj)
{
	var retVal = "";
	/*
	if (pre_ONCLICK('cglsnom_res',obj) == false) { 
		return false;
	}
	*/
	...
	/*
	if (post_ONCLICK('cglsnom_res',obj) == false) { 
		return false;
	}
	*/
