...
<%
	...
	String funCode=request.getParameter("cuicsau.funCode")!=null ?request.getParameter("cuicsau.funCode"):"";
	String roleID=request.getParameter("cuicsau.roleID")!=null ?request.getParameter("cuicsau.roleID"):"";
    String currency= request.getParameter("cuicsau.currency")!=null ?request.getParameter("cuicsau.currency"):"";
%>
