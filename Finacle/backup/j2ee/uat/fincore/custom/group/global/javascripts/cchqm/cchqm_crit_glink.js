...
function printFooterBlock()
{
	...
	write('<input type="button" name="Accept" value="Go" class="button" id="Accept" onClick="javascript:return cchqm_crit_ONCLICK2(this,this);" hotKeyId="Go">');
	write('<input type="button" name="Clear" value="Clear" class="button" id="Clear" onClick="javascript:return cchqm_crit_ONCLICK3(this);">');
	writeFooter();
	write('</div>');
	}
	} //End with()
...
function cchqm_crit_ONCHANGE1(obj,p1)
{
	var retVal = "";
	if (pre_ONCHANGE('cchqm_crit',obj) == false) { 
		return false;
	}
	if ((retVal = validateUser(p1)) == false) {
		return false;
	}
	if (post_ONCHANGE('cchqm_crit',obj) == false) { 
		return false;
	}
	return (retVal == undefined) ? true : retVal;
}

function cchqm_crit_ONCLICK2(obj,p1)
{
...
if ((document.forms[0].funcCode.value != "D") && (document.forms[0].funcCode.value != "V") && (document.forms[0].funcCode.value != "I")){
	...
	if((document.forms[0].funcCode.value!="A") && (document.forms[0].funcCode.value!="U")){
	...
	var retVal = "";
	if (pre_ONCLICK('cchqm_crit',obj) == false) { 
		return false;
	}
	if ((retVal = fnValAndSubmit(p1)) == false) {
		return false;
	}
	if (post_ONCLICK('cchqm_crit',obj) == false) { 
		return false;
	}
	return (retVal == undefined) ? true : retVal;
}

function cchqm_crit_ONCLICK3(obj)
{
	var retVal = "";
	if (pre_ONCLICK('cchqm_crit',obj) == false) { 
		return false;
