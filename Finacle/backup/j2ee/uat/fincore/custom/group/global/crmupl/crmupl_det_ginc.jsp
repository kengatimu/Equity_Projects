...
<script>
	...
	var refnumber= '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".empID",""))%>';
	var uploadFileName= '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".uploadFileName",""))%>';
