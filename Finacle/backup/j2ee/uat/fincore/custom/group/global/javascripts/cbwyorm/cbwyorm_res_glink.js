function printBlock()
{
	...
	write('<tr>');
	write('<td class="page-heading">E-BANKING SWIFT TABLE MAINTAINENCE</td>');
	write('</tr>');
	write('</table>');
	write('</td>');
	write('</tr>');
...
function printFooterBlock()
{
	...
	write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return cbwyorm_res_ONCLICK1(this);" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}

function cbwyorm_res_ONCLICK1(obj)
{
	var retVal = "";
