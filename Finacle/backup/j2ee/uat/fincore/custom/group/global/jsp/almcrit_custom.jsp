...
if ((obj.id=="Accept") &&(profileId=="56"))
	{
		...
		if ((funcCode=="A")||(funcCode=="M")||(funcCode=="V"))
		{
				...
				if ((funcCode=="A")||(funcCode=="M"))
				{
					if ((a=="110")||(a=="130")||(a=="150")||(a=="200")||(a=="260")||(a=="310")||(a=="084")||(a=="144")||(a=="153")||(a=="051")||(a=="063")||(a=="068"))
					{

					}
					else
					{
						alert("Lien Maintenance not allowed.Workclass 063,068,084,110,130,150,200,260,310,051")
						return false;
					}
				...
				if (funcCode=="V")
				{
					if ((a=="146")||(a=="290")||(a=="310")||(a=="340")||(a=="051")||(a=="068")||(a=="064"))
					{
