...
function printFooterBlock()
{
	...
	write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return cichbm_res_ONCLICK1(this);" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function cichbm_res_ONCLICK1(obj)
{
	var retVal = "";
	/*
	if (pre_ONCLICK('cichbm_res',obj) == false) { 
		return false;
	}
	*/
	...
	/*
	if (post_ONCLICK('cichbm_res',obj) == false) { 
		return false;
	}
	*/
