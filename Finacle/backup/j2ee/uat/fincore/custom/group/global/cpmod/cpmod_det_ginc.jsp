...
<script>
	...
	var moduleId = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".moduleId",""))%>';
	var moduleDesc = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".moduleDesc",""))%>';
