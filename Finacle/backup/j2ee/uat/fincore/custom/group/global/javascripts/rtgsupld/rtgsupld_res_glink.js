function printBlock()
{
	writeCustomHeader("rtgsupld_res");
	with (document){
...
function printFooterBlock()
{
	...
	write('<div class="ctable">');
        write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return rtgsupld_res_ONCLICK1(this);" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function rtgsupld_res_ONCLICK1(obj)
{
	var retVal = "";
	/*
	if (pre_ONCLICK('rtgsupld_res',obj) == false) { 
		return false;
	}
	*/
	...
	/*
	if (post_ONCLICK('rtgsupld_res',obj) == false) { 
		return false;
	}
	*/
