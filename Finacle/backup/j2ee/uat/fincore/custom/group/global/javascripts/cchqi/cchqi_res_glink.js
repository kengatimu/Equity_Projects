...
function printFooterBlock()
{
	...
	write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return cchqi_res_ONCLICK1(this);" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function cchqi_res_ONCLICK1(obj)
{
	var retVal = "";
	/*
	if (pre_ONCLICK('cchqi_res',obj) == false) { 
		return false;
	}
	*/
	...
	/*
	if (post_ONCLICK('cchqi_res',obj) == false) { 
		return false;
	}
	*/
