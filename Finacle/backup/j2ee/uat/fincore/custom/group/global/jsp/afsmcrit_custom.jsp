...
function afsmcrit_pre_ONCLICK(obj)
{
	if ((obj.id=="Accept") &&(profileId=="56"))
	{
		...
		if ((funcCode=="F")||(funcCode=="U")||(funcCode=="V"))
		{
				...
				//alert(a);
				//CHG0031591
				// include 063, 068 as makers
				if ((funcCode=="F")||(funcCode=="U"))
				{
					if ((a=="080")||(a=="110")||(a=="150")||(a=="200")||(a=="260")||(a=="063")||(a=="068"))
					{

					}
					else
					{
						alert("Freeze OR Unfreeze not allowed.Workclass 063,068,110,150,200,260")
						return false;
					}
				}
				//CHG0033692 to include W_C 051
				//include 064,068 as checkers
				if (funcCode=="V")
				{
					if ((a=="146")||(a=="290")||(a=="051")||(a=="064")||(a=="068"))
					{

					}
					else
					{
						alert("Verification not allowed.Workclass 051,064,068,146,290")
						return false;
					}
