<!----------------------------------------------------------------------------------------------------->
<!--    Name            :       oituaschdet_custom.jsp                                               -->
<!--    Menu            :       OITUA,OCMIDA,VITUAO,VCMIDAO,MITUAO,MCMIDAO,MITUA                     -->
...
var objForm = document.forms[0];
	...
	if((mopId.toUpperCase()=="OITUA")|| (mopId.toUpperCase()=="OCMIDA") ||(mopId.toUpperCase()=="VITUAO")||(mopId.toUpperCase()=="VCMIDAO")||(mopId.toUpperCase()=="MITUAO")||(mopId.toUpperCase()=="MCMIDAO")||(mopId.toUpperCase()=="MITUA"))
	{
		with (document) {
		write('<html>');
...
function oituaschdet_pre_TAB_SWITCH(obj)
{
...
function oituaschdet_pre_ONCLICK(obj)
{
	if((mopId.toUpperCase()=="OITUA")|| (mopId.toUpperCase()=="OCMIDA") ||(mopId.toUpperCase()=="VITUAO")||(mopId.toUpperCase()=="VCMIDAO")||(mopId.toUpperCase()=="MITUAO")||(mopId.toUpperCase()=="MCMIDAO")||(mopId.toUpperCase()=="MITUA"))
	{
		setFieldsToCustomData("flgRadioSwitch");
...
function oituaschdet_pre_ONLOAD(obj)
{	
	if((mopId.toUpperCase()=="OITUA")|| (mopId.toUpperCase()=="OCMIDA") ||(mopId.toUpperCase()=="VITUAO")||(mopId.toUpperCase()=="VCMIDAO")||(mopId.toUpperCase()=="MITUAO")||(mopId.toUpperCase()=="MCMIDAO")||(mopId.toUpperCase()=="MITUA"))
	{
