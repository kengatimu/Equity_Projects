...
function printFooterBlock()
{
	...
	write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return cbchqd_res_ONCLICK1(this);" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function cbchqd_res_ONCLICK1(obj)
{
	var retVal = "";
	/*
	if (pre_ONCLICK('cbchqd_res',obj) == false) { 
		return false;
	}
	*/
	...
	/*
	if (post_ONCLICK('cbchqd_res',obj) == false) { 
		return false;
	}
	*/
