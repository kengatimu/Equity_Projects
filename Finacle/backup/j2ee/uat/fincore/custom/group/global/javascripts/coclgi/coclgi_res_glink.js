...
function printFooterBlock()
{
        ...
        write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return coclgi_res_ONCLICK1(this);" hotKeyId="Go">');
        writeFooter();
        write('</div>');
        }
}//End function
...
function coclgi_res_ONCLICK1(obj)
{
        var retVal = "";
        /*
        if (pre_ONCLICK('coclgi_res',obj) == false) {
                return false;
        }
        */
        ...
        /*
        if (post_ONCLICK('coclgi_res',obj) == false) {
                return false;
        }
        */
