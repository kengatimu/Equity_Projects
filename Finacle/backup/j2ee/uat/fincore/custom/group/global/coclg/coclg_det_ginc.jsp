...
<%
	...
	String sHomeBankId   = (String)ARJspCurr.getInput(sGrpName+".homeBankId", "");
%>
...
<script>
	...
	var homeSol = <%=homeSol%>;
	var homebk = '<%=ParseValue.checkString(sHomeBankId)%>';
	...
	var printp = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".printp",""))%>';
</script>
...
<script language="javascript" src="../Renderer/javascripts/lists/<%=VRPKeys.getFile("showSetId.js",sProfileId)%>" > </script>
<script language="JavaScript">
	printBlock();
	printFooterBlock();
</script>
