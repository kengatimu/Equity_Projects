function printBlock()
{
	...
	write('</tr>');
        ...
        write('<td class="textfield"><input type="text" class="textfieldfont" fmnd="Y" fmb="Y" fdt="string" fblk="fblk1" fds="N" name="'+subGroupName+'.evtType" id="evtType" size="7" maxlength="5"  onChange="javascript:return hcustcrg_det_ONCHANGE5();" hotKeyId="search1">');
