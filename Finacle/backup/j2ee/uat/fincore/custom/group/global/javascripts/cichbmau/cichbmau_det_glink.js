function printBlock()
{
	writeCustomHeader("cichbmau_det");
	with (document){
	...
	write('<tr>');
	write('<a href="javascript:showHelpFile(\'cichbmau_det_help.htm\');" id="sLnk1">');
    ...
    write('<td><select name="' + subGroupName + '.funcCode" id="funcCode" ' + cichbmauProps.get("funcCode_ENABLED") + ' class="textfieldfont">');
    write('<option value ="" selected>' + jspResArr.get("FLT000005") + '</option>');
    write('<option value="V">' + jspResArr.get("FLT000011") + '</option>');
    write('<option value="X">' + jspResArr.get("FLT000012") + '</option>');
    write('</select>');
    write('</td>');
    write('<td>&nbsp;</td>');
    write('<td>&nbsp;</td>');
    ...
    write('<td><input name="' + subGroupName + '.foracid" id="foracid" ' + cichbmauProps.get("foracid_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" onChange= "javascript:fnCustValidate();" >');
    //write('<a href="javascript:fnshowAccountIdList(document.forms[0].foracid);" id="foracid">');
    write('<a href="javascript:fnshowAccount1(document.forms[0].foracid);" id="foracid">');
    ...
    write('<td><input name="' + subGroupName + '.instrNo" id="instrNo" ' + cichbmauProps.get("instrNo_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" >');
...
write('<IMG src="../Renderer/images/' + applangcode + '/search_icon.gif" width="16" height="17" border=0 hotKeyId="search3"></IMG></a>');
    ...
    write('<td><input name="' + subGroupName + '.bgChqNo" id="bgChqNo" ' + cichbmauProps.get("bgChqNo_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" >');
    write('</td>');
    write('</tr>');
	
	write('<tr>');
    write('<td class="textlabel">' + jspResArr.get("FLT026336") + '<font color=red size=2>*</font></td>');
    write('<td><input name="' + subGroupName + '.noOfLeav" id="noOfLeav" ' + cichbmauProps.get("noOfLeav_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" >');
    write('</td>');
    write('</tr>');
...
function printFooterBlock()
{
	...
	write('<input name="Submit" type="button" class="button" onClick="javascript:return cichbmau_det_ONCLICK1(this,this);" id="Submit" value="Submit" hotKeyId="Submit">');
	write('<input name="Clear" type="button" class="button" onClick="javascript:return cichbmau_det_ONCLICK2(this);" id="Clear" value="Clear">');
	}
	else{
...
function cichbmau_det_ONCLICK1(obj,p1)
{
	var retVal = "";
	if (pre_ONCLICK('cichbmau_det',obj) == false) { 
		return false;
	}
	...
	/*if(document.forms[0].funcCode.value == "I" || document.forms[0].funcCode.value == "X" || document.forms[0].funcCode.value == "V" ){	
    	...
    	if(fnIsNull(document.forms[0].instrNo.value) )
	   	...
	   	cichbmau_det_ONCLICK2(document.forms[0].Clear);
	}*/
//}
...
function cichbmau_det_ONCLICK2(obj)
{
	var retVal = "";
	if (pre_ONCLICK('cichbmau_det',obj) == false) { 
		return false;
	...
	if (post_ONCLICK('cichbmau_det',obj) == false) { 
		return false;
	}
	return (retVal == undefined) ? true : retVal;
}
