...
<script>
	...
	var chrgType = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".chrgType",""))%>';
	...
	var prcnt = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".prcnt",""))%>';
	var slabCode = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".slabCode",""))%>';
