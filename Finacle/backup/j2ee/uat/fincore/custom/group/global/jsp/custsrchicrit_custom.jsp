...
<script type = "text/javascript" >
    if (profileId = "43") 
	{
		function fnGetCifIdFromTaxId()
		{
			var taxIdValue = document.forms[0].taxId.value;
			
			if(taxIdValue != "")
			{
				var inputNameValues	= "taxId|"+taxIdValue;
				var outputNames		= "cifId|taxId|corporateName";
				var scrName		= "GetCifByTaxId.scr";
				var title		= "CIF(s) UNDER TAX ID: " + taxIdValue;
				var literalNames	= "CIF ID|TAX ID|CORPORATE NAME";
				var hyperLnks		= "1";
		...
		document.write('<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" CLASS="ctable" id ="srcFndsTbl">')
		document.write('<TR>')
		document.write('<TD>')
		...
		document.write('<TR id ="taxIdRow">')
		document.write('<tr>');
		document.write('<td class="textlabel" size="500">Tax Id </td>');
		document.write('<td class="textfield" size="200">');
		document.write('<input type="text" name="taxId" style="width: 200px" class="textfieldfont" id="taxId">');		
		document.write('&nbsp; <a target=_self id="taxIdImg" href="javascript:fnGetCifIdFromTaxId(document.forms[0].cifId.value,\'ctrl\',\'F\',\'\');">')
		document.write('<img border="0" height="17" hotKeyId="taxIdSearch" src="../Renderer/images/INFENG/search_icon.gif" width="15">')
		document.write('</a>')
		document.write('</td>');
