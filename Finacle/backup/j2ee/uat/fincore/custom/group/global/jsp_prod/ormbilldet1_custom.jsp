...
<%
       ...
       if (custData1 == null) {
           ...
           int remIndex = Arrays.asList(result).indexOf("~ormbilldet1");
           if (remIndex >= 0) {
...
function ormbilldet1_post_ONLOAD() 
{
...
function ormbilldet1_pre_ONCLICK(obj) 
{
...
function ormbilldet1_pre_TAB_SWITCH(obj) 
{
