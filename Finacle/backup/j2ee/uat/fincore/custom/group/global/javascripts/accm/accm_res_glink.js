...
function printFooterBlock()
{
	...
	write('<input id="Ok" name="Ok" type="button" class="button" value="Ok"	onClick="javascript:return accm_res_ONCLICK1(this);"" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function accm_res_ONCLICK1(obj)
{
	var retVal = "";
	if (pre_ONCLICK('accm_res',obj) == false) { 
		return false;
	}
	if ((retVal = fnLastButtonClick()) == false) {
		return false;
	}
	if (post_ONCLICK('accm_res',obj) == false) { 
		return false;
	}
