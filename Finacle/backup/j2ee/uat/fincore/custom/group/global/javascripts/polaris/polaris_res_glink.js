...
function printFooterBlock()
{
	...
	write('<div class="ctable">');
        write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return polaris_res_ONCLICK1(this);" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function polaris_res_ONCLICK1(obj)
{
	var retVal = "";
	/*
	if (pre_ONCLICK('polaris_res',obj) == false) { 
		return false;
	}
	*/
	...
	/*
	if (post_ONCLICK('polaris_res',obj) == false) { 
		return false;
	}
	*/
