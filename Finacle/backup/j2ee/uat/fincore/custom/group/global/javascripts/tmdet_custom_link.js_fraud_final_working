...
//VP
        ...
        if (tranType == "C"){
			...
			if (amt>=20000000)
			{
				if (tranSubType == "NR"|| tranSubType == "RI" ){
                                if((obj.id == "Post") || (obj.id == "Save")){
                                        //alert("51 web");
                                        var optVal = document.forms[0].option.value;
                                        //alert(optVal);
...
function fnPopulatePayGLCredit()
{
        ...
        if(c == 2)
        {
	        getFieldsFromCustomData("pTranTypes", "refCrncys", "refAmts", "acctIds", "cifInfo","varbiotest","refNum","tranParticular","tranRmks","tranRmks2","refCrncy");
