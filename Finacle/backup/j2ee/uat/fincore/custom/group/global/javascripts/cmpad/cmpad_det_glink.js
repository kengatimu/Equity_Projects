function printBlock()
{
	...
	write('<td class="textfielddisplaylabel">'+ foracid+ " " + accntName+'</td>');
	write('</tr>');
	if(funcCode=="I"){
	write('<tr>');
	write('<table border="0" cellspacing="0" cellpadding="0">');
	...
	write('<tr>');
	write('<a href="javascript:showHelpFile(\'cmpad_det_help.htm\');" id="sLnk1">');
	...
	write('<td><input name="' + subGroupName + '.msg1" id="msg1" ' + cmpadProps.get("msg1_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="50" onChange="checkValidName(this);" >');
	write('</td>');
	write('<td class="textlabel">' + jspResArr.get("FLT026335") + '</td>');
	write('<td><input name="' + subGroupName + '.msg2" id="msg2" ' + cmpadProps.get("msg2_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="50" onChange="checkValidName(this);" >');
	write('</td>');
	write('</tr>');
	write('<tr>');
	write('<td class="textlabel">' + jspResArr.get("FLT026336") + '</td>');
	write('<td><input name="' + subGroupName + '.msg3" id="msg3" ' + cmpadProps.get("msg3_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="50" onChange="checkValidName(this);">');
	write('</td>');
	write('<td class="textlabel">' + jspResArr.get("FLT026337") + '</td>');
	write('<td><input name="' + subGroupName + '.msg4" id="msg4" ' + cmpadProps.get("msg4_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="50" onChange="checkValidName(this);" >');
	write('</td>');
	write('</tr>');
	write('<tr>');
	write('<td class="textlabel">' + jspResArr.get("FLT026338") + '</td>');
	write('<td><input name="' + subGroupName + '.msg5" id="msg5" ' + cmpadProps.get("msg5_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="50" onChange="checkValidName(this);">');
	write('</td>');
	write('<td class="textlabel">' + jspResArr.get("FLT026339") + '</td>');
	write('<td><input name="' + subGroupName + '.msg6" id="msg6" ' + cmpadProps.get("msg6_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="50" onChange="checkValidName(this);">');
	write('</td>');
	write('</tr>');
	write('<tr>');
	write('<td class="textlabel">' + jspResArr.get("FLT026340") + '</td>');
	write('<td><input name="' + subGroupName + '.msg7" id="msg7" ' + cmpadProps.get("msg7_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="50" onChange="checkValidName(this);">');
	write('</td>');
	if (funcCode=="I"){
		write('<td class="textlabel">' + jspResArr.get("FLT026341") + '<font color=red size=2>*</font></td>');
		write('<td><input name="' + subGroupName + '.commChange" id="commChange" ' + cmpadProps.get("commChange_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" disabled >'); 
	}
	else{
	write('<td class="textlabel">' + jspResArr.get("FLT026341") + '<font color=red size=2>*</font></td>');
	write('<td><input name="' + subGroupName + '.commChange" id="commChange" ' + cmpadProps.get("commChange_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" >');
	}
	write('</td>');
	write('</tr>');
	write('<tr>');
...
function printFooterBlock()
{
	...
	write('<input name="Submit" type="button" class="button" onClick="javascript:return cmpad_det_ONCLICK1(this,this);" id="Submit" value="Submit" hotKeyId="Submit">');
	write('<input name="Clear" type="button" class="button" onClick="javascript:return cmpad_det_ONCLICK2(this);" id="Clear" value="Cancel">');
	}else{
...
function cmpad_det_ONCLICK1(obj,p1)
{
	var retVal = "";
	if (pre_ONCLICK('cmpad_det',obj) == false) { 
		return false;
	}
	...
	if (post_ONCLICK('cmpad_det',obj) == false) { 
	return false;
	}
	return (retVal == undefined) ? true : retVal;
}

function cmpad_det_ONCLICK2(obj)
{
	var retVal = "";
	if (pre_ONCLICK('cmpad_det',obj) == false) { 
		return false;
