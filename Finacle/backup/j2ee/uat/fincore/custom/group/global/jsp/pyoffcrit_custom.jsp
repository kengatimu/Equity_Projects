...
{
	var vfuncCode=document.forms[0].funcCode.value;
	var loanacctId=document.forms[0].acctId.value;

	alert(vfuncCode);	
	alert(loanacctId);	

        if ((vfuncCode=="I") && (loanacctId != null))
	{
		if(profileId=='50')
		{
			loanacctId = document.forms[0].acctId.value;
			var input      = "loanacctId|"+loanacctId;
			var outputNames    = "output|outVal";
			var scrName     =   "mgmt_fee_PayOffLaAcct_check.scr";
