<!----------------------------------------------------------------------------------------------------->
<!--Name                : custdetigendet_custom.jsp
<!--Description         : 
<!--Date                : 
<!--Author              : 
<!--Called By           : None
...
function custdetigendet_pre_ONLOAD(obj)
{
    if(profileId == "43")
    {
        ...
        for (var i = 0; i < labels.length; i++) {
            ...
            if (td.className && td.className.indexOf("textlabel") !== -1) {
                ...
                if (txt && txt.indexOf("Address 1") !== -1) {
                    td.innerHTML = td.innerHTML.replace(/Address 1/g, "House no/street name");
                }
