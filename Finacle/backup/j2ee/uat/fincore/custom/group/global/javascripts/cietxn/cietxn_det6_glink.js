function printBlock()
{
	...
	write('<td class="textlabel">' + jspResArr.get("FLT000701") + '</td>');
        ...
        write('</td>');
        write('<td class="columnwidth"></td>');
	write('<td class="textlabel">Status</td>');
        write('<td class="textfielddisplaylabel">');
        write('<label id="compFieldTxnType">' + statusFlgDesc + '</label>');
        write('</td>');
        write('</tr>');
        write('<tr>');
        write('<td class="textlabel">Init Entity Issue Transaction ID</td>');
        write('<td class="textfielddisplaylabel">');
        write('<label align="left"id="compFieldFunc">'+entity1IssueTranId+' / '+entity1IssueTranDate+'</label>');
        write('</td>');
        write('<td class="columnwidth"></td>');
	...
	write('<label align="left"id="compFieldFunc">'+chargeTranId+' / '+chargeTranDate+'</label>');
        write('</td>');
        write('</tr>');
        write('<tr id="pymtTranIdRow">');
        write('<td class="textlabel">Init Entity Payment Transaction ID</td>');
        write('<td class="textfielddisplaylabel">');
	write('<label align="left"id="compFieldFunc">'+entity1PymtTranId+' / '+entity1PymtTranDate+'</label>');
        write('</td>');
        write('<td class="columnwidth"></td>');
        write('<td class="textlabel">Target Entity Payment Transaction ID</td>');
        write('<td class="textfielddisplaylabel">');
	write('<label align="left"id="compFieldFunc">'+entity2PymtTranId+' / '+entity2PymtTranDate+'</label>');
        write('</td>');
        write('</tr>');
        write('</table>');
        write('<br/>');
	...
	write('<tr id="debitEntityRow">');
        ...
        write('<td class="textfield">');
        write('<input name="' + subGroupName + '.debitEntity" id="debitEntity" ' + cietxnProps.get("debitEntity_ENABLED") + ' hotKeyId="search1" type="text" class="textfieldfont" size="24" maxlength="2" onBlur="javascript:return cietxn_det6_ONBLUR8(this);">&nbsp;');
	...
	write('<tr id="drAcctNumRow">');
        ...
        write('<td class="textfield">');
        write('<input name="' + subGroupName + '.drAcctNum" id="drAcctNum" ' + cietxnProps.get("drAcctNum_ENABLED") + ' hotKeyId="search1" type="text" class="textfieldfont" size="24" maxlength="16" onChange="javascript:return cietxn_det6_ONCHANGE1(this);">&nbsp;');
	...
	write('<tr id="creditEntityRow">');
        ...
        write('<td class="textfield">');
        write('<input name="' + subGroupName + '.creditEntity" id="creditEntity" ' + cietxnProps.get("creditEntity_ENABLED") + ' hotKeyId="search1" type="text" class="textfieldfont" size="24" maxlength="2" onBlur="javascript:return cietxn_det6_ONBLUR9(this);">&nbsp;');
	...
	write('<tr id="crAcctNumRow">');
        ...
        write('<td class="textfield">');
        write('<input name="' + subGroupName + '.crAcctNum" id="crAcctNum" ' + cietxnProps.get("crAcctNum_ENABLED") + ' hotKeyId="search1" type="text" class="textfieldfont" size="24" maxlength="16" onChange="javascript:return cietxn_det6_ONCHANGE2(this);">&nbsp;');
	...
	write('<tr id="refCrncyRow">');
        ...
        write('<td class="textfielddisplaylabel">');
        write('<input name="' + subGroupName + '.refCrncy" id="refCrncy" ' + cietxnProps.get("refCrncy_ENABLED") + ' hotKeyId="search1" type="text" class="textfieldcode" size="2" maxlength="3" fdt="currency" onBlur="javascript:return cietxn_det6_ONBLUR3(this);">&nbsp;');
	...
	write('<input name="' + subGroupName + '.refAmt" id="refAmt" ' + cietxnProps.get("refAmt_ENABLED") + ' hotKeyId="search1" type="text" class="textfieldamount" size="23" maxlength="23" fdt="amount" onBlur="javascript:return cietxn_det6_ONBLUR7(this);">&nbsp;');
        write('</td>');
        write('<td class="textlabel">' + jspResArr.get("FLT000704") + '</td>');
	write('<td width="29%" class="textfielddisplaylabel"><input id="rateCode" name="' + subGroupName + '.rateCode" hotKeyId="search1" ' + cietxnProps.get("rateCode_ENABLED") + ' type="text" class="twotextfieldsearchicon" size="9" maxlength="5" onBlur="javascript:return cietxn_det6_ONBLUR6(this);" >');
        ...
        write('&nbsp;<input id="rate" name="' + subGroupName + '.rate" ' + cietxnProps.get("rate_ENABLED")+ ' type="text" class="twotextfieldsearchicon" size="9" maxlength="20" onBlur="javascript:return cietxn_det6_ONBLUR5(this);" >');
        write('</td>');
        write('</tr>');
	...
	write('<tr>');
        ...
        write('<a id="targetEntityimg" href="javascript:showEntityList3()">');
        write('<img border="0" alt="Search List" height="17" hotKeyId="search1" src="../Renderer/images/'+applangcode+'/search_icon.gif" width="16">');
        write('</a>&nbsp;');
        //write('</td>');
        //write('<td class="textlabel">');
	...
	write('<tr>');
        ...
        write('<td class="textfield"><input id="phoneNo" name="' + subGroupName + '.phoneNo" ' + cietxnProps.get("phoneNo_ENABLED") + ' type="text" class="textfieldfont" maxlength="25">&nbsp;&nbsp;');
        write('</td>');
        write('</tr>');
...
function printFooterBlock()
{
	...
	write('<input id="Submit" name="Submit" type="button" class="button" value="Submit"	onClick="javascript:return cietxn_det6_ONCLICK4(this,this);"" hotKeyId="Submit">');
	write('<input id="Cancel" name="Cancel" type="button" class="button" value="Cancel"	onClick="javascript:return cietxn_det6_ONCLICK5(this,this.id);"" hotKeyId="Cancel">');
	}else{
...
function cietxn_det6_ONCHANGE1(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det6',obj,'ONCHANGE') == false) {
                return false;
        }
        if ((retVal = fnGetDrAcctDetails()) == false) {
                return false;
        }
        if (postEventCall('cietxn_det6',obj,'ONCHANGE') == false) {
                return false;
        }
        return (retVal == undefined) ? true : retVal;
}

function cietxn_det6_ONCHANGE2(obj)
{
	var retVal = "";
	if (preEventCall('cietxn_det6',obj,'ONBLUR') == false) { 
		return false;
	}
	if ((retVal = fnGetCrAcctDetails()) == false) {
		return false;
	}
	if (postEventCall('cietxn_det6',obj,'ONBLUR') == false) { 
		return false;
	}
	return (retVal == undefined) ? true : retVal;
}

function cietxn_det6_ONBLUR3(obj)
{
	var retVal = "";
	if (preEventCall('cietxn_det6',obj,'ONBLUR') == false) { 
		return false;
	}
	if ((retVal = fnOnBlurRefCcy(obj)) == false) {
		return false;
	}
	if (postEventCall('cietxn_det6',obj,'ONBLUR') == false) { 
		return false;
...
function cietxn_det6_ONCHANGE4(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det6',obj,'ONCHANGE') == false) {
                return false;
        }
        if ((retVal = fnOnChangeRefCcy(obj)) == false) {
                return false;
        }
        if (postEventCall('cietxn_det6',obj,'ONCHANGE') == false) {
                return false;
...
function cietxn_det6_ONBLUR5(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det6',obj,'ONBLUR') == false) {
                return false;
	...
	if ((retVal = fnComputeTranAmt()) == false) {
                return false;
        }
        if (postEventCall('cietxn_det6',obj,'ONBLUR') == false) {
                return false;
...
function cietxn_det6_ONBLUR6(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det6',obj,'ONBLUR') == false) {
                return false;
        }
        if ((retVal = fnOnBlurRateCode(obj)) == false) {
                return false;
        }
        if (postEventCall('cietxn_det6',obj,'ONBLUR') == false) {
                return false;
...
function cietxn_det6_ONBLUR7(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det6',obj,'ONBLUR') == false) {
                return false;
...
function cietxn_det6_ONBLUR8(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det6',obj,'ONBLUR') == false) {
                return false;
...
function cietxn_det6_ONBLUR9(obj)
{
        var retVal = "";
        if (preEventCall('cietxn_det6',obj,'ONBLUR') == false) {
                return false;
...
function cietxn_det6_ONCHANGE10(obj,p1,p2)
{
        var retVal = "";
        if (preEventCall('cietxn_det6',obj,'ONCHANGE') == false) {
                return false;
...
function cietxn_det6_ONCLICK4(obj,p1)
{
	var retVal = "";
	if (preEventCall('cietxn_det6',obj,'ONCLICK') == false) { 
		return false;
	}
	if ((retVal =  fnValAndSubmit(p1)) == false) {
		return false;
	}
	if (postEventCall('cietxn_det6',obj,'ONCLICK') == false) { 
		return false;
	}
	return (retVal == undefined) ? true : retVal;
}

function cietxn_det6_ONCLICK5(obj,p1)
{
	var retVal = "";
	if (preEventCall('cietxn_det6',obj,'ONCLICK') == false) { 
		return false;
