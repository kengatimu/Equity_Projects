...
function printFooterBlock()
{
	...
	write('<input id="Ok" name="Ok" type="button" class="button" value="' + jspResArr.get("FLT700124") + '"	onClick="javascript:return c2bre_res_ONCLICK1(this);"" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function c2bre_res_ONCLICK1(obj)
{
	var retVal = "";
	if (preEventCall('c2bre_res',obj,'ONCLICK') == false) { 
		return false;
	}
	if ((retVal = fnLastButtonClick()) == false) {
		return false;
	}
	if (postEventCall('c2bre_res',obj,'ONCLICK') == false) { 
		return false;
	}
