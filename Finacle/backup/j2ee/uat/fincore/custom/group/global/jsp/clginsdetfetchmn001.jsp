...
function sendValues(obj) {
	...
	var outputNames        = "";
	var scrName            = "clginsdetfetchmn004.scr";
	...
	sendObj={amt:document.forms[0].amt.value,micrstring:document.forms[0].micrstring.value};
...
<tr>
<td class="textlabel">Instrument Amount</td>
<td class="textlabel"><input class="textfieldfont" id="amt" name="amt" fmnd="Y" size="15"  value="" ></td>
</tr>
<tr>
