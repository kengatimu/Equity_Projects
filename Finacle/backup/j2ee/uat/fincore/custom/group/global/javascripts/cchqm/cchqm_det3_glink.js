function printBlock()
{
	...
	write('<tr>');
	write('<a href="javascript:showHelpFile(\'cchqm_det3_help.htm\');" id="sLnk1">');
	...
	write('<td><input name="' + subGroupName + '.duplicate" id="duplicate" ' + cchqmProps.get("duplicate_ENABLED") + ' type="radio" value = "Y" ONCLICK="javascript:fnOnclickRadio()" >Yes<input name="' + subGroupName +'.duplicate" id="duplicate" ' + cchqmProps.get("duplicate_ENABLED") + ' type="radio" value = "N" ONCLICK="javascript:fnOnclickRadio()">No');
    write('</td>');
    write('</tr>');
    ...
    write('<td><input name="' + subGroupName + '.dnldID" id="dnldID" ' + cchqmProps.get("dnldID_ENABLED") + ' type="text" class="textfieldfont" size="25" maxlength="16" >');
...
function printFooterBlock()
{
	...
	write('<div class="ctable">');
        write('<input name="Submit" type="button" class="button" onClick="javascript:return cchqm_det3_ONCLICK1(this,this);" id="Submit" value="Submit" hotKeyId="Submit">');
        write('<input name="Clear" type="button" class="button" onClick="javascript:return cchqm_det3_ONCLICK2(this);" id="Clear" value="Clear">');
...
function cchqm_det3_ONCLICK1(obj,p1)
{
/*	var retVal = "";
	if (pre_ONCLICK('cchqm_det3',obj) == false) { 
		return false;
	}
*/
	...
	var frm = document.forms[0];
       ...
       frm.submit();
	*/
	if (post_ONCLICK('cchqm_det3',obj) == false) { 
	return false;
	}
	return (retVal == undefined) ? true : retVal;
}

function cchqm_det3_ONCLICK2(obj)
{
	var retVal = "";
/*
	if (pre_ONCLICK('cchqm_det3',obj) == false) { 
