...
<script>
	...
	var fieldType = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".fieldType",""))%>';
	var ibanOrAcct = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".ibanOrAcct",""))%>';
