...
function printFooterBlock()
{
	...
	write('<input type="button" class="button" id="ok" value="Ok" onClick="javascript:return cimgbv_res_ONCLICK1(this);" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End cimgbv
...
function cimgbv_res_ONCLICK1(obj)
{
	var retVal = "";
	/*
	if (pre_ONCLICK('cimgbv_res',obj) == false) { 
		return false;
	}
	*/
	...
	/*
	if (post_ONCLICK('cimgbv_res',obj) == false) { 
		return false;
	}
	*/
