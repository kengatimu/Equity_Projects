...
<%!
    public static final String _ARJSP_JSP_NAME = "ddmi/ddmidet.jsp";
%>
...
<script language="javascript" src="../Renderer/custom/javascripts/<%=VRPKeys.getCustomFile("ddmidet_custom_link.js",sProfileId)%>"> </script>
