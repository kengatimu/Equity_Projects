...
<script>
	...
	var txmrgnAmt = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".txmrgnAmt",""))%>';
	var cashmrgnAmt = '<%=ParseValue.checkString(ARJspCurr.getInput(sSubGrpName+".cashmrgnAmt",""))%>';
