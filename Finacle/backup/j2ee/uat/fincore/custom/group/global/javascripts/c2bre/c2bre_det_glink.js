function printBlock()
{
	...
	write('<select name="' + subGroupName + '.funcCode" id="funcCode" style="width: 218px"  fdt="String" ' + c2breProps.get("funcCode_ENABLED") + '>');
...
function printFooterBlock()
{
	...
	write('<input id="Upload" type="button" name="Submit" value="Upload" class="button" onClick="javascript:return c2bre_det_ONCLICK1(this,this);"" hotKeyId="Submit">');
	//write('<input id="Submit" name="Submit" type="button" class="button"	onClick="javascript:return c2bre_det_ONCLICK1(this,this);"" value="Submit" hotKeyId="Submit">');
	//write('<input id="Validate" name="Validate" type="button" class="button" value="Validate"	onClick="javascript:return c2bre_det_ONCLICK2(this,this);"" hotKeyId="Validate">');
	write('<input id="Cancel" name="Cancel" type="button" class="button" value="Clear"	onClick="javascript:return c2bre_det_ONCLICK3(this,this.id);"" hotKeyId="Cancel">');
	}else{
...
function c2bre_det_ONCLICK1(obj,p1)
{
...
function c2bre_det_ONCLICK2(obj,p1)
{
	var retVal = "";
	if (preEventCall('c2bre_det',obj,'ONCLICK') == false) { 
		return false;
	}
	if ((retVal =  fnValidateData(p1)) == false) {
		return false;
	}
	if (postEventCall('c2bre_det',obj,'ONCLICK') == false) { 
		return false;
	}
	return (retVal == undefined) ? true : retVal;
}

function c2bre_det_ONCLICK3(obj,p1)
{
	var retVal = "";
	if (preEventCall('c2bre_det',obj,'ONCLICK') == false) { 
		return false;
