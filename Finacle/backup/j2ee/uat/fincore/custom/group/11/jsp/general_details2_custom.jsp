...
function post_ONLOAD(){
	...
	if(mopId == "HOAACSB" ||  mopId == "HOAACCA" ||mopId == "HOAACCC" ||  mopId == "HOAACOD"){	
		...
		if(document.getElementById('intCrAcctFlg').value == ""){
			document.getElementById('intCrAcctFlg').value = 'S'
        }
        if(document.getElementById('intDrAcctFlg').value == ""){
			document.getElementById('intDrAcctFlg').value = 'S'
		}
	}
}
</script>
