...
function fnOnButtonClick(btnObj) {
	...
	if (tmpBtnId == 'Accept') {
		...
		if (tranType == 'T' && objForm.drFrmAcct.value == 'Y' && SVS_Flag != undefined && SVS_Flag == "Y" && SVS_Verfication_Mandatory == "Y") { //If trantype is transfer and Operative Account
			if (fnDetailsChanged() == true) { //After Signature Verfication if details are changed
