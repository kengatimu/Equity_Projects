...
function LoadSector()
{
	if(operationType =='EditEntity')
	{
		...
		var Acckey = document.getElementsByName('CorporateBO.corp_Key')[0].value
		ISICValidation('SUB_SECTOR_CODE','.sector','.Subsector_Code','SECTOR_CODE');

		CorpISICValue(Acckey,'Subsector_Code');
		ISICValidation('ISICP1','.Subsector_Code','.StrUserField1','SUB_SECTOR_CODE');
		
		var Subsector_Code = document.getElementsByName('CorporateBO.Subsector_Code')[0].value;

		if(Subsector_Code ==null || Subsector_Code =='')
		{
		SubsectorValue(Acckey,'Subsector');
		ISICValidation('ISICP1','.Subsector_Code','.StrUserField1','SUB_SECTOR_CODE');
		}

		CorpISICValue(Acckey,'StrUserField1');
		
		ISICValidation('ISICP2','.StrUserField1','.StrUserField13','ISICP1');		
		CorpISICValue(Acckey,'StrUserField13');

		ISICValidation('ISIC_DEMAND2','.StrUserField15','.StrUserField16','ISIC_DEMAND1');		
		CorpISICValue(Acckey,'StrUserField16');

		ISICValidation('SUB_SECTOR_CODE','.StrUserField22','.StrUserField23','SECTOR_CODE')
		CorpISICValue(Acckey,'StrUserField23');
		
		ISICValidation('ISICP1','.StrUserField23','.StrUserField2','SUB_SECTOR_CODE')
		CorpISICValue(Acckey,'StrUserField2');
		
		ISICValidation('ISICP2','.StrUserField2','.StrUserField11','ISICP1')
		CorpISICValue(Acckey,'StrUserField11');

		ISICValidation('ISIC_DEMAND2','.StrUserField20','.StrUserField21','ISIC_DEMAND1')
		CorpISICValue(Acckey,'StrUserField21');			
...
//Recon for KYC High Risk start
function Makekycfieldmand()
{
	if(readMode!='Y')
	{
		var highriskcat = document.getElementsByName(boName+".StrUserField12")[0].value;
		if(highriskcat !=''&amp;&amp;highriskcat!=undefined)
		{
		var d = new Date();
		
		var fulldate= ("0" + d.getDate()).slice(-2) + "/" + ("0"+(d.getMonth()+1)).slice(-2) + "/" + d.getFullYear();
		var revdate= ("0" + d.getDate()).slice(-2) + "/" + ("0"+(d.getMonth()+1)).slice(-2) + "/" + (d.getFullYear()+1);

			document.getElementsByName(boName+".submitForKYC")[0].value = "Y";
			document.getElementsByName("3_CorporateBO.KYC_Date")[0].value = fulldate;
			document.getElementsByName("3_CorporateBO.KYC_ReviewDate")[0].value = revdate;
							

		}else{
			document.getElementsByName(boName+".submitForKYC")[0].value = 'N';
			document.getElementsByName("3_CorporateBO.KYC_Date")[0].value = '';
			document.getElementsByName("3_CorporateBO.KYC_ReviewDate")[0].value = '';
			document.getElementsByName("3_CorporateBO.RiskProfileExpiryDate")[0].value= '';
			document.getElementsByName("3_CorporateBO.classified_On")[0].value = '';
		}

	}	
}
//Recon for KYC High Risk End
...
//if(entityType != 'Prospect'){
if((entityType != 'Prospect')&amp;&amp;(entityType != 'Customer')){
//changes done by sundar for kyc
document.getElementsByName(boName+".submitForKYC")[0].disabled = true;
...
<!--Isic validation changes starts-->
	function SegmentValidation()
	{
		
		var source = document.getElementsByName(boName+".StrUserField30")[0].value;	
		
		if(source =='Y')
		{		
		document.getElementsByName(boName+".StrUserField22")[0].IsMandatory = "true";
		...
		document.getElementsByName(boName+".StrUserField11")[0].IsMandatory = "true";
		document.getElementsByName(boName+".StrUserField20")[0].IsMandatory = "true";
		document.getElementsByName(boName+".StrUserField21")[0].IsMandatory = "true";
		}
	}



<!--Isic validation changes ends-->
    ...
    <!-- load() function is renamed to loadGen() -->  
     ...
     <!--tracker id 554568 changes starts-->
      <!--Changes for not auto populating Primary Sol id starts-->
        ...
        <xsl:attribute name="onload">crncyDefaultPop();LoadSector(); crncyDefaultPop1(); crncyDefaultPop2(); crncyDefaultPop3(); langDesc();populateAccContAttr();loadID();loadGen();makekeyMand();loadKYC();focusFirstField();loadrel();DisableGcifIdLookUp();loadZakat();loadBaseCurrency();isTFPartyFlag();loadBasel();makeSwiftFldMand();storeSegment();showbuttonsVisible(45);swifta();loadAddressType();
...
<!--tracker id 231104 changes ends-->
     ...
     <xsl:when test="normalize-space($IsDummy)='Y'">
        ...
        <!--tracker id 231104 changes starts-->
        <!--tracker id 554568 changes starts-->        
             <xsl:attribute name="onload">langDesc();loadID();LoadSector();loadKYC();loadGen();changeSubSeg();loadrel();DisableGcifIdLookUp();focusFirstField();loadBackEnd();showbuttonsVisible(30);showFormTips();loadSubSeg();loadSegVal();clearDummyAddress('<xsl:value-of select="$IsDummy"/>');fnNullifyDummyCustFlds('<xsl:value-of select="$IsDummy"/>');chkBSN();populateAccContAttr();loadBaseCurrency();makekeyMand();storeSegment();loadCode();makeSwiftFldMand();isTFPartyFlag();loadBasel();swifta();
    <!--tracker id 554568 changes ends-->
    <!--tracker id 231104 changes ends-->
    <!-- Tracker ID 131246 CHANGES END BY sonali -->
             </xsl:attribute>
...
<!--ticket id 438296 changes starts-->
	   <!-- Changes for the tracker id 351596 STARTS -->
        <xsl:attribute name="onload">langDesc();loadID();LoadSector();showInReadOnlyMode('<xsl:value-of select="$readMode"/>');loadGen();changeSubSeg();loadSegVal();loadrel();loadKYC();loadBaseCurrency();DisableGcifIdLookUp();populateAccContAttr();swifta();loadBackEnd();chkBSN();isTFPartyFlag();loadBasel();loadCode();makeSwiftFldMand();
...
<!-- changes for tracker 336728: removing call to loadSubSeg() -->
 ...
 <!--tracker id 554568 changes starts-->
 <xsl:attribute name="onload">langDesc();loadID();changeSubSeg();LoadSector();loadSegVal();loadGen();onLoadCurrency();loadrel();DisableGcifIdLookUp();loadbutton();focusFirstField();hideFields();loadBackEnd();showbuttonsVisible(30);showFormTips();clearDummyAddress('<xsl:value-of select="$IsDummy"/>');fnNullifyDummyCustFlds('<xsl:value-of select="$IsDummy"/>');chkBSN();populateAccContAttr();loadBaseCurrency();makekeyMand();storeSegment();loadCode();makeSwiftFldMand();isTFPartyFlag();loadBasel();swifta();loadKYC();loadAddressType();
<!--tracker id 554568 changes ends-->
...
<!--Isic sector changes by Silvester starts-->
			<xsl:template name="CorporateBO.sector">
		    		<xsl:call-template name="mdrpdown">
		    		<xsl:with-param name="res_name" select="$configLabels[@name='CorporateBO.sector']"/>
				...
				<xsl:with-param name="onchangefn">ISICValidation('SUB_SECTOR_CODE','.Sector','.Subsector_Code','SECTOR_CODE')</xsl:with-param>
				<xsl:with-param name="search_type">value</xsl:with-param>
				<xsl:with-param name="presdata" select="$PresData"/>
		    		</xsl:call-template>
		    </xsl:template>
			...
			<xsl:template name="CorporateBO.Subsector_Code">
				<xsl:call-template name="mdrpdown">
					...
					<!-- Changes for corp ISIC Subsector by james Starts  -->
					<xsl:with-param name="onchangefn">ISICValidation('ISICP1','.Subsector_Code','.StrUserField1','SUB_SECTOR_CODE')</xsl:with-param>
					<!-- Changes for corp ISIC Subsector by james ENDS  -->
					<xsl:with-param name="search_type">value</xsl:with-param>
					<xsl:with-param name="presdata" select="$PresData"/>
				</xsl:call-template>
			</xsl:template>
...
<!--Isic sector changes by Silvester ends-->

<!--ISIC customization starts -->
 ...
 <xsl:template name="CorporateBO.StrUserField1">
				<xsl:call-template name="mdrpdown">
					...
					<xsl:with-param name="selectdisp">CorporateBO.StrUserField1</xsl:with-param>
					<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField1</xsl:with-param>
					<xsl:with-param name="choice_name">CorporateBO.StrUserField1</xsl:with-param>
					<xsl:with-param name="search_type">value</xsl:with-param>
					<xsl:with-param name="onchangefn">ISICValidation('ISICP2','.StrUserField1','.StrUserField13','ISICP1')</xsl:with-param> 
					<xsl:with-param name="presdata" select="$PresData"/>
				</xsl:call-template>
		</xsl:template>
	  	...
	  	<xsl:template name="CorporateBO.StrUserField13">
				<xsl:call-template name="mdrpdown">
					...
					<xsl:with-param name="search_type">value</xsl:with-param>
					<xsl:with-param name="onchangefn">ISICValidation('ISIC_DEMAND1','.StrUserField13','.StrUserField15','ISICP2')</xsl:with-param> 
					<xsl:with-param name="presdata" select="$PresData"/>
				</xsl:call-template>
		</xsl:template>
	  	...
	  	<xsl:template name="CorporateBO.StrUserField15">
				<xsl:call-template name="mdrpdown">
					...
					<xsl:with-param name="search_type">value</xsl:with-param>
					<xsl:with-param name="onchangefn">ISICValidation('ISIC_DEMAND2','.StrUserField15','.StrUserField16','ISIC_DEMAND1')</xsl:with-param> 
					<xsl:with-param name="presdata" select="$PresData"/>
				</xsl:call-template>
		</xsl:template>
...
<!--ISIC customization ends -->

<!--Climate categorization and ecosystem changes starts-->
  ...
  <xsl:template name="CorporateBO.StrUserField26">
				<xsl:call-template name="mdrpdown">
					...
					<xsl:with-param name="selectdisp">CorporateBO.StrUserField26</xsl:with-param>
					<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField26</xsl:with-param>
					<xsl:with-param name="choice_name">CorporateBO.StrUserField26</xsl:with-param>
					<xsl:with-param name="search_type">value</xsl:with-param>
					<xsl:with-param name="presdata" select="$PresData"/>
				</xsl:call-template>
		</xsl:template>
  ...
  <xsl:template name="CorporateBO.StrUserField25">
				<xsl:call-template name="mdrpdown">
					...
					<xsl:with-param name="selectdisp">CorporateBO.StrUserField25</xsl:with-param>
					<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField25</xsl:with-param>
					<xsl:with-param name="choice_name">CorporateBO.StrUserField25</xsl:with-param>
					<xsl:with-param name="search_type">value</xsl:with-param>
					<xsl:with-param name="presdata" select="$PresData"/>
				</xsl:call-template>
		</xsl:template>
...
<!--Climate categorization and ecosystem changes ends-->



<!--Isic Secondary Economic Activity changes starts-->
...
<!--validation ends-->
			...
			<xsl:template name="CorporateBO.StrUserField22">
		    		...
		    		<xsl:with-param name="selectdisp">CorporateBO.StrUserField22</xsl:with-param>
				<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField22</xsl:with-param>
				<xsl:with-param name="choice_name">CorporateBO.StrUserField22</xsl:with-param>
				<xsl:with-param name="onchangefn">ISICValidation('SUB_SECTOR_CODE','.StrUserField22','.StrUserField23','SECTOR_CODE')</xsl:with-param>
				<xsl:with-param name="search_type">value</xsl:with-param>
				<xsl:with-param name="presdata" select="$PresData"/>
		    		</xsl:call-template>
		    </xsl:template> 
			...
			<xsl:template name="CorporateBO.StrUserField23">
				<xsl:call-template name="mdrpdown">
					...
					<xsl:with-param name="selectdisp">CorporateBO.StrUserField23</xsl:with-param>
					<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField23</xsl:with-param>
					<xsl:with-param name="choice_name">CorporateBO.StrUserField23</xsl:with-param>
					<!-- Changes for corp ISIC Subsector by james Starts  -->
					<xsl:with-param name="onchangefn">ISICValidation('ISICP1','.StrUserField23','.StrUserField2','SUB_SECTOR_CODE')</xsl:with-param>
					<!-- Changes for corp ISIC Subsector by james ENDS  -->
					<xsl:with-param name="search_type">value</xsl:with-param>
					<xsl:with-param name="presdata" select="$PresData"/>
				</xsl:call-template>
				...
				<xsl:call-template name="mdrpdown">
					...
					<xsl:with-param name="selectdisp">CorporateBO.StrUserField2</xsl:with-param>
					<xsl:with-param name="selectname"><xsl:value-of select="$boName"/>.StrUserField2</xsl:with-param>
					<xsl:with-param name="choice_name">CorporateBO.StrUserField2</xsl:with-param>
					<xsl:with-param name="search_type">value</xsl:with-param>
					<xsl:with-param name="onchangefn">ISICValidation('ISICP2','.StrUserField2','.StrUserField11','ISICP1')</xsl:with-param> 
					<xsl:with-param name="presdata" select="$PresData"/>
				</xsl:call-template>
			</xsl:template>
	  	...
	  	<xsl:template name="CorporateBO.StrUserField11">
				<xsl:call-template name="mdrpdown">
					...
					<xsl:with-param name="search_type">value</xsl:with-param>
					<xsl:with-param name="onchangefn">ISICValidation('ISIC_DEMAND1','.StrUserField11','.StrUserField20','ISICP2')</xsl:with-param> 
					<xsl:with-param name="presdata" select="$PresData"/>
				</xsl:call-template>
		</xsl:template>
	  		...
	  		<xsl:template name="CorporateBO.StrUserField20">
				<xsl:call-template name="mdrpdown">
					...
					<xsl:with-param name="search_type">value</xsl:with-param>
					<xsl:with-param name="onchangefn">ISICValidation('ISIC_DEMAND2','.StrUserField20','.StrUserField21','ISIC_DEMAND1')</xsl:with-param>
					<xsl:with-param name="presdata" select="$PresData"/>
				</xsl:call-template>
			</xsl:template>
...
<!--Isic Secondary Economic Activity changes ends-->
...
<!--Isic Secondary Economic activity section starts-->
...
<!--Isic Secondary Economic activity section ends-->
