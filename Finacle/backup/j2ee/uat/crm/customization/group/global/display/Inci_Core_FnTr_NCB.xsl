...
<!-- importing xml files InciFnTrNCB.xml -->
     <xsl:variable name="configFile" select="document(concat('../Renderer/customization/resource/Inci_Core_FnTr_NCB.xml', ''))"/>	
...
<!--template for Status  -->
	...
	<xsl:with-param name="search_type">RequestBO.userStrField5</xsl:with-param>
	<xsl:with-param name="selectdisp">RequestBO.userStrField5</xsl:with-param>
	<xsl:with-param name="selectname">RequestBO.userStrField5</xsl:with-param>
	</xsl:call-template>
	</xsl:template>
...
<xsl:call-template name="BeginTabPage">
	<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
	<xsl:with-param name="tabPageName">tpageFundTrNCBDetails</xsl:with-param>
...
<xsl:call-template name="EndTabView">
	<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
	<xsl:with-param name="selectedTabPageName">tpageFundTrNCBDetails</xsl:with-param>
</xsl:call-template>
