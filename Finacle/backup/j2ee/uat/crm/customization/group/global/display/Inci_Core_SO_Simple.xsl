...
<!-- importing xml files InciSOSimple.xml -->
     <xsl:variable name="configFile" select="document(concat('../Renderer/customization/resource/Inci_Core_SO_Simple.xml', ''))"/>	
...
<!--template for Currency -->
	<xsl:template name="RequestBO.userStrField2">
		...
		<xsl:with-param name="search_type">RequestBO.userStrField2</xsl:with-param>
...
<!--template for Amount Indicator-->
	<xsl:template name="RequestBO.userStrField8">
	<xsl:call-template name="mdrpdown">
	<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userStrField8']"/>
	<xsl:with-param name="search_type">RequestBO.userStrField8</xsl:with-param>
	<xsl:with-param name="selectdisp">RequestBO.userStrField8</xsl:with-param>
	<xsl:with-param name="selectname">RequestBO.userStrField8</xsl:with-param>
	</xsl:call-template>
	</xsl:template>

<!--template for Part Tran Type-->
	<xsl:template name="RequestBO.userStrField9">
	<xsl:call-template name="mdrpdown">
	<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userStrField9']"/>
	<xsl:with-param name="search_type">RequestBO.userStrField9</xsl:with-param>
	<xsl:with-param name="selectdisp">RequestBO.userStrField9</xsl:with-param>
	<xsl:with-param name="selectname">RequestBO.userStrField9</xsl:with-param>
	</xsl:call-template>
	</xsl:template>

<!--template for Frequency  Type -->
	<xsl:template name="RequestBO.userStrField6">
	<xsl:call-template name="mdrpdown">
	<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userStrField6']"/>
	<xsl:with-param name="search_type">RequestBO.userStrField6</xsl:with-param>
	<xsl:with-param name="selectdisp">RequestBO.userStrField6</xsl:with-param>
	<xsl:with-param name="selectname">RequestBO.userStrField6</xsl:with-param>
	</xsl:call-template>
	</xsl:template>

<!--template for Frequency - Week Type -->
	<xsl:template name="RequestBO.userStrField11">
	<xsl:call-template name="mdrpdown">
	<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userStrField11']"/>
	<xsl:with-param name="search_type">RequestBO.userStrField11</xsl:with-param>
...
<!--template for Frequency - Start Date of Mth -->
	<xsl:template name="RequestBO.userStrField13">
	<xsl:call-template name="mdrpdown">
	<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userStrField13']"/>
	<xsl:with-param name="search_type">RequestBO.userStrField13</xsl:with-param>
	<xsl:with-param name="selectdisp">RequestBO.userStrField13</xsl:with-param>
	<xsl:with-param name="selectname">RequestBO.userStrField13</xsl:with-param>
	</xsl:call-template>
	</xsl:template>

<!--template for Frequency - Week Holidat Status -->
	<xsl:template name="RequestBO.userStrField14">
	<xsl:call-template name="mdrpdown">
	<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userStrField14']"/>
	<xsl:with-param name="search_type">RequestBO.userStrField14</xsl:with-param>
	<xsl:with-param name="selectdisp">RequestBO.userStrField14</xsl:with-param>
	<xsl:with-param name="selectname">RequestBO.userStrField14</xsl:with-param>
	</xsl:call-template>
	</xsl:template>

<!--template for Transfer/DD -->
	<xsl:template name="RequestBO.userStrField15">
	<xsl:call-template name="mdrpdown">
	<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userStrField15']"/>
	<xsl:with-param name="search_type">RequestBO.userStrField15</xsl:with-param>
	<xsl:with-param name="selectdisp">RequestBO.userStrField15</xsl:with-param>
	<xsl:with-param name="selectname">RequestBO.userStrField15</xsl:with-param>
	</xsl:call-template>
	</xsl:template>	
...
<!--template for Special Instructions -->
...
<!--template for Miscellaneous -->
	<xsl:template name="RequestBO.userTextField3">
		<xsl:call-template name="mtextarea">
		<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userTextField3']"/>
		<xsl:with-param name="mname">RequestBO.userTextField3</xsl:with-param>
		<xsl:with-param name="mvalue">RequestBO.userTextField3</xsl:with-param>
		<xsl:with-param name="mwrap">on</xsl:with-param>
		<xsl:with-param name="mrows">4</xsl:with-param>
		<xsl:with-param name="mcols">70</xsl:with-param>
		<xsl:with-param name="mcolspan">5</xsl:with-param>
...
<!--template for Miscellaneous -->
	<xsl:template name="RequestBO.userTextField4">
		<xsl:call-template name="mtextarea">
		<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userTextField4']"/>
		<xsl:with-param name="mname">RequestBO.userTextField4</xsl:with-param>
		<xsl:with-param name="mvalue">RequestBO.userTextField4</xsl:with-param>
		<xsl:with-param name="mwrap">on</xsl:with-param>
		<xsl:with-param name="mrows">4</xsl:with-param>
		<xsl:with-param name="mcols">70</xsl:with-param>
		<xsl:with-param name="mcolspan">5</xsl:with-param>
...
<!--template for Miscellaneous -->
	<xsl:template name="RequestBO.userTextField5">
		<xsl:call-template name="mtextarea">
		<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userTextField5']"/>
		<xsl:with-param name="mname">RequestBO.userTextField5</xsl:with-param>
		<xsl:with-param name="mvalue">RequestBO.userTextField5</xsl:with-param>
		<xsl:with-param name="mwrap">on</xsl:with-param>
		<xsl:with-param name="mrows">4</xsl:with-param>
		<xsl:with-param name="mcols">70</xsl:with-param>
		<xsl:with-param name="mcolspan">5</xsl:with-param>
...
<xsl:call-template name="BeginTabPage">
	<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
	<xsl:with-param name="tabPageName">tpageSO</xsl:with-param>
	<xsl:with-param name="tabPageDisplayNameRes" select="'Standing Order Details'"/>
	<xsl:with-param name="isTabNameHardCoded" select="'Yes'"/>
	<xsl:with-param name="isInnerToInnerTab" select="'N'"/>
</xsl:call-template>

<xsl:call-template name="Begin"/>
	<xsl:call-template name="RequestBO.userStrField15"/>
...
<xsl:call-template name="Begin"/>
	...
	<xsl:call-template name="RequestBO.userStrField12"/>
<xsl:call-template name="End"/>

<xsl:call-template name="Begin"/>
	<xsl:call-template name="RequestBO.userStrField13"/>
	<xsl:call-template name="RequestBO.userStrField14"/>
<xsl:call-template name="End"/>
...
<xsl:call-template name="EndTabView">
	<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
	<xsl:with-param name="selectedTabPageName">tpageSO</xsl:with-param>
</xsl:call-template>
