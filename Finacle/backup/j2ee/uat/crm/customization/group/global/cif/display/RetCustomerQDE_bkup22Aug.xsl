...
<xsl:variable name="LastUpdate_Date" select="//SRMData[@SRMDataSpace='CustomData']/Z[@n='LastUpdate_Date']"></xsl:variable>
    <xsl:variable name="file1">../Renderer/cif/resource/RetCustomerQDE_<xsl:value-of select="$locale"/>.xml</xsl:variable>
...
<!-- Last Edited Page changes starts -->
 ...
 <!-- Last Edited Page changes ends -->
	...
	<!-- CRM101UB change end -->
	    ...
	    <!-- changes rajan -->
	     <script type="text/javascript" language="javascript" src="../cif/js/CustomerAddress_Form.js"></script>
		<!--CIF Changes Start -->
	     <script type="text/javascript" language="javascript" src="../cif/js/HouseHold.js"></script>
		<!--CIF Changes  End -->
		<script type="text/javascript" language="javascript" src="../cif/js/Minor.js"></script>		
...
<!--Ends of changes for GCIF LookUp-->
	...
	<xsl:choose>
		...
		<!--Changes for ticket id:690997 starts-->
			<xsl:with-param name="fn_onBlur">checkStatus('AccountBO.AccountKey',keyGeneration);txtLimit_CIF_QDE(this,"AccountBO.AccountKey","CIF ID");</xsl:with-param>
