...
<!-- importing xml files InciCreditReq.xml -->
     <xsl:variable name="configFile" select="document(concat('../Renderer/customization/resource/Inci_Core_Crdt_Rep.xml', ''))"/>	
...
<xsl:call-template name="BeginTabPage">
	<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
	<xsl:with-param name="tabPageName">tpageCrdtRepDetails</xsl:with-param>
	<xsl:with-param name="tabPageDisplayNameRes" select="'Credit Report Details'"/>
...
<xsl:call-template name="EndTabView">
	<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
	<xsl:with-param name="selectedTabPageName">tpageCrdtRepDetails</xsl:with-param>
</xsl:call-template>
