...
<!-- importing xml files InciDDReq.xml -->
     <xsl:variable name="configFile" select="document(concat('../Renderer/customization/resource/Inci_Core_FnTr_NonNCB.xml', ''))"/>	
...
<!--template for TPIN Validated -->
	...
	<xsl:with-param name="search_type">RequestBO.userStrField1</xsl:with-param>
...
<!--template for  Name -->
	...
	<xsl:with-param name="ele_name">RequestBO.userStrField7</xsl:with-param>
	<xsl:with-param name="ele_val">RequestBO.userStrField7</xsl:with-param>
	</xsl:call-template>
	</xsl:template>
...
<!--template for  Address -->
	...
	<xsl:with-param name="ele_name">RequestBO.userTextField4</xsl:with-param>
	<xsl:with-param name="ele_val">RequestBO.userTextField4</xsl:with-param>
	</xsl:call-template>
	</xsl:template>
...
<!--template for Misc -->
	...
	<xsl:with-param name="ele_name">RequestBO.userTextField5</xsl:with-param>
	<xsl:with-param name="ele_val">RequestBO.userTextField5</xsl:with-param>
	</xsl:call-template>
	</xsl:template>
...
<!--template for Misc -->
	...
	<xsl:with-param name="ele_name">RequestBO.userTextField3</xsl:with-param>
	<xsl:with-param name="ele_val">RequestBO.userTextField3</xsl:with-param>
	</xsl:call-template>
	</xsl:template>
...
<xsl:call-template name="apply1">
     <xsl:with-param name="apply_head">Dispatch Details</xsl:with-param>
</xsl:call-template>
...
<xsl:call-template name="Begin"/>
	<xsl:call-template name="RequestBO.userTextField3"/>
	<xsl:call-template name="addemptycell"/>
<xsl:call-template name="End"/>
...
<xsl:call-template name="BeginTabPage">
	<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
	<xsl:with-param name="tabPageName">tpageFundTrNonNCBDetails</xsl:with-param>
	<xsl:with-param name="tabPageDisplayNameRes" select="'Transfer Details'"/>
	<xsl:with-param name="isTabNameHardCoded" select="'Yes'"/>
	<xsl:with-param name="isInnerToInnerTab" select="'N'"/>
</xsl:call-template>

<xsl:call-template name="apply1">
     <xsl:with-param name="apply_head">Transfer Details</xsl:with-param>
</xsl:call-template>
...
<xsl:call-template name="BeginTabPage">
	<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
	<xsl:with-param name="tabPageName">tpageBeneficiaryDetails</xsl:with-param>
...
<xsl:call-template name="apply1">
     <xsl:with-param name="apply_head">Beneficiary Details</xsl:with-param>
</xsl:call-template>
...
<xsl:call-template name="Begin"/>
	<xsl:call-template name="RequestBO.userTextField4"/>
	<xsl:call-template name="addemptycell"/>
<xsl:call-template name="End"/>

<xsl:call-template name="Begin"/>
	<xsl:call-template name="RequestBO.userTextField5"/>
	<xsl:call-template name="addemptycell"/>
<xsl:call-template name="End"/>
...
<xsl:call-template name="EndTabView">
	<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
	<xsl:with-param name="selectedTabPageName">tpageFundTrNonNCBDetails</xsl:with-param>
</xsl:call-template>
