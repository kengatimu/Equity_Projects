...
<xsl:variable name="file_ML">../Renderer/Customization/cif/resource/EquityCorpCIF_<xsl:value-of select="$locale"/>.xml</xsl:variable>
   	...
   	var strUserid3=document.getElementsByName("AccountBO.StrUserField2")[0].value;
	   	...
	   	alert("User's Login ID is mandatory. Please provide");
			...
			if (window.XMLHttpRequest)
				...
				var strURL1 = '../servlet/com.infy.cis.custom.EquityCorpCIF_Result?strUserid2='+strUserid2+'&amp;strUserid3='+strUserid3;
...
<xsl:template match="*" mode="mode1">
	<xsl:call-template name="Begin"/>
		...
		<!--	</td>  -->
			...
			<b>Corporate CIF Custom Menu</b><br/>
			</xsl:with-param>
				</xsl:call-template>
				</tr>
				</table>
