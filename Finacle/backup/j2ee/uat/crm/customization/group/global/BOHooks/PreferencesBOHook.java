...
import com.infy.cis.srmbo.PreferencesBO;
...
public class PreferencesBOHook implements IHooks {

    public PreferencesBOHook() { }
   ...
   try
   {
	...
	final PreferencesBO aBoNew = (PreferencesBO) aBoObj;

	final Integer corpId = aBoNew.getCorp_ID();
	// PreferencesBO --> For Corporate Only
