...
<!-- importing xml files InciDDReq.xml -->
     <xsl:variable name="configFile" select="document(concat('../Renderer/customization/resource/Inci_Insu_Fin_Stmt.xml', ''))"/>	
...
<!--template for Docs received at Branch Details -->
