...
<!-- importing xml files InciDDReq.xml -->
     <xsl:variable name="configFile" select="document(concat('../Renderer/customization/resource/Inci_Wpen_Stdg_Ordr.xml', ''))"/>	
...
<!--template for Suspense Account Id -->	         
...
<!--template for Zip -->
	...
	<xsl:with-param name="ele_name">RequestBO.userStrField13</xsl:with-param>
	<xsl:with-param name="ele_val">RequestBO.userStrField13</xsl:with-param>
	</xsl:call-template>
	</xsl:template>
...
<!--template for Zip -->
	...
	<xsl:with-param name="ele_name">RequestBO.userStrField14</xsl:with-param>
	<xsl:with-param name="ele_val">RequestBO.userStrField14</xsl:with-param>
	</xsl:call-template>
	</xsl:template>
...
<xsl:call-template name="BeginTabPage">
			<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
			<xsl:with-param name="tabPageName">tpageWITCODetails</xsl:with-param>
			<xsl:with-param name="tabPageDisplayNameRes" select="'WITCO Details'"/>
			<xsl:with-param name="isTabNameHardCoded" select="'Yes'"/>
