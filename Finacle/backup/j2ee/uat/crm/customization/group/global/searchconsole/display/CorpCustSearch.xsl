<?xml version='1.0'?>
  ...
  <!--CRM70t-ST: Tracker:79742 STARTOFCHANGES-->
  <xsl:variable name="InputParam" select="$userArea//Z[@n='InputParam']"/>
  <!--CRM70t-ST: Tracker:79742 ENDOFCHANGES-->
 ...
 <!--Begin of changes for tracker 131243  by sumeet gandhok - BANKID - -->
  ...
  <!--changes for call id 333206 start-->
  ...
  <!--changes for call id 333206 ends-->
 <!--End of changes for tracker 131243  by sumeet gandhok - BANKID - -->
  ...
  <head>
	...
	/* Changes for Audit Enquiry CRMBAR02 Ends*/
		...
		<script type="text/javascript" src="../Customization/searchconsole/js/CorpEntitySearchRCLOptions_{$locale}{$islamicResourceFileSuffix}.js"></script>
		<!-- Alternate BANKING CHANGES Starts-->
        ...
        <![CDATA[   
                    ...
                    function sortMe(sortColumn,sortOrder) {
                         ...
                         var iParam=]]>"<xsl:value-of select="$InputParam"/>"<![CDATA[;
                         ...
                         savePersistData();
                             ...
                             var options=]]>"<xsl:value-of select="$query"/>"<![CDATA[;
                                  eval("window.location.href='../servlet/com.infy.cis.ui.common.AdvancedContactSearchResults?SortColumn=" +sortColumn+ "&amp;SortOrder=" +sortOrder+ "&amp;Query=" +escape(options)+ "&amp;BOName=CorporateBO&amp;ViewName="+vName+"&amp;SearchFrom=" +searchFrom+"'");                            
                         } else {  
				...
				if(doc.form_filters!=undefined){
					...
					doc.form_filters.submit();
                             		...
                             		eval("window.location.href='../servlet/com.infy.cis.ui.common.GenericResults?SortColumn=" +sortColumn+ "&amp;SortOrder=" +sortOrder+  "&amp;ViewName="+vName+"&amp;" +iParam+"'"); 
                             	}
		...
		<xsl:call-template name="mainbody">
			...
			<xsl:with-param name="imgFieldNameFunc_one">populateCorpcifEntityDetails(corpID,viewnameScreenID)</xsl:with-param>
