...
<!-- importing xml files InciDDReq.xml -->
     <xsl:variable name="configFile" select="document(concat('../Renderer/customization/resource/Inci_Crdt_Disp_Tran.xml', ''))"/>	
...
<!--template for Investigation details -->
...
<!--template for Reference No -->
	<xsl:template name="RequestBO.userStrField12">
	<xsl:call-template name="label">
	<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userStrField12']"/>
	<xsl:with-param name="ele_name">RequestBO.userStrField12</xsl:with-param>
	<xsl:with-param name="ele_val">RequestBO.userStrField12</xsl:with-param>
	</xsl:call-template>
	</xsl:template>
...
<!--template for Statement Date -->
	<xsl:template name="RequestBO.userDateField3">
	<xsl:call-template name="label">
	<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userDateField3']"/>
	<xsl:with-param name="ele_name">RequestBO.userDateField3</xsl:with-param>
	<xsl:with-param name="ele_val">RequestBO.userDateField3</xsl:with-param>
	</xsl:call-template>
	</xsl:template>

<!--template for Amount of Transaction -->
...
<!--template for Reason for Disput (Free text) -->
...
<!--template for Transaction Description (Free text) -->
...
<xsl:call-template name="BeginTabView">
		<xsl:with-param name="tabViewName">tabSRDispTran</xsl:with-param>
...
<xsl:call-template name="BeginTabPage">
		<xsl:with-param name="tabViewName">tabSRDispTran</xsl:with-param>
		<xsl:with-param name="tabPageName">tpageTransactionDetails</xsl:with-param>
		<xsl:with-param name="tabPageDisplayNameRes" select="'Transaction Details'"/>
		<xsl:with-param name="isTabNameHardCoded" select="'Yes'"/>
		<xsl:with-param name="isInnerToInnerTab" select="'N'"/>
	</xsl:call-template>
...
<xsl:call-template name="Begin"/>
	...
	<xsl:call-template name="RequestBO.userDateField3"/>
<xsl:call-template name="End"/>
