...
<xsl:variable name="resFile_ML">../Renderer/cif/resource/RetSQDEdet</xsl:variable>
...
<script>
		...
		<script type="text/javascript" src="../cif/js/RetSQDEdet_System.js" language="javascript"></script>
		<script type="text/javascript" src="../cif/js/RetSQDEdet.js" language="javascript"></script>
...
<xsl:otherwise>
<xsl:attribute name="onload"> loadprimarysolid();populateDocTypeOnLoad();fnLoad();loadrate();</xsl:attribute>
</xsl:otherwise>
</xsl:choose>
<!-- changes done for ticket id 435934 ends -->
