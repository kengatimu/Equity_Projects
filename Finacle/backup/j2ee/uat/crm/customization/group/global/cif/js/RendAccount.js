...
//changes for recon tracker 403626
			...
			if(tempbankid == 56){
			if(parent.parent.IFrmtab0.formDispFrame.document.frm2!= "undefined"){
			var  noOfPhone = parent.parent.IFrmtab0.formDispFrame.document.all.PhoneEmailRecordSet.rows.length;
			/*DEF- 533 End of changes*/			if(noOfPhone==2){
...
//changes for recon tracker 403626
	...
	for(var x = 0; x < noOfEdu ; x++) {
	 ...
	 if((ad_address_type[x]) == "NRERelative") {
		...
		if(blFlag==true)
		{
			/**Commented as per 10.2.13 functionality*/
	    /* if(mailingad == false){
...
/* ***** Tracker# 97236 CIF - EBanking Changes : End ***** */
		...
		//Commenting as per 10.2.13 Customization
		/* if(blFlag==true)
		{
		if (currentCount == 0)
		{
