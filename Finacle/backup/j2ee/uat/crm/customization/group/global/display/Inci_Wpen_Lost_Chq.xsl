...
<!-- importing xml files InciDDReq.xml -->
     <xsl:variable name="configFile" select="document(concat('../Renderer/customization/resource/Inci_Wpen_Lost_Chq.xml', ''))"/>	
...
<!--template for Docs sent to WITCO Details-->
...
<!--template for Docs Received at WITCO Details  -->
...
<xsl:call-template name="BeginTabView">
	<xsl:with-param name="tabViewName">tabSRLostChq</xsl:with-param>
...
<xsl:call-template name="BeginTabPage">
	<xsl:with-param name="tabViewName">tabSRLostChq</xsl:with-param>
	<xsl:with-param name="tabPageName">tpageChequeDetails</xsl:with-param>
	<xsl:with-param name="tabPageDisplayNameRes" select="'Cheque Details'"/>
	<xsl:with-param name="isTabNameHardCoded" select="'Yes'"/>
	<xsl:with-param name="isInnerToInnerTab" select="'N'"/>
</xsl:call-template>
