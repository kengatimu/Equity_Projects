...
import com.infy.cis.srmbo.FinancialBO;
...
public class FinancialBOHook implements IHooks {

    public FinancialBOHook() { }
    ...
    try
    {
 	...
 	final FinancialBO aBoNew = (FinancialBO) aBoObj;
 	...
 	// Only CorporateBO  is using FinancialBO
