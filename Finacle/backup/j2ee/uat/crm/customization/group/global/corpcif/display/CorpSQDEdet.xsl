...
<xsl:variable name="resFile_ML">../Renderer/Customization/corpcif/resource/CorpSQDEdet</xsl:variable>
...
<head>
				       ...
				       <script type="text/javascript" language="javascript" src="../corpcif/js/CorpSQDEdet.js"></script>
...
<xsl:otherwise>
<xsl:attribute name="onload">loadseg();loadprimesolid();populateDocTypeOnLoad();onAddrSelect();disableCorpRep();fnload();loadID();loadrel();</xsl:attribute>
</xsl:otherwise>
</xsl:choose> 
