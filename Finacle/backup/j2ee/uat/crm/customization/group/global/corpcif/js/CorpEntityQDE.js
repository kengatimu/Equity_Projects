...
function addAddressdetails()
{
	...
	updateAdrDet = false;
//Changes for call id 376456 recon of 370046 start
	updateEduDet =false;
//Changes for call id 376456 recon of 370046 end
...
function KRAchecker() {
	var placeofissue=document.getElementsByName('CorporateBO.principle_PlaceOperation')[0].value;
	var letterNumber = /^[A-Z]{1}*[0-9]{9}[A-Z]{1}*$/;
	var krst='true';
   var krapinNumber = document.getElementsByName('CorporateBO.StrUserField8')[0].value;
	if(placeofissue.toUpperCase()=='KE')
	{
	if (krapinNumber.match(letterNumber) && krapinNumber.length == 11) {
		//alert('Valid KRA!');
		krst='true';}
	else{
		alert(" ENTER KRA PIN INVALID");
		document.getElementsByName('CorporateBO.StrUserField8')[0].value =='';
		krst='false';
		}
	}
	return krst;
	...
	{	
		...
		ad_end_date[findex] = address_enddateHij(altCalendarHij,startdate[k+1]);
  		//tracker 113259:Hijri:to validate for hijri dates:change end
  		 ...
  		 /*Admin Locale Date Format 332673 issue correction Start : done by krity_kamboj */ 
		                   //ad_end_date[findex] = "31/12/2099"; 
		                   //change for callid 346606 and 348767 start
		                   //ad_end_date[findex] = getJNDIFormat ("31/12/2099"); 
		                   ad_end_date[findex] = getEndDate1();
		                   //change for callid 346606 and 348767 end
		                   /*Admin Locale Date 332673 Format issue correction End*/ 
  		}
  		}
  		}
  		catch(e)
		...
		ad_end_date[findex] = address_enddateHij(altCalendarHij,startdate2[k+1]);
  		//tracker 113259:Hijri:to validate for hijri dates:change end
  		 ...
  		 /*Admin Locale Date Format 332673 issue correction Start : done by krity_kamboj */ 
		                   ...
		                   ad_end_date[findex]= getEndDate1();
		                   //change for callid 346606 and 348767 end
		                   /*Admin Locale Date Format 332673 issue correction End*/ 
  		}
  		}
  		}
  		catch(e)
...
/*ticker id 206142 changes ends*/
 document.getElementsByName("hid_CorporateRepBO.first_Name_alt1")[0].value = getCookie('LookupFirstName_alt1');
	...
	//Changes For Call ID 381878 and recon of call id 369988  Starts
 document.getElementsByName("hid_CorporateRepBO.first_Name")[0].value = getCookie('LookupProspectFirstName');
	//Changes For Call ID 381878 and recon of call id 369988  Starts
//Tracker 129381 changes End
document.getElementsByName("CorporateRepBO.last_Name")[0].fireEvent("onChange");
lookupload();
...
document.getElementsByName("hid_CorporateRepBO.first_Name_alt1")[0].value = getCookie('LookupFirstName_alt1');
	...
	//Changes For Call ID 381878 and recon of call id 369988  Starts
 document.getElementsByName("hid_CorporateRepBO.first_Name")[0].value = getCookie('LookupContactFirstName');
	//Changes For Call ID 381878 and recon of call id 369988  ends
//Tracker 129381 changes End
document.getElementsByName("CorporateRepBO.last_Name")[0].fireEvent("onChange");
lookupload();
}
...
if(lookupFor == 'ForCorpProspect'){
	//Changes For Call ID 381878 and recon of call id 369997  Starts
document.getElementsByName("CorporateBO.CorpMiscellaneousInfo.str2")[0].value = getCookie("LookupProspectCorpKey");
	//Changes For Call ID 381878 and recon of call id 369997  ends
...
//Tracker 129381 changes Start
	//Changes For Call ID 381878 and recon of call id 370005  Starts
document.getElementsByName("hid_CorporateBO.CorpMiscellaneousInfo.str4")[0].value = getCookie("LookupContactFirstName");
	//Changes For Call ID 381878 and recon of call id 370005  ends
if(altLangActv=='true'){	
document.getElementsByName("hid_CorporateBO.CorpMiscellaneousInfo.str4_alt1")[0].value = getCookie("LookupFirstName_alt1");
/*ticker id 209661 tracker id 125246 changes starts*/
document.getElementsByName("CorporateBO.CorpMiscellaneousInfo.str5_alt1")[0].value = getCookie('LookupLastName_alt1');
...
//Tracker 129381 changes Start
	//Changes For Call ID 381878 and recon of call id 370005  Starts
document.getElementsByName("hid_CorporateBO.CorpMiscellaneousInfo.str4")[0].value = getCookie("LookupProspectFirstName");
	//Changes For Call ID 381878 and recon of call id 370005  Ends
if(altLangActv=='true'){	
document.getElementsByName("hid_CorporateBO.CorpMiscellaneousInfo.str4_alt1")[0].value = getCookie("LookupFirstName_alt1");
/*ticker id 206142 changes starts*/
 ...
 function loadrel()
{
	...
	//document.getElementsByName("CorporateBO.DefaultAddressType")[0].value = DefAdress;	// Changes for Call id:346337
//changes for ticket 684997 begins
	if(document.getElementsByName(boName+".Subsector_Code")[0]!=undefined){
	...
	if(document.getElementsByName(boName+".sector")[0]!=undefined){
	document.getElementsByName(boName+".sector")[0].value = SecCode;
	}
//changes for ticket 684997 ends
...
function setFocusOnComp(compName) {
  ...
  var elementName = eval(object + "document.getElementsByName(compName)[0]");
	if(elementName) {
		...
		//Changes for call id 660800 begin
		try{
			var ids="";
			if(compName=="CorporateModBO.Address.preferredAddress") {
			ids = elementName.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.id;
			}
			else {
			ids = elementName.parentElement.parentElement.parentElement.parentElement.parentElement.id;
			}
			ids = trim(ids.replace("det_",""));
		    if(ids == 'tpagePhone' || ids == 'tpageAddr')
			{
				showTabFortabEntityFieldDetails('tpageCont3');
				eval(object + "showTabFortabContactDetails('" + ids +"')");
			}
			else {
		...
		//Changes for call id 660800 end
...
function disableCorpRep(){
	...
	if(entityType == ""){
		...
		//Changes For Call ID 381878 and recon of call id 381163  Starts
		document.getElementsByName("CorporateRepBO.designation")[0].value = "";
		//Changes For Call ID 381878 and recon of call id 381163 Ends
    ...
    {  // New Entry 
 	...
 	if(boNamePrefe=='PreferencesModBO'){
        ...
        populateConcessionListEntry(URL,
			 ...
			 preferentialExpiryDate,
			 currency);    
//changes for 441390 starts
        var tdNode = document.createElement("TD");
        oNewNode.appendChild(tdNode);                               
        tdNode.innerHTML =  "<font class='fntColData'>" + add_category_ML + "</font>";
        var tdNode2 = document.createElement("TD");
        oNewNode.appendChild(tdNode2);                              
        tdNode2.innerHTML = "<font class='fntColData'>" + creditDiscountPercentage + "</font>";
        var tdNode1 = document.createElement("TD");
        oNewNode.appendChild(tdNode1);                              
        tdNode1.innerHTML = "<font class='fntColData'>" + debitDiscountPercentage + "</font>";
        var tdNode3 = document.createElement("TD");
        oNewNode.appendChild(tdNode3);                              
        tdNode3.innerHTML = "<font class='fntColData'>" + withTaxPercentage + "</font>";
        
        
        var tdNode4 = document.createElement("TD");
	        oNewNode.appendChild(tdNode4);                              
        tdNode4.innerHTML = "<font class='fntColData'>" + withTaxFloorLimit + "</font>"; 
	...
	tdNode5.setAttribute("id","DATE1CorpCustQDECurrencyDetails"+idIndex);
	...
	/* Tracker-ID 113259:ERPBOCF1:Hijri:To refresh multirec on toggle of calendar type- END*/
        oNewNode.appendChild(tdNode5);                              
        tdNode5.innerHTML = "<font class='fntColData'>" + preferentialExpiryDate + "</font>"; 
                //changes for 441390 ends
        var tdNode6 = document.createElement("TD");
        oNewNode.appendChild(tdNode6);                              
    ...
    } else 
    {
        ...
        populateConcessionListEntry(URL,
			 ...
			 currency);   
//changes for 441390 starts
        currConcessionTableRow.childNodes(1).innerHTML="<font class='fntColData'>" + creditDiscountPercentage + "</font>";       
        currConcessionTableRow.childNodes(2).innerHTML="<font class='fntColData'>" + debitDiscountPercentage + "</font>";
        currConcessionTableRow.childNodes(3).innerHTML="<font class='fntColData'>" + withTaxPercentage + "</font>";
        currConcessionTableRow.childNodes(4).innerHTML="<font class='fntColData'>" + withTaxFloorLimit + "</font>";
        /* Tracker-ID 113259:ERPBOCF1:Hijri:To refresh multirec on toggle of calendar type- START*/
        if((preferentialExpiryDate!= '') && (preferentialExpiryDate != undefined))
	{
	//date converted acc to the present calendar type before displaing in the multirec 
	...
	/* Tracker-ID 113259:ERPBOCF1:Hijri:To refresh multirec on toggle of calendar type- END*/
        currConcessionTableRow.childNodes(5).innerHTML="<font class='fntColData'>" + preferentialExpiryDate + "</font>";
        //currConcessionTableRow.childNodes(5).innerHTML="<font class='fntColData'>" + currency + "</font>";
        currConcessionTableRow.childNodes(0).innerHTML="<font class='fntColData'>" + add_category_ML + "</font>";
//changes for 441390 ends
        ConcessionPref = false;
    }
}
