...
<!-- importing xml files InciDDReq.xml -->
     <xsl:variable name="configFile" select="document(concat('../Renderer/customization/resource/Inci_EdGa_Conf_Stmt.xml', ''))"/>	
...
<xsl:call-template name="BeginTabView">
	<xsl:with-param name="tabViewName">tabSRConfStmt</xsl:with-param>
...
<xsl:call-template name="BeginTabPage">
	<xsl:with-param name="tabViewName">tabSRConfStmt</xsl:with-param>
	<xsl:with-param name="tabPageName">tpageAccountDetails</xsl:with-param>
	<xsl:with-param name="tabPageDisplayNameRes" select="'Account Details'"/>
	<xsl:with-param name="isTabNameHardCoded" select="'Yes'"/>
	<xsl:with-param name="isInnerToInnerTab" select="'N'"/>
</xsl:call-template>
