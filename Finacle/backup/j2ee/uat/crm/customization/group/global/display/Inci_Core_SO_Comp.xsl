...
<!-- importing xml files InciSOComp.xml -->
     <xsl:variable name="configFile" select="document(concat('../Renderer/customization/resource/Inci_Core_SO_Comp.xml', ''))"/>	
...
<!--template for Frequency of Payment -->
...
<xsl:call-template name="BeginTabPage">
	<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
	<xsl:with-param name="tabPageName">tpageStandingOrderDetails</xsl:with-param>
...
<xsl:call-template name="EndTabView">
	<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
	<xsl:with-param name="selectedTabPageName">tpageStandingOrderDetails</xsl:with-param>
</xsl:call-template>
