...
<!-- importing xml files InciDDReq.xml -->
     <xsl:variable name="configFile" select="document(concat('../Renderer/customization/resource/Inci_Wlea_Intr_Det.xml', ''))"/>	
...
<!--template for Address of Delivery -->
...
<table width="100%" bgcolor='E5E5E5' cellspacing="0" vspace="0" hspace="0" border="0">
			...
			<xsl:call-template name="BeginTabView">
				...
				<xsl:with-param name="tabPageHeight">365</xsl:with-param>
