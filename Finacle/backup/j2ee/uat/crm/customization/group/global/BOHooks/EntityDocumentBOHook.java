 ...
 *
 * $Workfile	: EntityDocumentBOHook.java $
 *
 * $Author		: Greety $
 *
 * $Archive		: /FCRM62BASE/com/infy/cis/custom/BOHooks/EntityDocumentBOHook.java $
 *
 * $History		: EntityDocumentBOHook.java $
 *
 *****************************************************************************/
...
public class  EntityDocumentBOHook
implements IHooks  {
	...
	try
		...
		EntityDocumentBO boEntDoc = (EntityDocumentBO)bo;
