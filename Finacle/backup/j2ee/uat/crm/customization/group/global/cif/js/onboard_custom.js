...
try
{
parent.parent.frames(0).formFilterFrame.FindForm.document.getElementsByName('dedup check')[0].disabled= false;
...
parent.parent.frames(0).formFilterFrame.FindForm.CREATE7.disabled= false;	
...
parent.parent.frames(0).formFilterFrame.FindForm.CREATE7.disabled= true;	
}
catch(e){
alert(e.message);
}
