...
<!-- importing xml files InciDDReq.xml -->
     <xsl:variable name="configFile" select="document(concat('../Renderer/customization/resource/Inci_Insu_Name_Corr.xml', ''))"/>	
...
/*Populate A/c No Function**/
		...
		'<xsl:for-each select="//SRMData[@SRMDataSpace='Main']/SRMComposite[@n='RecordSet']/SRMRow">'
			...
			if (type1=="PAYER")
			{
				...
				document.getElementsByName('MiddleName')[iCount].value=middlename;
				document.getElementsByName('LastName')[iCount].value=lastname;
				document.getElementsByName('NameTitle')[iCount].value=nameTit;
...
<xsl:call-template name="BeginTabPage">
		<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
		<xsl:with-param name="tabPageName">tpageOwnCorrectionDetails</xsl:with-param>
...
<xsl:call-template name="BeginTabPage">
		<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
		<xsl:with-param name="tabPageName">tpageBenCorrectionDetails</xsl:with-param>
...
<xsl:call-template name="BeginTabPage">
		<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
		<xsl:with-param name="tabPageName">tpageInsuCorrectionDetails</xsl:with-param>
		<xsl:with-param name="tabPageDisplayNameRes" select="'Insured Details'"/>
		<xsl:with-param name="isTabNameHardCoded" select="'Yes'"/>
		<xsl:with-param name="isInnerToInnerTab" select="'N'"/>
</xsl:call-template>
...
<xsl:call-template name="BeginTabPage">
		<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
		<xsl:with-param name="tabPageName">tpagePayCorrectionDetails</xsl:with-param>
		<xsl:with-param name="tabPageDisplayNameRes" select="'Payer Details'"/>
		<xsl:with-param name="isTabNameHardCoded" select="'Yes'"/>
		<xsl:with-param name="isInnerToInnerTab" select="'N'"/>
</xsl:call-template>
