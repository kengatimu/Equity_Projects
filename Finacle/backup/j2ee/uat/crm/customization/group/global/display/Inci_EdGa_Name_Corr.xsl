...
<!-- importing xml files InciDDReq.xml -->
    <xsl:variable name="configFile" select="document(concat('../Renderer/customization/resource/Inci_EdGa_Name_Corr.xml', ''))"/>	
...
<!--template for Document Received -->
...
<!--template for Driving License Checked -->
...
<!--template for National ID Checked -->
	...
	<!--template for Existing First Name to be Deleted -->
	<xsl:template name="RequestBO.userStrField17">
		<xsl:call-template name="label">
		<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userStrField17']"/>
		<xsl:with-param name="ele_name">RequestBO.userStrField17</xsl:with-param>
		<xsl:with-param name="ele_val">RequestBO.userStrField17</xsl:with-param>
		</xsl:call-template>
	</xsl:template>

	<!--template for Existing Middle Name to be Deleted -->
	<xsl:template name="RequestBO.userStrField18">
		<xsl:call-template name="label">
		<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userStrField18']"/>
		<xsl:with-param name="ele_name">RequestBO.userStrField18</xsl:with-param>
		<xsl:with-param name="ele_val">RequestBO.userStrField18</xsl:with-param>
		</xsl:call-template>
	</xsl:template>

	<!--template for Existing Last Name to be Deleted -->
	<xsl:template name="RequestBO.userStrField19">
		<xsl:call-template name="label">
		<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userStrField19']"/>
		<xsl:with-param name="ele_name">RequestBO.userStrField19</xsl:with-param>
		<xsl:with-param name="ele_val">RequestBO.userStrField19</xsl:with-param>
		</xsl:call-template>
	</xsl:template>

	<!--template for New First Name -->
	<xsl:template name="RequestBO.userStrField20">
		<xsl:call-template name="label">
		<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userStrField20']"/>
		<xsl:with-param name="ele_name">RequestBO.userStrField20</xsl:with-param>
		<xsl:with-param name="ele_val">RequestBO.userStrField20</xsl:with-param>
		</xsl:call-template>
	</xsl:template>

	<!--template for New Middle Name -->
	<xsl:template name="RequestBO.userStrField21">
		<xsl:call-template name="label">
		<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userStrField21']"/>
		<xsl:with-param name="ele_name">RequestBO.userStrField21</xsl:with-param>
		<xsl:with-param name="ele_val">RequestBO.userStrField21</xsl:with-param>
		</xsl:call-template>
	</xsl:template>

	<!--template for New Last Name -->
	<xsl:template name="RequestBO.userStrField22">
		<xsl:call-template name="label">
		<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userStrField22']"/>
		<xsl:with-param name="ele_name">RequestBO.userStrField22</xsl:with-param>
		<xsl:with-param name="ele_val">RequestBO.userStrField22</xsl:with-param>
		</xsl:call-template>
	</xsl:template>
...
<xsl:call-template name="BeginTabView">
	...
	<xsl:with-param name="colSpan">20</xsl:with-param>
		...
		<xsl:call-template name="BeginTabPage">
			...
			<xsl:call-template name="BeginTabPage">
					<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
					<xsl:with-param name="tabPageName">tpageCorrectionDetails</xsl:with-param>
					<xsl:with-param name="tabPageDisplayNameRes" select="'Correction Details'"/>
					<xsl:with-param name="isTabNameHardCoded" select="'Yes'"/>
					<xsl:with-param name="isInnerToInnerTab" select="'N'"/>
			</xsl:call-template>
				...
				<xsl:call-template name="Begin"/>
					<xsl:call-template name="RequestBO.userStrField17"/>
					<xsl:call-template name="RequestBO.userStrField20"/>
				<xsl:call-template name="End"/>

				<xsl:call-template name="Begin"/>
					<xsl:call-template name="RequestBO.userStrField18"/>
					<xsl:call-template name="RequestBO.userStrField21"/>
				<xsl:call-template name="End"/>

				<xsl:call-template name="Begin"/>
					<xsl:call-template name="RequestBO.userStrField19"/>
					<xsl:call-template name="RequestBO.userStrField22"/>
				<xsl:call-template name="End"/>
