...
<!-- importing xml files InciDDReq.xml -->
     <xsl:variable name="configFile" select="document(concat('../Renderer/customization/resource/Inci_Insu_Sign_Corr.xml', ''))"/>	
...
<!--template for Docs receivedd at branch details -->
...
<!--template for Driver's License Received -->
...
<!--template for Electoral ID Received -->
...
<!--template for Passport Received -->
...
<!--template for New Signature updated -->
