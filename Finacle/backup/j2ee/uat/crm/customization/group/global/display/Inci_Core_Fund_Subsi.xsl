...
<!-- importing xml files InciDDReq.xml -->
     <xsl:variable name="configFile" select="document(concat('../Renderer/customization/resource/Inci_Core_Fund_Subsi.xml', ''))"/>	
...
<!--template for Relationship A/C -->
	<xsl:template name="RequestBO.userStrField32">
	<xsl:call-template name="label">
	<xsl:with-param name="res_name" select="$configLabels[@name='RequestBO.userStrField32']"/>
	<xsl:with-param name="ele_name">RequestBO.userStrField32</xsl:with-param>
	<xsl:with-param name="ele_val">RequestBO.userStrField32</xsl:with-param>
	</xsl:call-template>
	</xsl:template>

<!--template for Date of Transaction -->
...
<xsl:call-template name="BeginTabPage">
	<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
	<xsl:with-param name="tabPageName">tpageFundSubsiDetails</xsl:with-param>
	<xsl:with-param name="tabPageDisplayNameRes" select="'Fund Placement Details'"/>
...
<xsl:call-template name="apply1">
     <xsl:with-param name="apply_head">Fund Placement Details</xsl:with-param>
</xsl:call-template>
...
<xsl:call-template name="Begin"/>
	<xsl:call-template name="RequestBO.userStrField32"/>
...
<xsl:call-template name="apply1">
     <xsl:with-param name="apply_head">Address Details</xsl:with-param>
</xsl:call-template>
...
<xsl:call-template name="EndTabView">
	<xsl:with-param name="tabViewName">tabSRAddrChg</xsl:with-param>
	<xsl:with-param name="selectedTabPageName">tpageFundSubsiDetails</xsl:with-param>
</xsl:call-template>
