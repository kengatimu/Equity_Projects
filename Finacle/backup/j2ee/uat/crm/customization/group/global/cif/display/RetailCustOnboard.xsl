...
<script language='javascript'>
	...
	function submitForm(){
			...
			var documentcode = document.getElementsByName('documenttype')[0].value;
			 <!-- alert("document code"+documentcode);-->
			...
			try
			{			
			document.getElementsByName('dedup check')[0].disabled= true;
			document.FindForm.action ="../servlet/com.infy.cis.custom.RetailCustOnboardList?ReferenceNumber="+uniqueid+"&IdentificationType="+documentcode+"";
			document.FindForm.submit();
			
			<!--CRM_STD_Frank updated on 2012/5/30. Ref.:QC922. Begins-->
	...
	function clearForm() {
			...
			document.getElementsByName('CREATE7')[0].disabled= true;
			}
	

	function load(){
	
	        	document.getElementsByName('dedup check')[0].disabled= false;      
			document.getElementsByName('CREATE1')[0].disabled= true;
			document.getElementsByName('CREATE2')[0].disabled= true;
			document.getElementsByName('CREATE3')[0].disabled= true;
			document.getElementsByName('CREATE4')[0].disabled= true;
	...
	function CreateCustomerQDE(){
				...
				screenTitle.titleMsg.innerHTML = "Individual CIF > New Entity > Customer QDE";
				<!--CRM_STD_Frank updated on 2012/5/14. Ref.:QC707. Begins-->
				
				dataArea.location.href="../servlet/com.infy.cis.ui.cif.CustomerQDEDetWizard";
	...
	function CreateCustomer(){
					...
					var dataArea = parent.parent.parent.parent.parent;
					var screenTitle= parent.parent.parent.parent.parent.parent.ScreenTitleFrm;
					screenTitle.titleMsg.innerHTML = "Individual CIF > New Entity > Customer DDE";
					<!--CRM_STD_Frank updated on 2012/5/14. Ref.:QC707. Begins-->
					
					dataArea.location.href="../servlet/com.infy.cis.ui.cif.AccountDetWizard";
	...
	function CreateCustomerSQDE(){
					...
					var dataArea = parent.parent.parent.parent.parent;
					var screenTitle= parent.parent.parent.parent.parent.parent.ScreenTitleFrm;
					screenTitle.titleMsg.innerHTML = "Individual CIF > New Entity > Customer SQDE";
					<!--CRM_STD_Frank updated on 2012/5/14. Ref.:QC707. Begins-->
					
					dataArea.location.href="../servlet/com.infy.cis.ui.cif.RetSQDEDetWizard";
	...
	function CreateContactQDE(){
				
						
				
				setCookie("Filter_uniqueId",document.FindForm.ReferenceNumber);
				setCookie("Filter_documentcode",document.FindForm.documenttype.value);
				
				var dataArea = parent.parent.parent.parent.parent;
				var screenTitle= parent.parent.parent.parent.parent.parent.ScreenTitleFrm;
				screenTitle.titleMsg.innerHTML = "Individual CIF > New Entity > Contact QDE";
				dataArea.location.href="../servlet/com.infy.cis.ui.cif.ContactQDEDetWizard";
	}
	...
	function CreateProspectQDE()
	{
					...
					var dataArea = parent.parent.parent.parent.parent;
					var screenTitle= parent.parent.parent.parent.parent.parent.ScreenTitleFrm;
					screenTitle.titleMsg.innerHTML = "Individual CIF > New Entity > Prospect QDE";
					dataArea.location.href="../servlet/com.infy.cis.ui.cif.QDEProspectDetWizard";
	...
	function CreateProspect()
		{
						...
						var dataArea = parent.parent.parent.parent.parent;
						var screenTitle= parent.parent.parent.parent.parent.parent.ScreenTitleFrm;
						screenTitle.titleMsg.innerHTML = "Individual CIF > New Entity > Prospect";
						dataArea.location.href="../servlet/com.infy.cis.ui.cif.SuspectDetWizard";
	...
	function CreateNonCustomer()
		{
						...
						var dataArea = parent.parent.parent.parent.parent;
						var screenTitle= parent.parent.parent.parent.parent.parent.ScreenTitleFrm;
						screenTitle.titleMsg.innerHTML = "Individual CIF > New Entity > Non-customer";
						dataArea.location.href="../servlet/com.infy.cis.ui.cif.NonCustomerDetWizard";
...
<input type="hidden" name="IdentificationType" value=""/> 
	...
	<tr>
       ...
       <xsl:call-template name="user_button_withText">
       		...
       		<xsl:with-param name="button_fnc">CreateCustomerQDE();</xsl:with-param>
       		<xsl:with-param name="class">sbttn</xsl:with-param>
       		</xsl:call-template>&#160;
       		...
       		<xsl:call-template name="user_button_withText">
		       		...
		       		<xsl:with-param name="button_fnc">CreateCustomerSQDE();</xsl:with-param>
		       		<xsl:with-param name="class">sbttn</xsl:with-param>
				</xsl:call-template>
		       ...
		       <xsl:call-template name="user_button_withText">
		       					...
		       					<xsl:with-param name="button_fnc">CreateCustomer();</xsl:with-param>
		       					<xsl:with-param name="class">sbttn</xsl:with-param>
					</xsl:call-template>&#160;
		    </td>
		     <td>
		       <xsl:call-template name="user_button_withText">
					...
					<xsl:with-param name="button_text">Contact QDE</xsl:with-param>
					<xsl:with-param name="button_fnc">CreateContactQDE();</xsl:with-param>
					<xsl:with-param name="class">sbttn</xsl:with-param>
					</xsl:call-template>&#160;
	...
	<tr>
        <td>
					...
					<xsl:call-template name="user_button_withText">
										<xsl:with-param name="button_name">CREATE7</xsl:with-param>
										<xsl:with-param name="button_text">Prospect QDE</xsl:with-param>
