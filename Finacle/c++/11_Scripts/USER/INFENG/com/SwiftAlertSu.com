...
#  -------         ------          ------               ------------
#  1.0             04-10-2022      Irungu James          Original Version
#-----------------------------------------------------------------------------------------------
...
tooo="Greetings South Sudan Team "
fi
if [ ${moduleType} = "SWIFT" ]
then
subject=" Eazzybiz Swift EFT verification ${dtime}"
fi
(
	echo "From: ${frmmail}"
	echo "To: ${tomail}"
	...
	echo " Bank Code: ${poAwiBIC} "
	echo " Country: ${poCtry} "
	echo  " "
	echo " Payment details: "
	echo " Amount: ${poAmt}  ${poStatus} "
	echo " Payment Ref:  ${poNum} "
