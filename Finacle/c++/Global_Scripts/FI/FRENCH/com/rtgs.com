...
mrbx4004 $B2K_SESSION_ID  $mrtFileName rtgs.lst $reportFileName 
...
babx4040 "${B2K_SESSION_ID}" "$reportFileName.rpt" "Unverified RTGS Report " "MANAGER" "${noOfPages}" N
