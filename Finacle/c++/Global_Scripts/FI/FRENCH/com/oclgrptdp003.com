...
#       SQL Execution
#----------------------------------------------------------------------------------------
#	exebatch spbx4001 CUSTOM.OCLGRPT_PACK_09.OCLGRPT_PROC_09 $solId!$zoneDate!$zoneCode!$bankId!$pZoneCode1!$pZoneCode2!$pZoneCode3!$pBrCode> $LstFile
	spbx4001 CUSTOM.OCLGRPT_PACK_09.OCLGRPT_PROC_09 $solId!$zoneDate!$zoneCode!$bankId!$pZoneCode1!$pZoneCode2!$pZoneCode3!$pBrCode> $LstFile 
	if [ $? -ne 0 ]
	then
