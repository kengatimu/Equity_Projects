...
#        	0.01       12-03-2013		Shishira  		Original 
...
#       SQL Execution
#----------------------------------------------------------------------------------------
#	exebatch spbx4001 CUSTOM.OCLGRPT_Pack_08.OCLGRPT_PROC_08 $solId!$zoneDate!$zoneCode!$bankId > $LstFile
	spbx4001 CUSTOM.OCLGRPT2_PACK_08.OCLGRPT2_PROC_08 $solId!$zoneDate!$zoneCode!$bankId > $LstFile 
	if [ $? -ne 0 ]
	then
