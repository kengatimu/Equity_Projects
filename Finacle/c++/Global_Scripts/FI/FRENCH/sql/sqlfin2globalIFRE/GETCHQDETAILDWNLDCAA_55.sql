--DROP PACKAGE CUSTOM.GETCHQDETAILDWNLDCAA_55;

CREATE OR REPLACE PACKAGE CUSTOM.Getchqdetaildwnldcaa_55 AS
PROCEDURE Getchqdetaildwnldcaa( inp_str IN VARCHAR2,
            out_retCode OUT NUMBER,
            out_desc OUT VARCHAR2);
END Getchqdetaildwnldcaa_55;
/


GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDWNLDCAA_55 TO TBAADM;

GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDWNLDCAA_55 TO TBAGEN;

GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDWNLDCAA_55 TO TBAUTIL;


DROP PACKAGE BODY CUSTOM.GETCHQDETAILDWNLDCAA_55;

CREATE OR REPLACE PACKAGE BODY custom.Getchqdetaildwnldcaa_55 AS
