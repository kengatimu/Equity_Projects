REM**********************************************************************************
REM     Report Name             : TILL POSITION INQUIRY.
REM     File Name               : dentillmn001.sql
...
create or replace synonym tbautil.FIN_DENTILL_PACK for custom.FIN_DENTILL_PACK
/
create or replace synonym tbagen.FIN_DENTILL_PACK for custom.FIN_DENTILL_PACK
/
------------------------------------------------------------------------------
------------------------------ GRANTING PERMISSION TO SCHEMAS ----------------
grant execute,debug on custom.FIN_DENTILL_PACK to tbagen,tbautil
/
------------------------------------------------------------------------------
------------------------------ END OF FILE  ----------------------------------
show errors
