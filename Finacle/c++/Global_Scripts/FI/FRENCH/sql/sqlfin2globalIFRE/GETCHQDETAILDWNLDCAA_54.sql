--DROP PACKAGE CUSTOM.GETCHQDETAILDWNLDCAA_54;

CREATE OR REPLACE PACKAGE CUSTOM.Getchqdetaildwnldcaa_54 AS
PROCEDURE Getchqdetaildwnldcaa( inp_str IN VARCHAR2,
            out_retCode OUT NUMBER,
            out_desc OUT VARCHAR2);
END Getchqdetaildwnldcaa_54;
/


GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDWNLDCAA_54 TO TBAADM;

GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDWNLDCAA_54 TO TBAGEN;

GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDWNLDCAA_54 TO TBAUTIL;


DROP PACKAGE BODY CUSTOM.GETCHQDETAILDWNLDCAA_54;

CREATE OR REPLACE PACKAGE BODY CUSTOM.Getchqdetaildwnldcaa_54 AS
