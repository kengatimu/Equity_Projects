CREATE OR REPLACE PACKAGE GETCHQDETAILDUPDWNLD AS
...
CREATE OR REPLACE PACKAGE BODY GETCHQDETAILDUPDWNLD AS
...
End GETCHQDETAILDUPDWNLD;
/
grant all on GETCHQDETAILDUPDWNLD to tbaadm,tbagen,tbautil
/
SHOW ERROR
/
