--DROP PACKAGE CUSTOM.GETCHQDETAILDUPDWNLD_54;

CREATE OR REPLACE PACKAGE CUSTOM.GETCHQDETAILDUPDWNLD_54 AS
PROCEDURE GETCHQDETAILDUPDWNLD( inp_str IN VARCHAR2,
            out_retCode OUT NUMBER,
            out_desc OUT VARCHAR2);
END GETCHQDETAILDUPDWNLD_54;
/


GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDUPDWNLD_54 TO TBAADM;

GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDUPDWNLD_54 TO TBAGEN;

GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDUPDWNLD_54 TO TBAUTIL;


DROP PACKAGE BODY CUSTOM.GETCHQDETAILDUPDWNLD_54;

CREATE OR REPLACE PACKAGE BODY CUSTOM.GETCHQDETAILDUPDWNLD_54 AS
