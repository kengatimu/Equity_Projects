/* Formatted on 2013/04/17 15:22 (Formatter Plus v4.8.8) */
-------------------------------------------------------------------------------------------------------
--  Name                        : custEITRep_cr00719mn002.sql
--  Date                        : 26-02-2013
--  Description                 : 
--  Author                      : Parikshith
--  Modification History        :
-- <Serial No.>    <Date>       <Author Name>       <Description>
--     1.0       17-04--2013      Parikshith             Initial draft
-------------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------
CREATE OR REPLACE SYNONYM tbagen.intrpt_report_pack FOR custom.intrpt_report_pack
/
CREATE OR REPLACE SYNONYM tbautil.intrpt_report_pack FOR custom.intrpt_report_pack
/
CREATE OR REPLACE SYNONYM tbaadm.intrpt_report_pack FOR custom.intrpt_report_pack
/
GRANT EXECUTE ON custom.intrpt_report_pack TO tbagen,tbautil,tbaadm
/
