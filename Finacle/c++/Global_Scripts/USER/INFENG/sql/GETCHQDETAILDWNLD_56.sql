--DROP PACKAGE CUSTOM.GETCHQDETAILDWNLD_56;

CREATE OR REPLACE PACKAGE CUSTOM.Getchqdetaildwnld_56 AS
PROCEDURE Getchqdetaildwnld( inp_str IN VARCHAR2,
            out_retCode OUT NUMBER,
            out_desc OUT VARCHAR2);
END Getchqdetaildwnld_56;
/


GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDWNLD_56 TO TBAADM;

GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDWNLD_56 TO TBAGEN;

GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDWNLD_56 TO TBAUTIL;


DROP PACKAGE BODY CUSTOM.GETCHQDETAILDWNLD_56;

CREATE OR REPLACE PACKAGE BODY CUSTOM.Getchqdetaildwnld_56 AS
