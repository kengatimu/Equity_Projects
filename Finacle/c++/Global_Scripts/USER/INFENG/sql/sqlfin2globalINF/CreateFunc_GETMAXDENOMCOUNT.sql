DROP FUNCTION CUSTOM.GETMAXDENOMCOUNT;

CREATE OR REPLACE FUNCTION CUSTOM.GETMAXDENOMCOUNT(
...
END GETMAXDENOMCOUNT;
/

DROP SYNONYM TBAGEN.GETMAXDENOMCOUNT;

CREATE SYNONYM TBAGEN.GETMAXDENOMCOUNT FOR CUSTOM.GETMAXDENOMCOUNT;

DROP SYNONYM TBAUTIL.GETMAXDENOMCOUNT;

CREATE SYNONYM TBAUTIL.GETMAXDENOMCOUNT FOR CUSTOM.GETMAXDENOMCOUNT;


GRANT EXECUTE ON CUSTOM.GETMAXDENOMCOUNT TO ALLTAB;

GRANT EXECUTE ON CUSTOM.GETMAXDENOMCOUNT TO TBAGEN;

GRANT EXECUTE ON CUSTOM.GETMAXDENOMCOUNT TO TBAUTIL;
