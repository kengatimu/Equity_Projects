...
-- For inserting data into custom table        
        ...
        insert into CUSTOM.SUSP_DET_TBL_FINAL54_FC values(GamGac_rec.acid,GamGac_rec.foracid,GamGac_rec.Sol_id,GamGac_rec.acct_opn_date,GamGac_rec.acct_cls_flg,
