...
input="$1"
input1="$2"
reportFileName="hotce${$}"
ripFileName="hotce${$}.rip"
mrtFileName="hotce.mrt"

bauu9151 hotce.sql "$1" "$2"
if [ $? -ne 0 ]
then
...
mrbx4004 $B2K_SESSION_ID $mrtFileName hotce.lst $reportFileName 
...
babx4040 "${B2K_SESSION_ID}" "$reportFileName.rpt" "Unverified HOTCE  " "MANAGER" "${noOfPages}" N
