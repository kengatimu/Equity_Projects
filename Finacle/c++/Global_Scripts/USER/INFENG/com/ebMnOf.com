...
echo $FIN_BANK_ID
nacct="1220299727755"
wd="/finacle/EQPROD/BackEnd/Finacle/FC/app/CDCI_LOGS/PAYSYS54/LOG/MSG_BKP/"
cd ${wd}
logfil=`date +%m%d%Y%H%M%S`".log"
datr="940${nacct}"`date +%m%d%H%M%S`".txt"
for fil in `find /finacle/EQPROD/BackEnd/Finacle/FC/app/CDCI_LOGS/PAYSYS54/LOG/MSG_BKP -mtime 0 -type f | xargs ls -lrt |  awk  '{ print $9 }'`
do
...
tomail="twanja@ktdateas.com,fa@kapkoros.ktdateas.com,fum@kapkoros.ktdateas.com,ndungur@gmail.com,sielebeatrice@gmail.com,fwairimu95@gmail.com,twsudi@gmail.com,Sanayianrose@gmail.com"
