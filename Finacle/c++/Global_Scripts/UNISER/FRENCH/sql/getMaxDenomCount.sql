...
/
create or replace synonym tbagen.GETMAXDENOMCOUNT for custom.GETMAXDENOMCOUNT
/
create or replace synonym tbautil.GETMAXDENOMCOUNT for custom.GETMAXDENOMCOUNT
/
grant execute on custom.GETMAXDENOMCOUNT to tbagen,tbautil
/
