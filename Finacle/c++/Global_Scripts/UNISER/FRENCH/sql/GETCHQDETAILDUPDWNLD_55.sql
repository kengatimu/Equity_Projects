--DROP PACKAGE CUSTOM.GETCHQDETAILDUPDWNLD_55;

CREATE OR REPLACE PACKAGE CUSTOM.GETCHQDETAILDUPDWNLD_55 AS
PROCEDURE GETCHQDETAILDUPDWNLD( inp_str IN VARCHAR2,
            out_retCode OUT NUMBER,
            out_desc OUT VARCHAR2);
END GETCHQDETAILDUPDWNLD_55;
/


GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDUPDWNLD_55 TO TBAADM;

GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDUPDWNLD_55 TO TBAGEN;

GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDUPDWNLD_55 TO TBAUTIL;


DROP PACKAGE BODY CUSTOM.GETCHQDETAILDUPDWNLD_55;

CREATE OR REPLACE PACKAGE BODY CUSTOM.GETCHQDETAILDUPDWNLD_55 AS
