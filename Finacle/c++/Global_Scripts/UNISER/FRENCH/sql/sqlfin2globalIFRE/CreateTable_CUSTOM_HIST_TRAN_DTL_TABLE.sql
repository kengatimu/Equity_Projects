...
CREATE UNIQUE INDEX CUSTOM.IDX_CUSTOM_HIST_TRAN_DTL_TABLE ON CUSTOM.CUSTOM_HIST_TRAN_DTL_TABLE
(TRAN_DATE, TRAN_ID, PART_TRAN_SRL_NUM, BANK_ID);


CREATE INDEX CUSTOM.IDX_C_HTD_GSH ON CUSTOM.CUSTOM_HIST_TRAN_DTL_TABLE
(GL_SUB_HEAD_CODE, TRAN_CRNCY_CODE, SOL_ID, TRAN_DATE)
;


CREATE INDEX CUSTOM.IDX_C_HTD_ACCT_ID ON CUSTOM.CUSTOM_HIST_TRAN_DTL_TABLE
(ACID, TRAN_DATE);


CREATE INDEX CUSTOM.IDX_C_HTD_ACCT_VAL_DT ON CUSTOM.CUSTOM_HIST_TRAN_DTL_TABLE
(ACID, VALUE_DATE);


CREATE INDEX CUSTOM.IDX_C_HTD_ACCT_ID_GL_DATE ON CUSTOM.CUSTOM_HIST_TRAN_DTL_TABLE
(ACID, GL_DATE);


CREATE INDEX CUSTOM.IDX_C_HTD_SOL_ID_TRAN_DATE ON CUSTOM.CUSTOM_HIST_TRAN_DTL_TABLE
(SOL_ID, TRAN_DATE);
