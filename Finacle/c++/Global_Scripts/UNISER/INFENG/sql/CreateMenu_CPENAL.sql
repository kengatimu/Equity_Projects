...
delete from tbaadm.MOD WHERE mop_ID = 'CPENAL' and bank_id='43';
delete from tbaadm.MOD_TXT WHERE mop_ID = 'CPENAL' and bank_id='43';
delete from tbaadm.MNO WHERE mop_ID = 'CPENAL' and bank_id='43';
delete from tbaadm.OAT WHERE mop_ID = 'CPENAL' and bank_id='43';
commit;
...
VALUES('CPENAL','Y','N','U','https://$W/finbranch/','Customize/Customize_ctrl.jsp?sessionid=$S','\&sectok=$T\&finsessionid=$S\&fabsessionid=$C\&mo=CPENAL\&mtype=F','F
...
VALUES('CPENAL','INFENG','CPENAL','Penal Charge Maintenance','','Y','TBAADM','TBAADM',SYSDATE,SYSDATE,0,'43');

INSERT INTO tbaadm.OAT (MOP_ID,APPL_ID,LCHG_USER_ID,LCHG_TIME,RCRE_USER_ID,RCRE_TIME,TS_CNT,BANK_ID)
VALUES('CPENAL','GU','TBAADM',SYSDATE,'TBAADM',SYSDATE,0,'43');
...
VALUES('ONSDBMNU',:mopNum,'CPENAL','Y','U','TBAADM',SYSDATE,'TBAADM',SYSDATE,0,'43');
end;
/
