DROP PACKAGE CUSTOM.OCLGIRPT_PACK_RD;

CREATE OR REPLACE PACKAGE CUSTOM.OCLGIRPT_PACK_RD AS
PROCEDURE OCLGIRPT_PROC_RD(inp_str IN varchar2,
    out_retcode OUT number,
    out_rec out varchar2);
END OCLGIRPT_PACK_RD;
/

DROP PACKAGE BODY CUSTOM.OCLGIRPT_PACK_RD;

CREATE OR REPLACE PACKAGE BODY CUSTOM.OCLGIRPT_PACK_RD AS
...
WHERE
    ...
    AND OCI.del_flg ='N'
    AND OCI.sol_id in (SELECT sol_id FROM TBAADM.SST WHERE SST.set_id=inp_SolId AND del_flg ='N')
...
END OCLGIRPT_PROC_RD;
END OCLGIRPT_PACK_RD;
/


DROP SYNONYM CUSTOM.OCLGIRPT_PACK_RD1;

CREATE SYNONYM CUSTOM.OCLGIRPT_PACK_RD1 FOR CUSTOM.OCLGIRPT_PACK_RD;

GRANT EXECUTE ON CUSTOM.OCLGIRPT_PACK_RD TO ALLTAB;

GRANT EXECUTE ON CUSTOM.OCLGIRPT_PACK_RD TO TBAADM;

GRANT EXECUTE ON CUSTOM.OCLGIRPT_PACK_RD TO TBAGEN;

GRANT EXECUTE ON CUSTOM.OCLGIRPT_PACK_RD TO TBAUTIL;
