...
#       MAIN SCRIPT
#----------------------------------------------------------------------------------------
        Report="OutwardClearingFile"
        SqlFile=oclgrptmn002.sql
...
#       SQL Execution
#----------------------------------------------------------------------------------------
#	exebatch spbx4001 CUSTOM.OCLGRPT_PACK_02.OCLGRPT_PROC_02 $solId!$zoneDate!$zoneCode!$bankId!$pZoneCode1!$pZoneCode2!$pZoneCode3> $LstFile
	spbx4001 CUSTOM.OCLGRPT_PACK_02.OCLGRPT_PROC_02 $solId!$zoneDate!$zoneCode!$bankId!$pZoneCode1!$pZoneCode2!$pZoneCode3> $LstFile 
	if [ $? -ne 0 ]
	then
