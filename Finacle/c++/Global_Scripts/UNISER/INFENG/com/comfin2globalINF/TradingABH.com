...
input3="$3"
input4="$4"
reportFileName="TradingABH${$}"
ripFileName="TradingABH${$}.rip"
mrtFileName="TradingABH.mrt"

bauu9151 TradingABH.sql "$1" "$2" "$3" "$4"
if [ $? -ne 0 ]
then
...
mrbx4004 $B2K_SESSION_ID  $mrtFileName TradingABH.lst $reportFileName 
...
babx4040 "${B2K_SESSION_ID}" "$reportFileName.rpt" "Un-Verified SALES" "MANAGER" "${noOfPages}" N
