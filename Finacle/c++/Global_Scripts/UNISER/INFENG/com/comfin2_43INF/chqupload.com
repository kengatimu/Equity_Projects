...
if [ ${start} != "" -a ${end} != "" ]
then
#echo "UPDATE CUSTOM.CUSTOM_CBR SET REQ_STATUS='R',BEGIN_CHQ_NUM=rtrim('$start'),END_CHQ_NUM=rtrim('$end') WHERE BANK_ID='$7' AND REQ_ID=rtrim('$req') AND REQ_STATUS IN ('S','R');">>uploadxls.sql
