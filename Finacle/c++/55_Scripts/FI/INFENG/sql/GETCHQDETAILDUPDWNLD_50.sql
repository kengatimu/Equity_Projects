--DROP PACKAGE CUSTOM.GETCHQDETAILDUPDWNLD_50;

CREATE OR REPLACE PACKAGE CUSTOM.GETCHQDETAILDUPDWNLD_50 AS
PROCEDURE GETCHQDETAILDUPDWNLD( inp_str IN VARCHAR2,
            out_retCode OUT NUMBER,
            out_desc OUT VARCHAR2);
END GETCHQDETAILDUPDWNLD_50;
/


GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDUPDWNLD_50 TO TBAADM;

GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDUPDWNLD_50 TO TBAGEN;

GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDUPDWNLD_50 TO TBAUTIL;


DROP PACKAGE BODY CUSTOM.GETCHQDETAILDUPDWNLD_50;

CREATE OR REPLACE PACKAGE BODY CUSTOM.GETCHQDETAILDUPDWNLD_50 AS
