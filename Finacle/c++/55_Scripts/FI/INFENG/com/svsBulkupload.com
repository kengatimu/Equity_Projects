...
#      2 		08-01-2020	Irungu James 			Restrict the update of Signid createdby to the uploading branch.RF37519
#===============================================================================
...
echo "update svsuser.nsigncustinfo set createdby='${userId}' where createdby='SVSUPLOADUTILITY' and substr(SIGNID,1,(select length (sol_id)from tbaadm.upr where user_id ='${userId}')) = (select  sol_id from tbaadm.upr where user_id ='${userId}') " > test12345.sql
echo "/" >> test12345.sql
...
echo "update svsuser.nsignmaintenance set createdby='${userId}' where createdby='SVSUPLOADUTILITY' and substr(SIGNID,1,(select length (sol_id)from tbaadm.upr where user_id ='${userId}')) = (select  sol_id from tbaadm.upr where user_id ='${userId}')" > test123456.sql
echo "/" >> test123456.sql
