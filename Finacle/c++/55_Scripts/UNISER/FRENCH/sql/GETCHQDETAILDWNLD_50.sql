--DROP PACKAGE CUSTOM.GETCHQDETAILDWNLD_50;

CREATE OR REPLACE PACKAGE CUSTOM.Getchqdetaildwnld_50 AS
PROCEDURE Getchqdetaildwnld( inp_str IN VARCHAR2,
            out_retCode OUT NUMBER,
            out_desc OUT VARCHAR2);
END Getchqdetaildwnld_50;
/


GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDWNLD_50 TO TBAADM;

GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDWNLD_50 TO TBAGEN;

GRANT EXECUTE, DEBUG ON CUSTOM.GETCHQDETAILDWNLD_50 TO TBAUTIL;


DROP PACKAGE BODY CUSTOM.GETCHQDETAILDWNLD_50;

CREATE OR REPLACE PACKAGE BODY custom.Getchqdetaildwnld_50 AS
...
---CLGCENTRENUM    BCT.MICR_CENTRE_CODE %TYPE;
...
BEGIN
    ...
    BEGIN
         SELECT    br_code,bank_code---,CLG_CENTRE_NUM
        INTO    BRCODE,BANKCODE---,MICRCENTRECODE
        FROM    TBAADM.sol
        WHERE    sol_id = SOLID
        and bank_id =bankID;
        EXCEPTION
...
-- Addedum by Peter Gachau  20/Jan/2006
