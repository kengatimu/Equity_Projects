...
#       SQL Execution
#----------------------------------------------------------------------------------------
#	exebatch spbx4001 CUSTOM.OCLGIRPT_PACK_TZ.OCLGIRPT_PROC_TZ $solId $zoneDate $zoneCode $bankId > $LstFile
	spbx4001 CUSTOM.OCLGIRPT_PACK_TZ.OCLGIRPT_PROC_TZ $solId $zoneDate $zoneCode $bankId > $LstFile 
	if [ $? -ne 0 ]
	then
