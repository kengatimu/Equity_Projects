...
echo "select rpad(NVL(DR_ACCT_NUM,' '),16,' ')||rpad('KES',3,' ')||rpad(NVL((select sol_id from tbaadm.gam where bank_id='54' and foracid=DR_ACCT_NUM),' '),8,' ')||rpad(NVL('D',' '),1,' ')||lpad(NVL(abs((TRAN_AMT)),0),17,' ')||rpad(NVL(TRAN_REMARKS,' '),30,' ')||rpad(NVL(' ',' '),5,' ')||rpad(NVL(' ',' '),20,' ')||rpad(NVL(' ',' '),5,' ')||rpad(NVL(' ',' '),10,' ')||rpad(NVL(' ',' '),6,' ')||rpad(NVL(' ',' '),16,' ')||rpad(NVL(' ',' '),1,' ')||rpad(NVL(' ',' '),17,' ')||rpad(NVL(' ',' '),3,' ')||rpad(NVL(' ',' '),5,' ')||rpad(NVL('',' '),15,' ')||rpad(to_char(sysdate,'DD-MM-YYYY'),10,' ')||rpad(NVL(' ',' '),10,' ')||rpad(NVL(' ',' '),5,' ')||rpad(NVL(' ',' '),6,' ')||rpad(NVL(' ',' '),6,' ')||rpad(NVL(' ',' '),2,' ')||rpad(NVL(' ',' '),1,' ')||rpad(NVL(' ',' '),12,' ')||rpad(NVL(' ',' '),10,' ')||rpad(NVL(' ',' '),20,' ')||rpad(NVL(' ',' '),5,' ')||rpad(NVL(' ',' '),30,' ')||rpad(NVL(' ',' '),40,' ')||rpad(NVL(' ',' '),40,' ')||rpad(NVL(' ',' '),40,' ')||rpad(NVL(' ',' '),40,' ')||rpad(NVL(' ',' '),40,' ')||rpad(NVL(' ',' '),17,' ')||rpad(NVL(' ',' '),17,' ')||rpad(NVL(' ',' '),17,' ')||rpad(NVL(' ',' '),17,' ')||rpad(NVL(' ',' '),17,' ')||rpad(NVL(BENEF_ACCOUNT_NUM,' '),30,' ')||rpad(NVL(' ',' '),16,' ')||rpad(NVL(' ',' '),12,' ')||rpad(NVL(' ',' '),10,' ')||rpad(NVL(' ',' '),10,' ')||rpad(NVL(' ',' '),9,' ')||rpad(NVL(' ',' '),4,' ')||rpad(NVL(' ',' '),256,' ')||rpad(NVL(' ',' '),16,' ')||rpad(NVL(' ',' '),5,' ')||rpad(NVL(' ',' '),5,' ')||rpad(NVL(' ',' '),5,' ')||rpad(NVL(' ',' '),50,' ')from custom.plmt where bank_id='54' and CORE_TRAN_ID is null and CORE_TRAN_DATE is null and RCRE_USER_ID='${uuid}' and UPL_REF_NUM='${batchId}' AND PROCESS_STAUS='U' and api_yn is null " >> ${batchId}_T.sql 
...
echo "and PROCESS_STAUS='U' and api_yn is null " >> ${batchId}_T.sql 
echo "union all " >> ${batchId}_T.sql 
echo "select rpad(NVL('0006500604443',' '),16,' ') ||rpad('KES',3,' ') ||rpad(NVL((select sol_id from tbaadm.gam where bank_id='54' and foracid=CR_ACCT_NUM),' '),8,' ') ||rpad(NVL('C',' '),1,' ') ||lpad(NVL(abs((FREE_TEXT4)),0),17,' ')||rpad(NVL('Transaction Processing Charge',' '),30,' ') ||rpad(NVL(' ',' '),5,' ') ||rpad(NVL(' ',' '),20,' ') ||rpad(NVL(' ',' '),5,' ') ||rpad(NVL(' ',' '),10,' ') ||rpad(NVL(' ',' '),6,' ') ||rpad(NVL(' ',' '),16,' ') ||rpad(NVL(' ',' '),1,' ') ||rpad(NVL(' ',' '),17,' ') ||rpad(NVL(' ',' '),3,' ') ||rpad(NVL(' ',' '),5,' ') ||rpad(NVL('',' '),15,' ') ||rpad(to_char(sysdate,'DD-MM-YYYY'),10,' ') ||rpad(NVL(' ',' '),10,' ') ||rpad(NVL(' ',' '),5,' ') ||rpad(NVL(' ',' '),6,' ') ||rpad(NVL(' ',' '),6,' ') ||rpad(NVL(' ',' '),2,' ') ||rpad(NVL(' ',' '),1,' ') ||rpad(NVL(' ',' '),12,' ') ||rpad(NVL(' ',' '),10,' ') ||rpad(NVL(' ',' '),20,' ') ||rpad(NVL(' ',' '),5,' ') ||rpad(NVL(' ',' '),30,' ') ||rpad(NVL(' ',' '),40,' ') ||rpad(NVL(' ',' '),40,' ') ||rpad(NVL(' ',' '),40,' ') ||rpad(NVL(' ',' '),40,' ') ||rpad(NVL(' ',' '),40,' ') ||rpad(NVL(' ',' '),17,' ') ||rpad(NVL(' ',' '),17,' ') ||rpad(NVL(' ',' '),17,' ') ||rpad(NVL(' ',' '),17,' ') ||rpad(NVL(' ',' '),17,' ') ||rpad(nvl('PesaLink Comm Cr:'||benef_account_num,' '),30,' ')||rpad(NVL(' ',' '),16,' ') ||rpad(NVL(' ',' '),12,' ') ||rpad(NVL(' ',' '),10,' ') ||rpad(NVL(' ',' '),10,' ') ||rpad(NVL(' ',' '),9,' ') ||rpad(NVL(' ',' '),4,' ') ||rpad(NVL(' ',' '),256,' ') ||rpad(NVL(' ',' '),16,' ') ||rpad(NVL(' ',' '),5,' ') ||rpad(NVL(' ',' '),5,' ') ||rpad(NVL(' ',' '),5,' ') ||rpad(NVL(' ',' '),50,' ') from custom.plmt where bank_id='54' and CORE_TRAN_ID is null and CORE_TRAN_DATE is null and RCRE_USER_ID='${uuid}' " >> ${batchId}_T.sql
echo "and FREE_TEXT4 is not null and UPL_REF_NUM='${batchId}' and api_yn is null; " >> ${batchId}_T.sql
...
echo "and plmt.api_yn is null " >> ${batchId}g.sql
