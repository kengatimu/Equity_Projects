...
#       SQL Execution
#----------------------------------------------------------------------------------------
#	exebatch spbx4001 CUSTOM.OCLGRPT_PACK_01.OCLGRPT_PROC_01 $solId!$zoneDate!$zoneCode!$bankId!$pZoneCode1!$pZoneCode2!$pZoneCode3> $LstFile
	spbx4001 CUSTOM.OCLGRPT_PACK_01.OCLGRPT_PROC_01 $solId!$zoneDate!$zoneCode!$bankId!$pZoneCode1!$pZoneCode2!$pZoneCode3> $LstFile 
	if [ $? -ne 0 ]
	then
