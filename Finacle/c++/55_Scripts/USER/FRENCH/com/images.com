...
#. `execom commfunc.com`
 input="$1"
 input1="$2"
reportFileName="images${$}"
ripFileName="images${$}.rip"
mrtFileName="images.mrt"

bauu9151 images.sql "$1" "$2"
if [ $? -ne 0 ]
then
...
mrbx4004 $B2K_SESSION_ID  $mrtFileName image.lst $reportFileName 
...
babx4040 "${B2K_SESSION_ID}" "$reportFileName.rpt" "Unverified images  " "MANAGER" "${noOfPages}" N
