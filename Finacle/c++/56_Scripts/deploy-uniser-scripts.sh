...
hpUNISERScriptDirectory=/finacle/EQPROD/BackEnd/Finacle/FC/app/cust/"$BANK"
...
then
    echo "FiNACLE UNISER_SCRIPT FILES FOUND IN:  "$UNISERFinacleFileType"/finacleFileType.txt"
    ...
    echo "NO UNISER_SCRIPT FILES FOUND. EXITING THE PROGRAM..."
fi
