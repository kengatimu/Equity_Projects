...
#testPath=/pipelines/USER
#hpUSERRootDirectory="$testPath"/finacle/EQPROD/BackEnd/Finacle/FC/app
#hpUSERScriptDirectory="$testPath"/finacle/EQPROD/BackEnd/Finacle/FC/app/cust/"$BANK"

hpUSERRootDirectory=/finacle/EQPROD/BackEnd/Finacle/FC/app
hpUSERScriptDirectory=/finacle/EQPROD/BackEnd/Finacle/FC/app/cust/"$BANK"
...
USERNewFiles="$TempUSERScriptDir"/newFiles
USERDeletedFiles="$TempUSERScriptDir"/deletedFiles
USERModifiedFiles="$TempUSERScriptDir"/modifiedFiles
USERFinacleFileType="$TempUSERScriptDir"/finacleFileType
...
#funtion to check if branch-user file
isUserFile() {
...
check_for_deleted_files() {
	...
	then
		...
		while read -r file;
		do	
			#checking if file is branch-user
...
then
    echo "FiNACLE USER_SCRIPT FILES FOUND IN:  "$USERFinacleFileType"/finacleFileType.txt"
    ...
    echo "NO USER_SCRIPT FILES FOUND. EXITING THE PROGRAM..."
fi
