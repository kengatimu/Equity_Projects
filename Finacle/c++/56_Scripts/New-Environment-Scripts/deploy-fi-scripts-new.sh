...
hpFIScriptDirectory=/finacle/equity_be/Finacle/FC/app/cust/"$BANK"
...
then
    echo "FiNACLE FI_SCRIPT FILES FOUND IN:  "$FIFinacleFileType"/finacleFileType.txt"
    ...
    echo "NO FI_SCRIPT FILES FOUND. EXITING THE PROGRAM..."
fi
