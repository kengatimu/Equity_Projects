...
echo $FIN_BANK_ID
wd="/finacle/EQPROD/BackEnd/Finacle/FC/app/CDCI_LOGS/PAYSYS43/LOG/"
mkp="/finacle/EQPROD/BackEnd/Finacle/FC/app/CDCI_LOGS/PAYSYS43/LOG/BCDCLOG/"
reout="/finacle/EQPROD/BackEnd/Finacle/FC/app/CDCI_LOGS/PAYSYS43/LOG/BCDC/"
cd ${wd}
nacct="RTO15"
ott="OTT15"
eazybiz=":20:OTTBZN"
...
##for fil in `find /finacle/EQPROD/BackEnd/Finacle/FC/app/CDCI_LOGS/PAYSYS43/LOG  -name "*.MSG" -print`
...
then
	...
	then
		perl -pi -e 's/\n/\r\n/g' ${fil}
		uuidd=`/usr/bin/python /finacle/EQPROD/BackEnd/Finacle/FC/app/cust/54/INFENG/com/ebV4UUID.py`
