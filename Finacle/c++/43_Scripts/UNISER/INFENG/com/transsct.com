...
input="$1"
input1="$2"
reportFileName="transsct${$}"
ripFileName="transsct${$}.rip"
mrtFileName="transsct.mrt"

bauu9151 transsct.sql "$1" "$2"
if [ $? -ne 0 ]
then
...
mrbx4004 $B2K_SESSION_ID $mrtFileName transct.lst $reportFileName 
...
babx4040 "${B2K_SESSION_ID}" "$reportFileName.rpt" "Unverified Transfer Accounts Between Schemes  " "MANAGER" "${noOfPages}" N
