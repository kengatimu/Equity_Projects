...
delete from tbaadm.MOD WHERE mop_ID = 'CACTMAP' and bank_id='43';
delete from tbaadm.MOD_TXT WHERE mop_ID = 'CACTMAP' and bank_id='43';
delete from tbaadm.MNO WHERE mop_ID = 'CACTMAP' and bank_id='43';
delete from tbaadm.OAT WHERE mop_ID = 'CACTMAP' and bank_id='43';
commit;
...
VALUES('CACTMAP','Y','N','U','https://$W/finbranch/','Customize/Customize_ctrl.jsp?sessionid=$S','\&sectok=$T\&finsessionid=$S\&fabsessionid=$C\&mo=CACTMAP\&mtype=F','F
...
VALUES('CACTMAP','INFENG','CACTMAP','Custom Account Mapping Menu','','Y','TBAADM','TBAADM',SYSDATE,SYSDATE,0,'43');

INSERT INTO tbaadm.MOD_TXT (MOP_ID,LANG_CODE,USER_MOP_ID,MOP_TEXT,MOP_HELP_TEXT,ENTITY_CRE_FLG,LCHG_USER_ID,RCRE_USER_ID,LCHG_TIME,RCRE_TIME,TS_CNT,BANK_ID)
VALUES('CACTMAP','FRENCH','CACTMAP','Custom Account Mapping Menu','','Y','TBAADM','TBAADM',SYSDATE,SYSDATE,0,'43');

INSERT INTO tbaadm.OAT (MOP_ID,APPL_ID,LCHG_USER_ID,LCHG_TIME,RCRE_USER_ID,RCRE_TIME,TS_CNT,BANK_ID)
VALUES('CACTMAP','GU','TBAADM',SYSDATE,'TBAADM',SYSDATE,0,'43');
...
VALUES('ONSDBMNU',:mopNum,'CACTMAP','Y','U','TBAADM',SYSDATE,'TBAADM',SYSDATE,0,'43');
end;
/
