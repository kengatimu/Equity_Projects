...
delete from tbaadm.mod where mop_id = 'CCOMSN' and bank_id='43';
delete from tbaadm.mod_txt where mop_id = 'CCOMSN' and bank_id='43';
delete from tbaadm.mno where mop_id = 'CCOMSN' and bank_id='43';
delete from tbaadm.oat where mop_id = 'CCOMSN' and bank_id='43';

variable mopNum varchar2(3);

begin
SELECT NVL(TO_CHAR(MAX(TO_NUMBER(MOP_NUM))+1), '01') into :mopNum FROM tbaadm.MNO WHERE MENU_ID = 'ONSMNU' and bank_id='43';
end;
/
...
VALUES('CCOMSN','Y','N','U','http://$W/$A/','Customize/Customize_ctrl.jsp?sessionid=$S','\&sectok=$T\&finsessionid=$S\&fabsessionid=$C\&mo=CCOMSN\&mtype=F','F
...
VALUES('CCOMSN','INFENG','CCOMSN','LC BG COMMISSION CODE MAINTANACE','','Y','TBAADM','TBAADM',SYSDATE,SYSDATE,0,'43');

INSERT INTO tbaadm.OAT (MOP_ID,APPL_ID,LCHG_USER_ID,LCHG_TIME,RCRE_USER_ID,RCRE_TIME,TS_CNT,BANK_ID)
VALUES('CCOMSN','NC','TBAADM',SYSDATE,'TBAADM',SYSDATE,0,'43');

INSERT INTO tbaadm.OAT (MOP_ID,APPL_ID,LCHG_USER_ID,LCHG_TIME,RCRE_USER_ID,RCRE_TIME,TS_CNT,BANK_ID)
VALUES('CCOMSN','GU','TBAADM',SYSDATE,'TBAADM',SYSDATE,0,'43');
...
VALUES('ONSMNU',:mopNum,'CCOMSN','Y','U','TBAADM',SYSDATE,'TBAADM',SYSDATE,0,'43');
end;
/
