...
-- VARIABLES:
	...
	loc_crncy_code			varchar2(150);
    loc_BG_amount           varchar2(150);
...
BEGIN
   ...
   into loc_ben_name ,loc_ben_add1 ,loc_ben_city ,loc_ben_area ,loc_Client_Name ,loc_Market_Ref ,
   loc_BOD ,loc_Purpose_of_BG,loc_crncy_code,loc_BG_amount ,loc_Eff_date ,loc_Exp_date ,loc_SOL_City ,
   loc_Issue_date ,loc_Responsible1 ,loc_Resp1_designation ,loc_Responsible2 ,
   loc_Resp2_designation ,loc_end
   ...
   and addr_type='S';
    ...
    END; --]
       ...
       dbms_output.put_line( loc_ben_name   	   ||'|'||
							 loc_ben_add1          ||'|'||
							 loc_ben_city          ||'|'||
							 loc_ben_area          ||'|'||
							 loc_Client_Name       ||'|'||
