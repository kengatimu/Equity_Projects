...
tooo="${salu} ${PartyName} ${PartyLname},"
fi
if [ ${moduleLien} = "N" ]
then
subject="Alerte par e-mail de transaction pour votre compte Equity BCDC"
fi
if [ ${moduleLien} = "Y" ]
then
...
(
	 ...
	 echo "Equity BCDC / SIEGE - KINSHASA"
	 echo "courriel: serviceclients@equitybcdc.cd"
