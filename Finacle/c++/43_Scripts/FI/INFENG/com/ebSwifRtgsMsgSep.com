...
echo $FIN_BANK_ID
wd="/finacle/EQPRODFI/BackEnd/Finacle/FC/app/CDCI_LOGS/PAYSYS43/LOG/"
mkp="/finacle/EQPRODFI/BackEnd/Finacle/FC/app/CDCI_LOGS/PAYSYS43/LOG/BCDCLOG/"
reout="/finacle/EQPRODFI/BackEnd/Finacle/FC/app/CDCI_LOGS/PAYSYS43/LOG/BCDC/"
cd ${wd}
nacct="RTO15"
ott="OTT15"
eazybiz=":20:OTTBZN"
...
##for fil in `find /finacle/EQPRODFI/BackEnd/Finacle/FC/app/CDCI_LOGS/PAYSYS43/LOG  -name "*.MSG" -print`
...
then
	...
	then
		perl -pi -e 's/\n/\r\n/g' ${fil}
		uuidd=`/usr/bin/python /finacle/EQPRODFI/BackEnd/Finacle/FC/app/cust/54/INFENG/com/ebV4UUID.py`
...
then
                ...
                datr="RTGS""${senum}""${yymmdd}""${hhmm}"".SWF"
                        ...
                        then
                                perl -pi -e 's/\n/\r\n/g' ${fil}
                                uuidd=`/usr/bin/python /Finacle/FC/app/cust/54/INFENG/com/ebV4UUID.py`
