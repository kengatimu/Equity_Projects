...
spool mdaccounts.lst
SELECT GAM.sol_id||'|'||GAM.foracid||'|'||SUBSTR(ADT.MOP_ID,1,30)||'|'||ADT.audit_bod_date FROM TBAADM.GAM,TBAADM.ADT
...
AND ADT.func_code ='M'
AND ADT.auth_id = '!'
AND ADT.audit_bod_date>'01-jan-2019'
