...
delete from tbaadm.MOD WHERE mop_ID = 'CCOMMNT' and bank_id='43';
delete from tbaadm.MOD_TXT WHERE mop_ID = 'CCOMMNT' and bank_id='43';
delete from tbaadm.MNO WHERE mop_ID = 'CCOMMNT' and bank_id='43';
delete from tbaadm.OAT WHERE mop_ID = 'CCOMMNT' and bank_id='43';
commit;
...
VALUES('CCOMMNT','Y','N','U','https://$W/finbranch/','Customize/Customize_ctrl.jsp?sessionid=$S','\&sectok=$T\&finsessionid=$S\&fabsessionid=$C\&mo=CCOMMNT\&mtype=F','F
...
VALUES('CCOMMNT','INFENG','CCOMMNT','Commision Code Maintenance','','Y','TBAADM','TBAADM',SYSDATE,SYSDATE,0,'43');

INSERT INTO tbaadm.MOD_TXT (MOP_ID,LANG_CODE,USER_MOP_ID,MOP_TEXT,MOP_HELP_TEXT,ENTITY_CRE_FLG,LCHG_USER_ID,RCRE_USER_ID,LCHG_TIME,RCRE_TIME,TS_CNT,BANK_ID)
VALUES('CCOMMNT','FRENCH','CCOMMNT','Commision Code Maintenance','','Y','TBAADM','TBAADM',SYSDATE,SYSDATE,0,'43');

INSERT INTO tbaadm.OAT (MOP_ID,APPL_ID,LCHG_USER_ID,LCHG_TIME,RCRE_USER_ID,RCRE_TIME,TS_CNT,BANK_ID)
VALUES('CCOMMNT','GU','TBAADM',SYSDATE,'TBAADM',SYSDATE,0,'43');
...
VALUES('ONSMNU',:mopNum,'CCOMMNT','Y','U','TBAADM',SYSDATE,'TBAADM',SYSDATE,0,'43');
end;
/
