...
(gam.schm_code not in ('SB199','CA299','SB130','SB135','SB136','SB137','SB145','SB146','SB116','CA216','VA301') and gam.clr_bal_amt > 100000 and acct_crncy_code ='&3') or 
 (gam.schm_code  in ('SB130','SB135','SB136','SB137','SB145','SB146') and gam.clr_bal_amt > 50000 and acct_crncy_code ='&3') or (gam.schm_code  not in
 ('SB199','CA299','SB135','SB136') and gam.clr_bal_amt >(select  100000/VAR_CRNCY_UNITS from tbaadm.rtl where FXD_CRNCY_CODE ='USD' and  VAR_CRNCY_CODE='&3' 
and RATECODE ='MEAN' and bank_id ='&2') and acct_crncy_code ='USD') or (gam.schm_code  not in ('SB199','CA299','SB135','SB136') and gam.clr_bal_amt >
 (select  100000/VAR_CRNCY_UNITS from tbaadm.rtl where FXD_CRNCY_CODE ='GBP' and  VAR_CRNCY_CODE='&3' and RATECODE ='MEAN' and bank_id ='&2') and acct_crncy_code ='GBP') or
  (gam.schm_code  not in ('SB199','CA299','SB135','SB136') and gam.clr_bal_amt > (select  100000/VAR_CRNCY_UNITS from tbaadm.rtl where FXD_CRNCY_CODE ='EUR' and 
