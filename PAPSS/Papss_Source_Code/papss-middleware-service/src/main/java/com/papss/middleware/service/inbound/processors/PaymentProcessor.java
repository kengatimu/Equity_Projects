...
public class PaymentProcessor implements MessageProcessor {
    ...
    public PartnerResponse processMessage(RtpMessageDto messageDto) {
        ...
        try {
            ...
            CreditTransferRequest paymentInitiation = requestUtils.mapInwardPaymentDto(message);
            ...
            ResponseEntity<String> response = httpClient.postClient(coreBankingProperties.getUrl() + coreBankingProperties.getPath().getCreditTransfer(), entity, messageDto.getSslKeyAlias(), String.class);
            ...
            if (response.getStatusCode().is2xxSuccessful()) {
                ...
                pacs002Response.setErrorMapping(txConfirmationResponse.getStatus().getCode());
