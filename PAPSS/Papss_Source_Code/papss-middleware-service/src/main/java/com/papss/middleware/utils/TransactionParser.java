...
public class TransactionParser {
    ...
    public static PaymentReturnDto paymentReturn(String xmlData) {
        try {
            ...
            // From/To member information
            info.setFromMemberId(getElementText(appHdr, "Fr", "FIId", "FinInstnId", "Othr", "Id"));
            info.setToBic(getElementText(appHdr, "To", "FIId", "FinInstnId", "BICFI"));
            info.setToMemberId(getElementText(appHdr, "To", "FIId", "FinInstnId", "Othr", "Id"));
