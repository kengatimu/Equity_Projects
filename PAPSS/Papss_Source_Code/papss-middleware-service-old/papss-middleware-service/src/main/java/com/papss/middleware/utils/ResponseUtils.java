...
//                code = "501";
    ...
    public String generateResponseMessage(String messageId, XMLGregorianCalendar creationDateTime, Message message,
        ...
        templateData.put("scheme_name_cd", message.getIdVrfctnReq().getVrfctns().get(0).getPtyAndAcctId().getAcct()
                .getOthr().getSchmeNm().getCd());
        templateData.put("clearing_sys_id_prtry",
                message.getAppHdr().getFr().getFIId().getFinInstnId().getClrSysMmbId().getClrSysId().getPrtry());
        templateData.put("account_number", nameInquiryResponse.getAccountNumber());
        ...
        if (!isAccountVerified) {
            ...
            templateData.put("account_name", nameInquiryResponse.getAccountName());
    ...
    public String generatePaymentResponseMessage(Message message, String messageId, boolean isProcessed,
        ...
        templateData.put("fr_memberId",
                message.getAppHdr().getTo().getFIId().getFinInstnId().getClrSysMmbId().getMmbId());
        ...
        templateData.put("original_instrumentId",
                message.getFIToFICstmrCdtTrf().getCdtTrfTxInves().get(0).getPmtId().getInstrId());
        templateData.put("original_endToEndId",
                message.getFIToFICstmrCdtTrf().getCdtTrfTxInves().get(0).getPmtId().getEndToEndId());
        templateData.put("original_transactionId",
                message.getFIToFICstmrCdtTrf().getCdtTrfTxInves().get(0).getPmtId().getTxId());
        ...
        if (isProcessed) {
            ...
            templateData.put("reason_code", ErrorCodes.CODE_501.getValue());
    ...
    public TxStatusResponseDto generateResponse(RtpMessageDto rtpMessageDto, XMLGregorianCalendar creationDateTime, PaymentRecallDto paymentCancellationRequestDTO) throws Exception {
        ...
        return TxStatusResponseDto.builder()
                ...
                .originalTransactionRef(message.getFIToFIPmtStsRpt().getOrgnlGrpInfAndSts().get(0).getOrgnlMsgId())
                .tranDateTime(creationDateTime.toString())
                .status(Status.builder().type(rejectionCode).code(rejectionReason)
                        .description(rtpMessageDto.getDescription()).build())
                .build();
    }
