...
public class RequestUtils {
    ...
    public String generateMessage(CreditReturnRequest creditReturnDto, String papssId,  XMLGregorianCalendar creationDateTime,  XMLGregorianCalendar creationDateSimple) {

        Map<String, Object> templateData = new HashMap<>();
        templateData.put("messageId", Utils.generateMessageId(papssId));
        templateData.put("toClearingSystemId", systemConfig.getToClearingSystemId());
        String interbankSttlmtDate = creditReturnDto.getOriginalTran().getTranDateTime().substring(0, 10);
