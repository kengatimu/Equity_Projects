...
public class Sender implements Serializable {
    ...
    @Pattern(regexp = "^[a-zA-Z]+$", message = "Country contains invalid characters")
    ...
    // New pattern allows letters, numbers, spaces, and a comprehensive set of punctuation and symbols
