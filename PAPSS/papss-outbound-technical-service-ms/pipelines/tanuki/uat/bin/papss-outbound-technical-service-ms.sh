...
# Application 
APP_NAME=papss-outbound-technical-service-ms
APP_LONG_NAME=papss-outbound-technical-service-ms
 
# Wrapper 
WRAPPER_CMD="./wrapper" 
WRAPPER_CONF="../conf/papss-outbound-technical-service-ms.conf" 
