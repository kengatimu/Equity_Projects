...
@Component
@ConfigurationProperties(prefix = "limits.inbound")
public class TransactionLimitsPropConfig implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if (this.maxTransactionLimit == null) {
            ...
            log.warn("[TransactionConfig]: 'limits.inbound.max-transaction-limit' not configured. Defaulting to {}. Please configure this property.", this.maxTransactionLimit);
        }
        if (this.dailyTransactionLimit == null) {
            this.dailyTransactionLimit = new BigDecimal("999999"); // Updated default
            log.warn("[TransactionConfig]: 'limits.inbound.daily-transaction-limit' not configured. Defaulting to {}. Please configure this property.", this.dailyTransactionLimit);
        }
        if (this.velocityLimit == null) {
            this.velocityLimit = new BigDecimal("99999999"); // Updated default
            log.warn("[TransactionConfig]: 'limits.inbound.velocity-limit' not configured. Defaulting to {}. Please configure this property.", this.velocityLimit);
        }
    }
}