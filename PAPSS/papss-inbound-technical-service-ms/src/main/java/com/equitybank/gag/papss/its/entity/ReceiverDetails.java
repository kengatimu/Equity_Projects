...
@Entity
@Table(name = "papss_receiver_details")
public class ReceiverDetails implements Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "papss_receiver_details_seq")
    @SequenceGenerator(name = "papss_receiver_details_seq", sequenceName = "papss_receiver_details_seq", allocationSize = 10)
    private Long id;
