...
public final class ISOApplicationConstants {
    ...
    public static final String TRANSACTION_CHARGE_CODE = "PAPSS";                   // Default charge type
...
//    public static final String TRANSACTION_PAN = "4478150000000000";              // Generic PAN
    ...
    public static final String ACCT_INQUIRY_CODE_IDENTIFIER = "820000";  // Standard fund transfer
    public static final String ACCT_VALIDATION_TRANSACTION_PAN_KE = "6278519999011712";  // Standard fund transfer
    public static final String ACCT_VALIDATION_TRANSACTION_CHANNEL_CODE = "SMS";    // Default logical channel
    public static final String ACCT_VALIDATION_TRANSACTION_CHANNEL_CODE_2 = "BRK";    // Default logical channel
    public static final String ACCT_VALIDATION_TRANSACTION_TERMINAL_ID = "CAMPAIGN";// POS/ATM terminal ID
